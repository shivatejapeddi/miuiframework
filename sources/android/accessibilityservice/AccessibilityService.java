...
public abstract class AccessibilityService extends Service {
    ...
    public static class IAccessibilityServiceClientWrapper extends Stub implements Callback {
        ...
        public void onFingerprintCapturingGesturesChanged(boolean active) {
            ...
            handlerCaller.sendMessage(handlerCaller.obtainMessageI(10, active));
        }
    ...
    public static final class MagnificationController {
        ...
        public void onServiceConnectedLocked() {
            ArrayMap arrayMap = this.mListeners;
     ...
     */
        /* JADX WARNING: Missing block: B:12:0x0021, code skipped:
            r11 = (android.accessibilityservice.AccessibilityService.MagnificationController.OnMagnificationChangedListener) r0.keyAt(r10);
            r12 = (android.os.Handler) r0.valueAt(r10);
     */
     ...
     */
        public void dispatchMagnificationChanged(android.graphics.Region r15, float r16, float r17, float r18) {
            ...
            r1 = r8.mLock;
            monitor-enter(r1);
            r0 = r8.mListeners;	 Catch:{ all -> 0x0061 }
        ...
        L_0x0010:
            goto L_0x0054;
        L_0x0011:
            r0 = new android.util.ArrayMap;	 Catch:{ all -> 0x0061 }
            r2 = r8.mListeners;	 Catch:{ all -> 0x0061 }
        ...
        L_0x0021:
            r1 = r0.keyAt(r10);
            r11 = r1;
            r11 = (android.accessibilityservice.AccessibilityService.MagnificationController.OnMagnificationChangedListener) r11;
            r1 = r0.valueAt(r10);
            r12 = r1;
            r12 = (android.os.Handler) r12;
            if (r12 == 0) goto L_0x0044;
        L_0x0031:
            r13 = new android.accessibilityservice.AccessibilityService$MagnificationController$1;
            r1 = r13;
            r2 = r14;
            r3 = r11;
            r4 = r15;
        ...
        L_0x0054:
            ...
            r2 = "Received magnification changed callback with no listeners registered!";
            android.util.Slog.d(r0, r2);	 Catch:{ all -> 0x0061 }
            r0 = 0;
            r14.setMagnificationCallbackEnabled(r0);	 Catch:{ all -> 0x0061 }
            monitor-exit(r1);	 Catch:{ all -> 0x0061 }
            return;
        L_0x0061:
            r0 = move-exception;
     ...
     */
        public void dispatchSoftKeyboardShowModeChanged(final int r7) {
            ...
            r0 = r6.mLock;
            monitor-enter(r0);
            r1 = r6.mListeners;	 Catch:{ all -> 0x004a }
            if (r1 == 0) goto L_0x003d;
        L_0x0007:
            r1 = r6.mListeners;	 Catch:{ all -> 0x004a }
            r1 = r1.isEmpty();	 Catch:{ all -> 0x004a }
            if (r1 == 0) goto L_0x0010;
        L_0x000f:
            goto L_0x003d;
        L_0x0010:
            r1 = new android.util.ArrayMap;	 Catch:{ all -> 0x004a }
            r2 = r6.mListeners;	 Catch:{ all -> 0x004a }
        ...
        L_0x001f:
            r3 = r1.keyAt(r0);
            r3 = (android.accessibilityservice.AccessibilityService.SoftKeyboardController.OnShowModeChangedListener) r3;
            r4 = r1.valueAt(r0);
            r4 = (android.os.Handler) r4;
            if (r4 == 0) goto L_0x0036;
        L_0x002d:
            r5 = new android.accessibilityservice.AccessibilityService$SoftKeyboardController$1;
            r5.<init>(r3, r7);
            r4.post(r5);
            goto L_0x0039;
        L_0x0036:
        ...
        L_0x003d:
            ...
            r2 = "Received soft keyboard show mode changed callback with no listeners registered!";
            android.util.Slog.w(r1, r2);	 Catch:{ all -> 0x004a }
            r1 = 0;
    ...
    private void dispatchServiceConnected() {
        synchronized (this.mLock) {
            for (int i = 0; i < this.mMagnificationControllers.size(); i++) {
                ((MagnificationController) this.mMagnificationControllers.valueAt(i)).onServiceConnectedLocked();
            }
        }
    ...
    public final MagnificationController getMagnificationController(int displayId) {
        ...
        synchronized (this.mLock) {
            controller = (MagnificationController) this.mMagnificationControllers.get(displayId);
            if (controller == null) {
