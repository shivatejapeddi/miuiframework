...
public final class SeempLog {
    ...
    public static int record_sensor(int api, Sensor sensor) {
        ...
        return seemp_println_native(api, stringBuilder.toString());
    }
    ...
    public static int record_sensor_rate(int api, Sensor sensor, int rate) {
        ...
        stringBuilder = new StringBuilder();
        stringBuilder.append("sensor=-1,rate=");
        stringBuilder.append(rate);
        return seemp_println_native(api, stringBuilder.toString());
    }
    ...
    public static int record_vg_layout(int api, LayoutParams params) {
        ...
        try {
            ...
            if (p == null) {
                return seemp_println_native(api, str);
            }
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("window_type=");
            stringBuilder.append(p.type);
            stringBuilder.append(",window_flag=");
            stringBuilder.append(p.flags);
            return seemp_println_native(api, stringBuilder.toString());
    ...
    static {
        Map map = value_to_get_map;
        Integer valueOf = Integer.valueOf(170);
        String str = System.NOTIFICATION_SOUND;
        map.put(str, valueOf);
        map = value_to_get_map;
        valueOf = Integer.valueOf(132);
        String str2 = System.DTMF_TONE_WHEN_DIALING;
        map.put(str2, valueOf);
        String str3 = "lock_pattern_autolock";
        value_to_get_map.put(str3, Integer.valueOf(138));
        String str4 = "wifi_max_dhcp_retry_count";
        value_to_get_map.put(str4, Integer.valueOf(172));
        String str5 = "auto_time";
        value_to_get_map.put(str5, Integer.valueOf(123));
        map = value_to_get_map;
        valueOf = Integer.valueOf(131);
        String str6 = System.SETUP_WIZARD_HAS_RUN;
        map.put(str6, valueOf);
        String str7 = "wifi_watchdog_background_check_timeout_ms";
        value_to_get_map.put(str7, Integer.valueOf(192));
        String str8 = "location_providers_allowed";
        value_to_get_map.put(str8, Integer.valueOf(137));
        map = value_to_get_map;
        valueOf = Integer.valueOf(103);
        String str9 = System.ALARM_ALERT;
        map.put(str9, valueOf);
        map = value_to_get_map;
        valueOf = Integer.valueOf(158);
        String str10 = System.VIBRATE_ON;
        map.put(str10, valueOf);
        String str11 = "usb_mass_storage_enabled";
        value_to_get_map.put(str11, Integer.valueOf(157));
        String str12 = "wifi_watchdog_ping_delay_ms";
        value_to_get_map.put(str12, Integer.valueOf(197));
        map = value_to_get_map;
        valueOf = Integer.valueOf(109);
        String str13 = System.FONT_SCALE;
        map.put(str13, valueOf);
        String str14 = "wifi_watchdog_ap_count";
        value_to_get_map.put(str14, Integer.valueOf(189));
        String str15 = str14;
        ...
        value_to_put_map.put(str, Integer.valueOf(274));
        value_to_put_map.put(str2, Integer.valueOf(236));
        value_to_put_map.put(str3, Integer.valueOf(242));
        value_to_put_map.put(str4, Integer.valueOf(276));
        value_to_put_map.put(str5, Integer.valueOf(227));
        value_to_put_map.put(str6, Integer.valueOf(235));
        value_to_put_map.put(str7, Integer.valueOf(296));
        value_to_put_map.put(str8, Integer.valueOf(241));
        value_to_put_map.put(str9, Integer.valueOf(206));
        value_to_put_map.put(str10, Integer.valueOf(262));
        value_to_put_map.put(str11, Integer.valueOf(261));
        value_to_put_map.put(str12, Integer.valueOf(301));
        value_to_put_map.put(str13, Integer.valueOf(213));
        value_to_put_map.put(str15, Integer.valueOf(293));
