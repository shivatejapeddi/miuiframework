...
public final class PrintJobInfo implements Parcelable {
    ...
    private PrintJobInfo(Parcel parcel) {
        ...
        if (bundle != null) {
            Preconditions.checkArgument(bundle.containsKey(null) ^ 1);
        }
    }
    ...
    public String toString() {
        ...
        String str = null;
        stringBuilder.append(printAttributes != null ? printAttributes.toString() : null);
        builder.append(stringBuilder.toString());
        stringBuilder = new StringBuilder();
        stringBuilder.append(", documentInfo: ");
        PrintDocumentInfo printDocumentInfo = this.mDocumentInfo;
        stringBuilder.append(printDocumentInfo != null ? printDocumentInfo.toString() : null);
        builder.append(stringBuilder.toString());
        stringBuilder = new StringBuilder();
        ...
        stringBuilder.append(pageRangeArr != null ? Arrays.toString(pageRangeArr) : null);
        builder.append(stringBuilder.toString());
        stringBuilder = new StringBuilder();
        ...
        stringBuilder.append(charSequence != null ? charSequence.toString() : null);
        builder.append(stringBuilder.toString());
        stringBuilder = new StringBuilder();
        ...
        charSequence = this.mStatusResAppPackageName;
