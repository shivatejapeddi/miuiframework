...
public final class PrinterInfo implements Parcelable {
    ...
    public Drawable loadIcon(Context context) {
        ...
        try {
            ...
            ApplicationInfo appInfo = packageManager.getPackageInfo(packageName, (int) null).applicationInfo;
    ...
    public int hashCode() {
        ...
        hashCode2 = (((((((hashCode2 + (printerCapabilitiesInfo != null ? printerCapabilitiesInfo.hashCode() : 0)) * 31) + this.mIconResourceId) * 31) + this.mHasCustomPrinterIcon) * 31) + this.mCustomPrinterIconGen) * 31;
