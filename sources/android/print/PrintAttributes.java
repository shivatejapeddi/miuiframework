...
public final class PrintAttributes implements Parcelable {
    ...
    public static final class MediaSize {
        ...
        public static final MediaSize ISO_B10 = new MediaSize("ISO_B10", "android", R.string.mediasize_iso_b10, 1220, MetricsEvent.EMERGENCY_DIALER_CALL_RESULT);
        ...
        public static final MediaSize ISO_B9 = new MediaSize("ISO_B9", "android", R.string.mediasize_iso_b9, MetricsEvent.EMERGENCY_DIALER_CALL_RESULT, 2440);
        ...
        public static final MediaSize JIS_B10 = new MediaSize("JIS_B10", "android", R.string.mediasize_japanese_jis_b10, MetricsEvent.NOTIFICATION_ZEN_MODE_TOGGLE_ON_FOREVER, 1772);
        ...
        public static final MediaSize NA_FOOLSCAP = new MediaSize("NA_FOOLSCAP", "android", R.string.mediasize_na_foolscap, AnrMonitor.INPUT_DISPATCHING_TIMEOUT, 13000);
        public static final MediaSize NA_GOVT_LETTER = new MediaSize("NA_GOVT_LETTER", "android", R.string.mediasize_na_gvrnmt_letter, AnrMonitor.INPUT_DISPATCHING_TIMEOUT, 10500);
        public static final MediaSize NA_INDEX_3X5 = new MediaSize("NA_INDEX_3X5", "android", R.string.mediasize_na_index_3x5, EventLogTags.BOOT_PROGRESS_START, 5000);
        public static final MediaSize NA_INDEX_4X6 = new MediaSize("NA_INDEX_4X6", "android", R.string.mediasize_na_index_4x6, 4000, 6000);
        public static final MediaSize NA_INDEX_5X8 = new MediaSize("NA_INDEX_5X8", "android", R.string.mediasize_na_index_5x8, 5000, AnrMonitor.INPUT_DISPATCHING_TIMEOUT);
        public static final MediaSize NA_JUNIOR_LEGAL = new MediaSize("NA_JUNIOR_LEGAL", "android", R.string.mediasize_na_junior_legal, AnrMonitor.INPUT_DISPATCHING_TIMEOUT, 5000);
        ...
        public static final MediaSize NA_QUARTO = new MediaSize("NA_QUARTO", "android", R.string.mediasize_na_quarto, AnrMonitor.INPUT_DISPATCHING_TIMEOUT, 10000);
    ...
    public String toString() {
        ...
        if (this.mMediaSize != null) {
            builder.append(str);
            builder.append(this.mMediaSize.isPortrait() ? Parameters.SCENE_MODE_PORTRAIT : Parameters.SCENE_MODE_LANDSCAPE);
        } else {
            builder.append(str);
            builder.append("null");
        }
