...
public final class MifareClassic extends BasicTagTechnology {
    ...
    public static final byte[] KEY_MIFARE_APPLICATION_DIRECTORY = new byte[]{MidiConstants.STATUS_POLYPHONIC_AFTERTOUCH, (byte) -95, (byte) -94, (byte) -93, (byte) -92, (byte) -91};
    ...
    public MifareClassic(Tag tag) throws RemoteException {
        ...
        if (sak != (short) 1) {
            if (sak == (short) 40) {
                ...
                return;
            } else if (sak == (short) 56) {
                this.mType = 0;
                this.mSize = 4096;
                this.mIsEmulated = true;
                return;
            } else if (sak == (short) 136) {
                this.mType = 0;
                this.mSize = 1024;
                return;
            } else if (sak == (short) 152 || sak == (short) 184) {
                this.mType = 2;
                this.mSize = 4096;
                return;
            } else if (sak != (short) 8) {
                if (sak == (short) 9) {
                    ...
                    this.mSize = 4096;
                    return;
                } else if (sak == (short) 24) {
                    this.mType = 0;
                    this.mSize = 4096;
                    return;
                } else if (sak == (short) 25) {
                    this.mType = 0;
                    this.mSize = 2048;
                    return;
                } else {
