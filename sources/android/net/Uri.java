...
public abstract class Uri implements Parcelable, Comparable<Uri> {
    ...
    public static final class Builder {
        ...
        public Uri build() {
            ...
            if (part != null) {
                ...
                if (str != null) {
                    return new OpaqueUri(str, part, this.fragment, null);
                }
    ...
    static class PathPart extends AbstractPart {
        ...
        static PathPart appendEncodedSegment(PathPart oldPart, String newSegment) {
            ...
            if (oldPathLength == 0) {
                ...
                stringBuilder3.append(oldPath);
                stringBuilder3.append(newSegment);
    ...
    static class PathSegmentsBuilder {
        ...
        public PathSegments build() {
            ...
            try {
                PathSegments pathSegments = new PathSegments(strArr, this.size);
                return pathSegments;
            } finally {
                this.segments = null;
            }
    ...
    private static class StringUri extends AbstractHierarchicalUri {
        ...
        private StringUri(String uriString) {
            ...
            throw new NullPointerException(SearchResultColumn.COLUMN_URI_STRING);
        }
        ...
        private Part getAuthorityPart() {
            String encodedAuthority = this.authority;
            if (encodedAuthority != null) {
            ...
            if (scheme.equalsIgnoreCase(PhoneAccount.SCHEME_TEL) || scheme.equalsIgnoreCase("sip") || scheme.equalsIgnoreCase("sms") || scheme.equalsIgnoreCase("smsto") || scheme.equalsIgnoreCase("mailto") || scheme.equalsIgnoreCase("nfc")) {
                ...
                if (ssp != null) {
                    for (int i = 0; i < ssp.length(); i++) {
                        char c = ssp.charAt(i);
                        if (c == '-' || c == '@' || c == ClassUtils.PACKAGE_SEPARATOR_CHAR) {
                            builder.append(c);
                        } else {
                ...
                builder.append("//");
                String str = "";
                builder.append(getHost() != null ? getHost() : str);
                if (getPort() != -1) {
                    StringBuilder stringBuilder = new StringBuilder();
                    stringBuilder.append(":");
    ...
    public static Uri fromFile(File file) {
        if (file != null) {
            ...
            return new HierarchicalUri(ContentResolver.SCHEME_FILE, Part.EMPTY, path, Part.NULL, Part.NULL, null);
        }
    ...
    private static boolean isAllowed(char c, String allow) {
        return (c >= DateFormat.CAPITAL_AM_PM && c <= 'Z') || ((c >= DateFormat.AM_PM && c <= DateFormat.TIME_ZONE) || !((c < '0' || c > '9') && "_-!.~'()*".indexOf(c) == -1 && (allow == null || allow.indexOf(c) == -1)));
    }
