...
public class WifiAwareSession implements AutoCloseable {
    ...
    public void publish(PublishConfig publishConfig, DiscoverySessionCallback callback, Handler handler) {
        ...
        String str = TAG;
        if (mgr == null) {
            Log.e(str, "publish: called post GC on WifiAwareManager");
        } else if (this.mTerminated) {
            Log.e(str, "publish: called after termination");
        } else {
    ...
    public NetworkSpecifier createNetworkSpecifierOpen(int role, byte[] peer) {
        ...
        String str = TAG;
        if (mgr == null) {
            Log.e(str, "createNetworkSpecifierOpen: called post GC on WifiAwareManager");
            return null;
        } else if (this.mTerminated) {
            Log.e(str, "createNetworkSpecifierOpen: called after termination");
            return null;
        } else {
    ...
    public NetworkSpecifier createNetworkSpecifierPassphrase(int role, byte[] peer, String passphrase) {
        ...
        String str = TAG;
        if (mgr == null) {
            Log.e(str, "createNetworkSpecifierPassphrase: called post GC on WifiAwareManager");
            return null;
        } else if (this.mTerminated) {
            Log.e(str, "createNetworkSpecifierPassphrase: called after termination");
            return null;
    ...
    public NetworkSpecifier createNetworkSpecifierPmk(int role, byte[] peer, byte[] pmk) {
        ...
        String str = TAG;
        if (mgr == null) {
            Log.e(str, "createNetworkSpecifierPmk: called post GC on WifiAwareManager");
            return null;
        } else if (this.mTerminated) {
            Log.e(str, "createNetworkSpecifierPmk: called after termination");
            return null;
