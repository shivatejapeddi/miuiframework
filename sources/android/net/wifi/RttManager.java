...
public class RttManager {
    ...
    public static class RttCapabilities implements Parcelable {
        ...
        public String toString() {
            ...
            String str2 = "is not supported. ";
            sb.append(this.oneSidedRttSupported ? str : str2);
            sb.append("twoSided11McRtt ");
            sb.append(this.twoSided11McRttSupported ? str : str2);
            sb.append("lci ");
            sb.append(this.lciSupported ? str : str2);
            sb.append("lcr ");
            ...
            str = "supported";
            str2 = "not supported";
            sb.append(this.responderSupported ? str : str2);
    ...
    public void startRanging(RttParams[] params, final RttListener listener) {
        ...
        String str = TAG;
        Log.i(str, "Send RTT request to RTT Service");
        if (this.mNewService.isAvailable()) {
            ...
            try {
                ...
                stringBuilder = new StringBuilder();
                stringBuilder.append("startRanging: security exception - ");
