...
public final class WifiNetworkSuggestion implements Parcelable {
    public static final Creator<WifiNetworkSuggestion> CREATOR = new Creator<WifiNetworkSuggestion>() {
    ...
    public int hashCode() {
        return Objects.hash(new Object[]{this.wifiConfiguration.SSID, this.wifiConfiguration.BSSID, this.wifiConfiguration.allowedKeyManagement, Integer.valueOf(this.suggestorUid), this.suggestorPackageName});
    }
