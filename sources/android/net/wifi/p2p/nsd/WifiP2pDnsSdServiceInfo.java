...
public class WifiP2pDnsSdServiceInfo extends WifiP2pServiceInfo {
    ...
    private static String compressDnsName(String dnsName) {
        ...
        while (true) {
            ...
            if (i == -1) {
                if (dnsName.length() > 0) {
                    sb.append(String.format(Locale.US, str, new Object[]{Integer.valueOf(dnsName.length())}));
                ...
                sb.append(String.format(Locale.US, str, new Object[]{Integer.valueOf(name.length())}));
