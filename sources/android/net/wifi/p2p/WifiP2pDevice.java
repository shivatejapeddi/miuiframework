...
public class WifiP2pDevice implements Parcelable {
    ...
    public WifiP2pDevice(String string) throws IllegalArgumentException {
        ...
        String str2 = "Malformed supplicant event";
        if (tokens.length >= 1) {
            ...
            if (length == 1) {
                ...
                if (match2.find()) {
                    ...
                    if (match2.group(9) != null) {
                        str2 = match2.group(10);
                        this.wfdInfo = new WifiP2pWfdInfo(parseHex(str2.substring(0, 4)), parseHex(str2.substring(4, 8)), parseHex(str2.substring(8, 12)));
                        if (match2.group(11) != null) {
                            this.wfdInfo.setWfdR2Device(parseHex(match2.group(12).substring(0, 4)));
                        }
                    }
    ...
    public boolean equals(Object obj) {
        ...
        if (other != null) {
            String str = other.deviceAddress;
            if (str != null) {
