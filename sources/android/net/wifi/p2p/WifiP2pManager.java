...
public class WifiP2pManager {
    ...
    public static final int REQUEST_DEVICE_INFO = 139364;
    public static final int REQUEST_DISCOVERY_STATE = 139359;
    public static final int REQUEST_GROUP_INFO = 139287;
    public static final int REQUEST_NETWORK_INFO = 139361;
    public static final int REQUEST_ONGOING_PEER_CONFIG = 139349;
    public static final int REQUEST_P2P_STATE = 139357;
    ...
    public static final int RESPONSE_DEVICE_INFO = 139365;
    public static final int RESPONSE_DISCOVERY_STATE = 139360;
    public static final int RESPONSE_GET_HANDOVER_MESSAGE = 139341;
    public static final int RESPONSE_GROUP_INFO = 139288;
    public static final int RESPONSE_NETWORK_INFO = 139362;
    public static final int RESPONSE_ONGOING_PEER_CONFIG = 139350;
    public static final int RESPONSE_P2P_STATE = 139358;
    ...
    public static final int SET_WFDR2_INFO = 139354;
    public static final int SET_WFDR2_INFO_FAILED = 139355;
    public static final int SET_WFDR2_INFO_SUCCEEDED = 139356;
    ...
    public static final int UPDATE_CHANNEL_INFO = 139363;
            ...
            public void handleMessage(Message message) {
                ...
                switch (message.what) {
                    ...
                    case WifiP2pManager.RESPONSE_ONGOING_PEER_CONFIG /*139350*/:
                        WifiP2pConfig peerConfig = message.obj;
                        if (listener != null) {
    ...
    public Channel initialize(Context srcContext, Looper srcLooper, ChannelListener listener) {
        ...
        Context appContext = srcContext.getApplicationContext();
        return initalizeChannel(appContext == null ? srcContext : appContext, srcLooper, listener, getMessenger(binder), binder);
    }
