...
public class MultinetworkPolicyTracker {
    ...
    public MultinetworkPolicyTracker(Context ctx, Handler handler, Runnable avoidBadWifiCallback) {
        ...
        this.mSettingsUris = Arrays.asList(new Uri[]{Global.getUriFor(Global.NETWORK_AVOID_BAD_WIFI), Global.getUriFor(Global.NETWORK_METERED_MULTIPATH_PREFERENCE)});
    ...
    public String getAvoidBadWifiSetting() {
        return Global.getString(this.mResolver, Global.NETWORK_AVOID_BAD_WIFI);
    }
    ...
    public void updateMeteredMultipathPreference() {
        try {
            this.mMeteredMultipathPreference = Integer.parseInt(Global.getString(this.mResolver, Global.NETWORK_METERED_MULTIPATH_PREFERENCE));
