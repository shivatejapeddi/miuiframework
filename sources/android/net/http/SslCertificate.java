...
public class SslCertificate {
    ...
    private static String getDigest(X509Certificate x509Certificate, String algorithm) {
        ...
        try {
            str = fingerprint(MessageDigest.getInstance(algorithm).digest(x509Certificate.getEncoded()));
            return str;
        } catch (CertificateEncodingException e) {
            return str;
    ...
    public View inflateCertificateView(Context context) {
        View certificateView = LayoutInflater.from(context).inflate((int) R.layout.ssl_certificate, null);
