...
public final class PointerIcon implements Parcelable {
    ...
    private static DisplayListener sDisplayListener;
    ...
    public static PointerIcon getSystemIcon(Context context, int type) {
        if (context == null) {
            ...
            SparseArray<PointerIcon> systemIcons = (SparseArray) gSystemIconsByDisplay.get(displayId);
            if (systemIcons == null) {
                systemIcons = new SparseArray();
                gSystemIconsByDisplay.put(displayId, systemIcons);
            }
            PointerIcon icon = (PointerIcon) systemIcons.get(type);
            if (icon != null) {
                return icon;
            }
    ...
    public boolean equals(Object other) {
        ...
        if (this.mType == otherIcon.mType) {
            ...
            if (i == otherIcon.mSystemIconResourceId) {
    ...
    private static void registerDisplayListener(Context context) {
        sDisplayListener = new DisplayListener() {
