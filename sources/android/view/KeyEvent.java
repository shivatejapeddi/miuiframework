...
public class KeyEvent extends InputEvent implements Parcelable {
    ...
    public static final boolean isSystemKey(int keyCode) {
        if (!(keyCode == 2 || keyCode == 3 || keyCode == 4 || keyCode == 5 || keyCode == 6 || keyCode == 79 || keyCode == 80 || keyCode == 82 || keyCode == 130 || keyCode == 164 || keyCode == 689 || keyCode == 126 || keyCode == 127)) {
            switch (keyCode) {
                case 24:
                case 25:
                case 26:
    ...
    public final boolean dispatch(Callback receiver, DispatcherState state, Object target) {
        ...
        if (i == 0) {
            ...
            if (receiver.onKeyMultiple(code, i, this)) {
                return true;
            }
            if (code == 0) {
                return false;
    ...
    public static int keyCodeFromString(String symbolicName) {
        int keyCode;
        try {
            keyCode = Integer.parseInt(symbolicName);
        ...
        keyCode = nativeKeyCodeFromString(symbolicName);
        if (keyCodeIsValid(keyCode)) {
            return keyCode;
        }
        return 0;
