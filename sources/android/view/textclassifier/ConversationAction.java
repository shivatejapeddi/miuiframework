...
public final class ConversationAction implements Parcelable {
    public static final Creator<ConversationAction> CREATOR = new Creator<ConversationAction>() {
        public ConversationAction createFromParcel(Parcel in) {
            return new ConversationAction(in, null);
        }
    ...
    public static final class Builder {
        ...
        public ConversationAction build() {
            ...
            return new ConversationAction(str, remoteAction, charSequence, f, bundle, null);
        }
    }

    /* synthetic */ ConversationAction(Parcel x0, AnonymousClass1 x1) {
        this(x0);
    }

    /* synthetic */ ConversationAction(String x0, RemoteAction x1, CharSequence x2, float x3, Bundle x4, AnonymousClass1 x5) {
        this(x0, x1, x2, x3, x4);
    }
