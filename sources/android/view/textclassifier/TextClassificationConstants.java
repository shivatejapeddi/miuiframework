...
public final class TextClassificationConstants {
    ...
    private static final List<String> CONVERSATION_ACTIONS_TYPES_DEFAULT_VALUES = Arrays.asList(new String[]{ConversationAction.TYPE_TEXT_REPLY, ConversationAction.TYPE_CREATE_REMINDER, ConversationAction.TYPE_CALL_PHONE, ConversationAction.TYPE_OPEN_URL, ConversationAction.TYPE_SEND_EMAIL, ConversationAction.TYPE_SEND_SMS, ConversationAction.TYPE_TRACK_FLIGHT, ConversationAction.TYPE_VIEW_CALENDAR, ConversationAction.TYPE_VIEW_MAP, ConversationAction.TYPE_ADD_CONTACT, ConversationAction.TYPE_COPY});
    ...
    private static final List<String> ENTITY_LIST_DEFAULT_VALUE = Arrays.asList(new String[]{"address", "email", "phone", "url", "date", TextClassifier.TYPE_DATE_TIME, TextClassifier.TYPE_FLIGHT_NUMBER});
