...
public final class TextServicesManager {
    ...
    private final ITextServicesManager mService = Stub.asInterface(ServiceManager.getServiceOrThrow(Context.TEXT_SERVICES_MANAGER_SERVICE));
    private final int mUserId;

    private TextServicesManager(int userId) throws ServiceNotFoundException {
        this.mUserId = userId;
    }

    public static TextServicesManager createInstance(Context context) throws ServiceNotFoundException {
