            ...
            if (parser != null) {
                ...
                if ("spell-checker".equals(parser.getName())) {
                    ...
                    while (true) {
                        ...
                        type = next2;
                        if (next2 != 3 || parser.getDepth() > depth) {
                            if (type == i) {
                                break;
                            }
                            if (type == 2) {
                                if ("subtype".equals(parser.getName())) {
                                    ...
                                    res2 = res;
                                    this.mSubtypes.add(new SpellCheckerSubtype(a.getResourceId(0, 0), a.getString(1), a.getString(4), a.getString(2), a.getInt(3, null)));
                                } else {
