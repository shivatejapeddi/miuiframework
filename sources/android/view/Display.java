...
public final class Display {
    ...
    private Display(DisplayManagerGlobal global, int displayId, DisplayInfo displayInfo, DisplayAdjustments daj, Resources res) {
        ...
        DisplayAdjustments displayAdjustments = resources != null ? new DisplayAdjustments(resources.getConfiguration()) : daj != null ? new DisplayAdjustments(daj) : null;
    ...
    public DisplayAdjustments getDisplayAdjustments() {
        DisplayAdjustments currentAdjustements = this.mResources;
        if (currentAdjustements != null) {
            currentAdjustements = currentAdjustements.getDisplayAdjustments();
