...
public final class DataRemovalRequest implements Parcelable {
    public static final Creator<DataRemovalRequest> CREATOR = new Creator<DataRemovalRequest>() {
        public DataRemovalRequest createFromParcel(Parcel parcel) {
            return new DataRemovalRequest(parcel, null);
        }
    ...
    public static final class Builder {
        ...
        public Builder addLocusId(LocusId locusId, int flags) {
            throwIfDestroyed();
            Preconditions.checkState(this.mForEverything ^ 1, "Already is for everything");
        ...
        public DataRemovalRequest build() {
            throwIfDestroyed();
            boolean z = this.mForEverything || this.mLocusIds != null;
            Preconditions.checkState(z, "must call either #forEverything() or add one #addLocusId()");
            this.mDestroyed = true;
            return new DataRemovalRequest(this, null);
        }

        private void throwIfDestroyed() {
            Preconditions.checkState(this.mDestroyed ^ 1, "Already destroyed!");
        }
    }
    ...
    public final class LocusIdRequest {
        ...
        /* synthetic */ LocusIdRequest(DataRemovalRequest x0, LocusId x1, int x2, AnonymousClass1 x3) {
            this(x1, x2);
        }
    ...
    private DataRemovalRequest(Builder builder) {
        ...
        if (builder.mLocusIds != null) {
            ...
            for (int i = 0; i < size; i++) {
                this.mLocusIdRequests.add(new LocusIdRequest(this, (LocusId) builder.mLocusIds.get(i), builder.mFlags.get(i), null));
            }
        }
    }
    ...
    private DataRemovalRequest(Parcel parcel) {
        ...
        if (!this.mForEverything) {
            ...
            this.mLocusIdRequests = new ArrayList(size);
            for (int i = 0; i < size; i++) {
                this.mLocusIdRequests.add(new LocusIdRequest(this, (LocusId) parcel.readValue(null), parcel.readInt(), null));
            }
        }
    }
    ...
    public void writeToParcel(Parcel parcel, int flags) {
        ...
        if (!this.mForEverything) {
            ...
            for (int i = 0; i < size; i++) {
                LocusIdRequest request = (LocusIdRequest) this.mLocusIdRequests.get(i);
