...
public class InputMethodSystemProperty {
    ...
    private static ComponentName getMultiClientImeComponentName() {
        ...
        if (Build.IS_DEBUGGABLE) {
            ComponentName debugIme = ComponentName.unflattenFromString(SystemProperties.get(PROP_DEBUG_MULTI_CLIENT_IME, str));
            if (debugIme != null) {
                return debugIme;
            }
        }
        return ComponentName.unflattenFromString(SystemProperties.get(PROP_PROD_MULTI_CLIENT_IME, str));
    }
