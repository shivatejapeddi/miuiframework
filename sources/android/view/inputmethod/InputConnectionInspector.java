...
public final class InputConnectionInspector {
    ...
    private static boolean hasGetSelectedText(Class clazz) {
        boolean z = false;
        try {
            z = Modifier.isAbstract(clazz.getMethod("getSelectedText", new Class[]{Integer.TYPE}).getModifiers());
            return z ^ 1;
    ...
    private static boolean hasSetComposingRegion(Class clazz) {
        boolean z = false;
        try {
            z = Modifier.isAbstract(clazz.getMethod("setComposingRegion", new Class[]{Integer.TYPE, Integer.TYPE}).getModifiers());
            return z ^ 1;
        } catch (NoSuchMethodException e) {
            return z;
        }
    ...
    private static boolean hasCommitCorrection(Class clazz) {
        boolean z = false;
        try {
            z = Modifier.isAbstract(clazz.getMethod("commitCorrection", new Class[]{CorrectionInfo.class}).getModifiers());
            return z ^ 1;
        } catch (NoSuchMethodException e) {
            return z;
        }
    ...
    private static boolean hasRequestCursorUpdate(Class clazz) {
        boolean z = false;
        try {
            z = Modifier.isAbstract(clazz.getMethod("requestCursorUpdates", new Class[]{Integer.TYPE}).getModifiers());
            return z ^ 1;
        } catch (NoSuchMethodException e) {
            return z;
        }
    ...
    private static boolean hasDeleteSurroundingTextInCodePoints(Class clazz) {
        boolean z = false;
        try {
            z = Modifier.isAbstract(clazz.getMethod("deleteSurroundingTextInCodePoints", new Class[]{Integer.TYPE, Integer.TYPE}).getModifiers());
            return z ^ 1;
        } catch (NoSuchMethodException e) {
            return z;
        }
    ...
    private static boolean hasGetHandler(Class clazz) {
        boolean z = false;
        try {
            z = Modifier.isAbstract(clazz.getMethod("getHandler", new Class[0]).getModifiers());
            return z ^ 1;
        } catch (NoSuchMethodException e) {
            return z;
        }
    ...
    private static boolean hasCloseConnection(Class clazz) {
        boolean z = false;
        try {
            z = Modifier.isAbstract(clazz.getMethod("closeConnection", new Class[0]).getModifiers());
            return z ^ 1;
        } catch (NoSuchMethodException e) {
            return z;
        }
    ...
    private static boolean hasCommitContent(Class clazz) {
        boolean z = false;
        try {
            z = Modifier.isAbstract(clazz.getMethod("commitContent", new Class[]{InputContentInfo.class, Integer.TYPE, Bundle.class}).getModifiers());
            return z ^ 1;
        } catch (NoSuchMethodException e) {
            return z;
        }
