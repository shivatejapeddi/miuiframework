...
public final class ImeInsetsSourceConsumer extends InsetsSourceConsumer {
    ...
    public ImeInsetsSourceConsumer(InsetsState state, Supplier<Transaction> transactionSupplier, InsetsController controller) {
    ...
    public static boolean areEditorsSimilar(EditorInfo info1, EditorInfo info2) {
        ...
        if (!(areOptionsSimilar & (info1.privateImeOptions != null ? info1.privateImeOptions.equals(info2.privateImeOptions) : 1))) {
            return false;
        }
