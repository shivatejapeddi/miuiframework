...
public class WindowInfo implements Parcelable {
    ...
    public static WindowInfo obtain(WindowInfo other) {
        ...
        List list = other.childTokens;
        if (!(list == null || list.isEmpty())) {
            list = window.childTokens;
            if (list == null) {
                window.childTokens = new ArrayList(other.childTokens);
            } else {
                list.addAll(other.childTokens);
            }
        }
        return window;
    }
    ...
    public void writeToParcel(Parcel parcel, int flags) {
        ...
        parcel.writeInt(this.hasFlagWatchOutsideTouch);
        List list = this.childTokens;
        if (list == null || list.isEmpty()) {
            parcel.writeInt(0);
            return;
        }
    ...
    public String toString() {
        ...
        builder.append(this.inPictureInPicture);
        builder.append(", watchOutsideTouch=");
        builder.append(this.hasFlagWatchOutsideTouch);
        builder.append(']');
