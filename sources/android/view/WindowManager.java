...
public interface WindowManager extends ViewManager {
    ...
    public static class LayoutParams extends android.view.ViewGroup.LayoutParams implements Parcelable {
        ...
        public final void setSurfaceInsets(View view, boolean manual, boolean preservePrevious) {
            ...
            int windowMode = 0;
            try {
                windowMode = view.getResources().getConfiguration().windowConfiguration.getWindowingMode();
            } catch (Exception e) {
                e.printStackTrace();
            }
            if (surfaceInset == 0 || windowMode == 5) {
        ...
        public void writeToParcel(Parcel out, int parcelableFlags) {
            ...
            out.writeInt(this.extraFlags);
            out.writeFloat(this.blurRatio);
            out.writeInt(this.blurMode);
        ...
        public LayoutParams(Parcel in) {
            ...
            this.extraFlags = in.readInt();
            this.blurRatio = in.readFloat();
            this.blurMode = in.readInt();
        ...
        public final int copyFrom(LayoutParams o) {
            ...
            f = this.horizontalMargin;
            f2 = o.horizontalMargin;
            if (f != f2) {
                this.horizontalMargin = f2;
                changes |= 1;
            }
            f = this.verticalMargin;
            f2 = o.verticalMargin;
            if (f != f2) {
            ...
            i = this.layoutInDisplayCutoutMode;
            i2 = o.layoutInDisplayCutoutMode;
            if (i != i2) {
            ...
            i = this.windowAnimations;
            i2 = o.windowAnimations;
            if (i != i2) {
            ...
            if (!Objects.equals(this.mTitle, o.mTitle)) {
                charSequence = o.mTitle;
            ...
            f2 = o.screenBrightness;
            if (f != f2) {
                this.screenBrightness = f2;
                changes |= 2048;
            }
            f = this.buttonBrightness;
            f2 = o.buttonBrightness;
            if (f != f2) {
                this.buttonBrightness = f2;
                changes |= 8192;
            }
            i = this.rotationAnimation;
            i2 = o.rotationAnimation;
            if (i != i2) {
                this.rotationAnimation = i2;
                changes |= 4096;
            }
            i = this.screenOrientation;
            i2 = o.screenOrientation;
            if (i != i2) {
                this.screenOrientation = i2;
                changes |= 1024;
            }
            f = this.preferredRefreshRate;
            f2 = o.preferredRefreshRate;
            if (f != f2) {
                this.preferredRefreshRate = f2;
                changes |= 2097152;
            }
            i = this.preferredDisplayModeId;
            i2 = o.preferredDisplayModeId;
            if (i != i2) {
                this.preferredDisplayModeId = i2;
                changes |= 8388608;
            }
            ...
            i = this.inputFeatures;
            i2 = o.inputFeatures;
            if (i != i2) {
                this.inputFeatures = i2;
                changes |= 65536;
            }
            ...
            z = this.hasManualSurfaceInsets;
            boolean z3 = o.hasManualSurfaceInsets;
            if (z != z3) {
                this.hasManualSurfaceInsets = z3;
                changes |= 1048576;
            }
            z = this.preservePreviousSurfaceInsets;
            z3 = o.preservePreviousSurfaceInsets;
            if (z != z3) {
                this.preservePreviousSurfaceInsets = z3;
                changes |= 1048576;
            }
            i = this.needsMenuKey;
            i2 = o.needsMenuKey;
            if (i != i2) {
                this.needsMenuKey = i2;
                changes |= 4194304;
            }
            j = this.accessibilityIdOfAnchor;
            j2 = o.accessibilityIdOfAnchor;
            if (j != j2) {
                this.accessibilityIdOfAnchor = j2;
                changes |= 16777216;
            }
            if (!Objects.equals(this.accessibilityTitle, o.accessibilityTitle)) {
                charSequence = o.accessibilityTitle;
                if (charSequence != null) {
        ...
        public void dumpDimensions(StringBuilder sb) {
            ...
            String str = "wrap";
            String str2 = "fill";
            String valueOf = this.width == -1 ? str2 : this.width == -2 ? str : String.valueOf(this.width);
            sb.append(valueOf);
        ...
        public String toString(String prefix) {
            ...
            sb.append(" blurRatio=");
            sb.append(this.blurRatio);
            sb.append(" blurMode=");
            sb.append(this.blurMode);
            sb.append(" ty=");
            ...
            String str = "mSystemUiVisibility";
            if (this.systemUiVisibility != 0) {
                sb.append(System.lineSeparator());
                sb.append(prefix);
                sb.append("  sysui=");
                sb.append(ViewDebug.flagsToString(View.class, str, this.systemUiVisibility));
            }
            if (this.subtreeSystemUiVisibility != 0) {
                sb.append(System.lineSeparator());
                sb.append(prefix);
                sb.append("  vsysui=");
                sb.append(ViewDebug.flagsToString(View.class, str, this.subtreeSystemUiVisibility));
            }
            sb.append('}');
            return sb.toString();
        }
