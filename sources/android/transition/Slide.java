...
public class Slide extends Visibility {
    ...
    public Animator onAppear(ViewGroup sceneRoot, View view, TransitionValues startValues, TransitionValues endValues) {
        ...
        return TranslationAnimationCreator.createAnimation(view, endValues, position[0], position[1], startX, this.mSlideCalculator.getGoneY(viewGroup, view2, this.mSlideFraction), endX, endY, sDecelerate, this);
    }
    ...
    public Animator onDisappear(ViewGroup sceneRoot, View view, TransitionValues startValues, TransitionValues endValues) {
        ...
        return TranslationAnimationCreator.createAnimation(view, startValues, position[0], position[1], startX, startY, endX, this.mSlideCalculator.getGoneY(viewGroup, view2, this.mSlideFraction), sAccelerate, this);
    }
