...
public abstract class BaseCanvas {
    ...
    public void drawBitmap(Bitmap bitmap, Rect src, Rect dst, Paint paint) {
        ...
        if (rect2 != null) {
            ...
            nDrawBitmap(this.mNativeCanvasWrapper, bitmap.getNativeInstance(), (float) left, (float) top, (float) right, (float) bottom, f, (float) rect2.top, (float) rect2.right, (float) rect2.bottom, nativePaint, this.mScreenDensity, bitmap.mDensity);
            return;
        }
    ...
    public void drawBitmap(Bitmap bitmap, Rect src, RectF dst, Paint paint) {
        ...
        if (rectF != null) {
            ...
            float f5 = f4;
            float f6 = f3;
            nDrawBitmap(j, nativeInstance, left, top, right, bottom, f, f2, f6, f5, nativePaint, this.mScreenDensity, bitmap.mDensity);
            return;
        }
        throw new NullPointerException();
    }
