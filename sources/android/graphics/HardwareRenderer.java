...
public class HardwareRenderer {
    ...
    public final class FrameRenderRequest {
        ...
        public FrameRenderRequest setFrameCommitCallback(Executor executor, Runnable frameCommitCallback) {
            HardwareRenderer.this.setFrameCompleteCallback(new -$$Lambda$HardwareRenderer$FrameRenderRequest$dejdYejpuxp3nc7eP6FZ2zBu778(executor, frameCommitCallback));
            return this;
        }
    ...
    public HardwareRenderer() {
        ...
        this.mNativeProxy = nCreateProxy(1 ^ this.mOpaque, this.mRootNode.mNativeRenderNode);
