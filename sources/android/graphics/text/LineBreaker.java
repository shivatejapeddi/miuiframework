...
public class LineBreaker {
    ...
    private static native float nGetLineAscent(long j, int i);

    private static native int nGetLineBreakOffset(long j, int i);

    private static native int nGetLineCount(long j);

    private static native float nGetLineDescent(long j, int i);

    private static native int nGetLineFlag(long j, int i);

    private static native float nGetLineWidth(long j, int i);
    ...
    private LineBreaker(int breakStrategy, int hyphenationFrequency, int justify, int[] indents) {
        ...
        this.mNativePtr = nInit(breakStrategy, hyphenationFrequency, z, indents);
