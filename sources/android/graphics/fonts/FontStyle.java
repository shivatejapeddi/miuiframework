...
public final class FontStyle {
    ...
    public FontStyle(int weight, int slant) {
        boolean z = false;
        boolean z2 = 1 <= weight && weight <= 1000;
        Preconditions.checkArgument(z2, "weight value must be [1, 1000]");
        if (slant == 0 || slant == 1) {
            z = true;
        }
        Preconditions.checkArgument(z, "slant value must be FONT_SLANT_UPRIGHT or FONT_SLANT_UPRIGHT");
        this.mWeight = weight;
        this.mSlant = slant;
    }
