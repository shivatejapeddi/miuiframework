        ...
        builder.setMultiChoiceItems(this.mEntries, getSelectedItems(), new OnMultiChoiceClickListener() {
            public void onClick(DialogInterface dialog, int which, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    MultiSelectListPreference.access$076(multiSelectListPreference, multiSelectListPreference.mNewValues.add(MultiSelectListPreference.this.mEntryValues[which].toString()));
                    return;
                }
                multiSelectListPreference = MultiSelectListPreference.this;
                MultiSelectListPreference.access$076(multiSelectListPreference, multiSelectListPreference.mNewValues.remove(MultiSelectListPreference.this.mEntryValues[which].toString()));
            }
        });
