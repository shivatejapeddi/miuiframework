...
public abstract class CellInfo implements Parcelable {
    ...
    public int hashCode() {
        return (((this.mRegistered ^ 1) * 31) + (((int) (this.mTimeStamp / 1000)) * 31)) + (this.mCellConnectionStatus * 31);
    }
