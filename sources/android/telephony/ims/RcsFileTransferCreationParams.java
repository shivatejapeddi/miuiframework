...
public final class RcsFileTransferCreationParams implements Parcelable {
    public static final Creator<RcsFileTransferCreationParams> CREATOR = new Creator<RcsFileTransferCreationParams>() {
        public RcsFileTransferCreationParams createFromParcel(Parcel in) {
            return new RcsFileTransferCreationParams(in, null);
        }
    ...
    /* synthetic */ RcsFileTransferCreationParams(Parcel x0, AnonymousClass1 x1) {
        this(x0);
    }
