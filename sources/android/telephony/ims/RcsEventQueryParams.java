...
public final class RcsEventQueryParams implements Parcelable {
    ...
    public static final Creator<RcsEventQueryParams> CREATOR = new Creator<RcsEventQueryParams>() {
        public RcsEventQueryParams createFromParcel(Parcel in) {
            return new RcsEventQueryParams(in, null);
        }
    ...
    /* synthetic */ RcsEventQueryParams(Parcel x0, AnonymousClass1 x1) {
        this(x0);
    }
