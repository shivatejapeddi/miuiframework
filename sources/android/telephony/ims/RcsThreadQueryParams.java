...
public final class RcsThreadQueryParams implements Parcelable {
    public static final Creator<RcsThreadQueryParams> CREATOR = new Creator<RcsThreadQueryParams>() {
        public RcsThreadQueryParams createFromParcel(Parcel in) {
            return new RcsThreadQueryParams(in, null);
        }
    ...
    /* synthetic */ RcsThreadQueryParams(Parcel x0, AnonymousClass1 x1) {
        this(x0);
    }
