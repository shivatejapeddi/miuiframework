...
public final class RcsParticipantQueryParams implements Parcelable {
    public static final Creator<RcsParticipantQueryParams> CREATOR = new Creator<RcsParticipantQueryParams>() {
        public RcsParticipantQueryParams createFromParcel(Parcel in) {
            return new RcsParticipantQueryParams(in, null);
        }
    ...
    /* synthetic */ RcsParticipantQueryParams(Parcel x0, AnonymousClass1 x1) {
        this(x0);
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeByte((byte) this.mIsAscending);
