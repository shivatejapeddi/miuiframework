...
public final class RcsMessageQueryParams implements Parcelable {
    public static final Creator<RcsMessageQueryParams> CREATOR = new Creator<RcsMessageQueryParams>() {
        public RcsMessageQueryParams createFromParcel(Parcel in) {
            return new RcsMessageQueryParams(in, null);
        }
    ...
    /* synthetic */ RcsMessageQueryParams(Parcel x0, AnonymousClass1 x1) {
        this(x0);
    }
