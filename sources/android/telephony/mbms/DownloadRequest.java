...
public final class DownloadRequest implements Parcelable {
    ...
    public static class Builder {
        ...
        public static Builder fromSerializedRequest(byte[] data) {
            String str = DownloadRequest.LOG_TAG;
            try {
                ...
                Log.e(str, "Got IOException trying to parse opaque data");
                throw new IllegalArgumentException(e);
            } catch (ClassNotFoundException e2) {
                Log.e(str, "Got ClassNotFoundException trying to parse opaque data");
