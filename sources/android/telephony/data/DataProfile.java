...
public final class DataProfile implements Parcelable {
    public static final Creator<DataProfile> CREATOR = new Creator<DataProfile>() {
        public DataProfile createFromParcel(Parcel source) {
            return new DataProfile(source, null);
        }
    ...
    public static final class Builder {
        ...
        public DataProfile build() {
            return new DataProfile(this.mProfileId, this.mApn, this.mProtocolType, this.mAuthType, this.mUserName, this.mPassword, this.mType, this.mMaxConnectionsTime, this.mMaxConnections, this.mWaitTime, this.mEnabled, this.mSupportedApnTypesBitmask, this.mRoamingProtocolType, this.mBearerBitmask, this.mMtu, this.mPersistent, this.mPreferred, null);
        }
    }
    ...
    /* synthetic */ DataProfile(int x0, String x1, int x2, int x3, String x4, String x5, int x6, int x7, int x8, int x9, boolean x10, int x11, int x12, int x13, int x14, boolean x15, boolean x16, AnonymousClass1 x17) {
        this(x0, x1, x2, x3, x4, x5, x6, x7, x8, x9, x10, x11, x12, x13, x14, x15, x16);
    }

    /* synthetic */ DataProfile(Parcel x0, AnonymousClass1 x1) {
        this(x0);
    }
    ...
    public String toString() {
        ...
        if (Build.IS_USER) {
            ...
            stringBuilder2.append(this.mUserName);
            stringBuilder2.append(str2);
            stringBuilder2.append(this.mPassword);
