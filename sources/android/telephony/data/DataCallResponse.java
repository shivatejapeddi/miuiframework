...
public final class DataCallResponse implements Parcelable {
    ...
    public String toString() {
        ...
        while (true) {
            ...
            sb.append(TelephonyUtils.piiIP(((LinkAddress) it.next()).toString()));
            sb.append(str);
        }
        ...
        sb.append("] dnses=[");
        for (InetAddress addr : this.mDnsAddresses) {
            sb.append(TelephonyUtils.piiIP(addr.toString()));
            sb.append(str);
        }
        if (this.mDnsAddresses.size() > 0) {
            sb.deleteCharAt(sb.length() - 1);
        }
        sb.append(" gateways=");
