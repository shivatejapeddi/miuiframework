...
public class TtsEngines {
    ...
    public String getHighestRankedEngineName() {
        String engine = TtsEnginesInjector.getRecommendEngineForLocale(this, Locale.getDefault());
        if (engine != null) {
            return engine;
        }
    ...
    private String settingsActivityFromServiceInfo(ServiceInfo si, PackageManager pm) {
        String str = ":";
        String str2 = "Error parsing metadata for ";
        String str3 = TAG;
        ...
        try {
            ...
            stringBuilder.append(" uses unknown tag :");
            ...
            stringBuilder3.append("Could not load resources for : ");
    ...
    public Locale parseLocaleString(String localeString) {
        ...
        String country = "";
        String variant = "";
        boolean isEmpty = TextUtils.isEmpty(localeString);
        String str = "Failed to convert ";
        String str2 = TAG;
        if (!isEmpty) {
    ...
    public static String[] toOldLocaleStringFormat(Locale locale) {
        String str = "";
        String[] ret = new String[]{str, str, str};
        try {
