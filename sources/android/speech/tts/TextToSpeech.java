...
public class TextToSpeech {
        ...
        return (Set) runAction(new Action<Set<String>>() {
            public Set<String> run(ITextToSpeechService service) throws RemoteException {
                try {
                    ...
                    Log.w(TextToSpeech.TAG, stringBuilder.toString(), e);
                    return null;
                }
            }
        }, null, "getFeatures");
    ...
    public int setLanguage(final Locale loc) {
        return ((Integer) runAction(new Action<Integer>() {
            public Integer run(ITextToSpeechService service) throws RemoteException {
                StringBuilder stringBuilder;
                String str = "Couldn't retrieve ISO 3166 country code for locale: ";
                String str2 = "Couldn't retrieve ISO 639-2/T language code for locale: ";
                String str3 = TextToSpeech.TAG;
                String language = loc;
                ...
                try {
                    language = language.getISO3Language();
                    String country;
                    try {
                        country = loc.getISO3Country();
                        String country2 = loc.getVariant();
                        int result = service.isLanguageAvailable(language, country, country2);
                        if (result >= 0) {
                            String voiceName = service.getDefaultVoiceNameFor(language, country, country2);
                            String str4 = "-";
                            ...
                            if (TextUtils.isEmpty(voiceName)) {
                                ...
                                stringBuilder2.append(str4);
                                stringBuilder2.append(country2);
                                ...
                                if (voice == null) {
                                    stringBuilder2 = new StringBuilder();
                                    stringBuilder2.append("getDefaultVoiceNameFor returned ");
                                    stringBuilder2.append(voiceName);
                                    stringBuilder2.append(" for locale ");
                                    stringBuilder2.append(language);
                                    stringBuilder2.append(str4);
                                    stringBuilder2.append(country);
                                    stringBuilder2.append(str4);
                                    stringBuilder2.append(country2);
                                    stringBuilder2.append(" but getVoice returns null");
                                    Log.w(str3, stringBuilder2.toString());
                                    return valueOf;
                                }
                                String voiceLanguage = "";
                                try {
                                    str2 = voice.getLocale().getISO3Language();
                                    voiceLanguage = str2;
                                } catch (MissingResourceException e) {
                                    stringBuilder = new StringBuilder();
                                ...
                                str2 = "";
                                try {
                                    str = voice.getLocale().getISO3Country();
                                    str2 = str;
                                } catch (MissingResourceException e2) {
                                    stringBuilder = new StringBuilder();
                                    stringBuilder.append(str);
                                    stringBuilder.append(voice.getLocale());
                                    Log.w(str3, stringBuilder.toString(), e2);
                                }
                                ...
                                TextToSpeech.this.mParams.putString(Engine.KEY_PARAM_COUNTRY, str2);
                        ...
                        country.append(str);
                        country.append(loc);
                        Log.w(str3, country.toString(), e3);
                        return valueOf;
                    }
                    ...
                    Log.w(str3, stringBuilder3.toString(), e4);
                    return valueOf;
                }
            }
    ...
    public Locale getLanguage() {
        return (Locale) runAction(new Action<Locale>() {
            public Locale run(ITextToSpeechService service) {
                String variant = "";
                return new Locale(TextToSpeech.this.mParams.getString("language", variant), TextToSpeech.this.mParams.getString(Engine.KEY_PARAM_COUNTRY, variant), TextToSpeech.this.mParams.getString(Engine.KEY_PARAM_VARIANT, variant));
            }
        }, null, "getLanguage");
    }
        ...
        return (Set) runAction(new Action<Set<Voice>>() {
            public Set<Voice> run(ITextToSpeechService service) throws RemoteException {
                ...
                if (service.getVoices() != null) {
                    hashSet = new HashSet(service.getVoices());
                } else {
                    hashSet = new HashSet();
                }
                return hashSet;
            ...
            public Integer run(ITextToSpeechService service) throws RemoteException {
                ...
                if (result == 0) {
                    ...
                    try {
                        ...
                        Log.w(str, stringBuilder2.toString(), e2);
                    }
    ...
    private Voice getVoice(ITextToSpeechService service, String voiceName) throws RemoteException {
        ...
        String str = TAG;
        if (voices == null) {
            Log.w(str, "getVoices returned null");
            return null;
        }
        for (Voice voice : voices) {
    ...
    public int isLanguageAvailable(final Locale loc) {
        return ((Integer) runAction(new Action<Integer>() {
            public Integer run(ITextToSpeechService service) throws RemoteException {
                StringBuilder stringBuilder;
                String country = TextToSpeech.TAG;
                try {
                    ...
                    try {
                        ...
                        Log.w(country, stringBuilder.toString(), e);
                    ...
                    stringBuilder.append("Couldn't retrieve ISO 639-2/T language code for locale: ");
                    stringBuilder.append(loc);
                    Log.w(country, stringBuilder.toString(), e2);
                    return Integer.valueOf(-2);
                }
            }
