...
public class AccountManager {
    ...
    private abstract class AmsTask extends FutureTask<Bundle> implements AccountManagerFuture<Bundle> {
        ...
        private class Response extends Stub {
            ...
            public void onResult(Bundle bundle) {
                ...
                } else if (!ExtraPackageManager.handleIfContainsXiaomiAccountType(intent)) {
        ...
        /* Access modifiers changed, original: protected */
        public void done() {
            AccountManagerCallback accountManagerCallback = this.mCallback;
            if (accountManagerCallback != null) {
                AccountManager.this.postToHandler(this.mHandler, accountManagerCallback, (AccountManagerFuture) this);
            }
        }
    }
    ...
    private abstract class Future2Task<T> extends BaseFutureTask<T> implements AccountManagerFuture<T> {
        ...
        private T internalGetResult(Long timeout, TimeUnit unit) throws OperationCanceledException, IOException, AuthenticatorException {
            ...
            if (timeout == null) {
                ...
                obj = get(timeout.longValue(), unit);
                cancel(true);
                return obj;
            }
        }
        ...
        public void doWork() throws RemoteException {
            ...
            AccountManager.this.getAccountByTypeAndFeatures(this.mAccountType, this.mFeatures, new AccountManagerCallback<Bundle>() {
                public void run(AccountManagerFuture<Bundle> future) {
                    ...
                    String str2 = AccountManager.KEY_ACCOUNT_NAME;
                    try {
                        Bundle result = (Bundle) future.getResult();
                        String accountName = result.getString(str2);
                        String accountType = result.getString(str);
    ...
    public static Bundle sanitizeResult(Bundle result) {
        if (result != null) {
            String str = KEY_AUTHTOKEN;
            if (result.containsKey(str) && !TextUtils.isEmpty(result.getString(str))) {
                Bundle newResult = new Bundle(result);
                newResult.putString(str, "<omitted for logging purposes>");
                return newResult;
            }
        }
        return result;
        ...
        if (accountType == null) {
            ...
            return new Future2Task<String>(handler, callback) {
                ...
                public String bundleToResult(Bundle bundle) throws AuthenticatorException {
                    String str = AccountManager.KEY_AUTH_TOKEN_LABEL;
        ...
        if (account == null) {
            ...
            return new Future2Task<Boolean>(handler, callback) {
                ...
                public Boolean bundleToResult(Bundle bundle) throws AuthenticatorException {
                    String str = AccountManager.KEY_BOOLEAN_RESULT;
                    if (bundle.containsKey(str)) {
        ...
        if (type != null) {
            ...
            return new Future2Task<Account[]>(handler, callback) {
                ...
                public Account[] bundleToResult(Bundle bundle) throws AuthenticatorException {
                    Parcelable[] parcelables = AccountManager.KEY_ACCOUNTS;
                    if (bundle.containsKey(parcelables)) {
                        parcelables = bundle.getParcelableArray(parcelables);
