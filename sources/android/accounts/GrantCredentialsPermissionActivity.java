...
public class GrantCredentialsPermissionActivity extends Activity implements OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        String accountTypeLabel = this.mAccount;
        if (accountTypeLabel == null || this.mAuthTokenType == null || packages == null) {
            setResult(0);
            finish();
            return;
        }
        try {
            CharSequence accountTypeLabel2 = getAccountLabel(accountTypeLabel);
            ...
            ((TextView) findViewById(R.id.account_type)).setText(accountTypeLabel2);
    ...
    private View newPackageView(String packageLabel) {
        View view = this.mInflater.inflate((int) R.layout.permissions_package_list_item, null);
        ((TextView) view.findViewById(R.id.package_label)).setText((CharSequence) packageLabel);
        return view;
    }
