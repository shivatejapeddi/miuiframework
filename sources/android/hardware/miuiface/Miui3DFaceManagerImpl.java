...
public class Miui3DFaceManagerImpl implements IMiuiFaceManager, ServiceCallback {
    ...
    private class OnAuthenticationCancelListener implements OnCancelListener {
        ...
        /* synthetic */ OnAuthenticationCancelListener(Miui3DFaceManagerImpl x0, AnonymousClass1 x1) {
            this();
        }
    ...
    private class OnEnrollCancelListener implements OnCancelListener {
        ...
        /* synthetic */ OnEnrollCancelListener(Miui3DFaceManagerImpl x0, AnonymousClass1 x1) {
            this();
        }
    ...
    private Miui3DFaceManagerImpl(Context ctx) {
        ...
        this.mHandler = new ClientHandler(this, ctx, null);
    ...
    public boolean isFaceFeatureSupport() {
        if (this.mIsSuperPower) {
            Slog.d(LOG_TAG, "enter super power mode, isFaceFeatureSupport:false");
            return false;
