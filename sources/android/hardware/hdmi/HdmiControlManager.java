...
public final class HdmiControlManager {
    ...
    public boolean isDeviceConnected(HdmiDeviceInfo targetDevice) {
        ...
        if (HdmiUtils.getLocalPortFromPhysicalAddress(targetPhysicalAddress, this.mPhysicalAddress) != -1) {
            z = true;
        }
        return z;
    }
    ...
    public void addHotplugEventListener(HotplugEventListener listener) {
        ...
        String str = TAG;
        if (iHdmiControlService == null) {
            Log.e(str, "HdmiControlService is not available");
        } else if (this.mHotplugEventListeners.containsKey(listener)) {
            Log.e(str, "listener is already registered");
        } else {
    ...
    public void removeHotplugEventListener(HotplugEventListener listener) {
        ...
        if (wrappedListener == null) {
            Log.e(str, "tried to remove not-registered listener");
            return;
        }
        try {
