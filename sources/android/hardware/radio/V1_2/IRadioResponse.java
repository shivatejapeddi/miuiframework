...
public interface IRadioResponse extends android.hardware.radio.V1_1.IRadioResponse {
    ...
    public static abstract class Stub extends HwBinder implements IRadioResponse {
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            ...
            String str = android.hardware.radio.V1_1.IRadioResponse.kInterfaceName;
            String str2 = IRadioResponse.kInterfaceName;
            String str3 = android.hardware.radio.V1_0.IRadioResponse.kInterfaceName;
            boolean z = false;
            boolean z2 = true;
            ...
            switch (_hidl_code) {
                ...
                case 130:
                    ...
                    setCarrierInfoForImsiEncryptionResponse(info2);
                    return;
                case 131:
                    if ((_hidl_flags & 1) != 0) {
                        z = true;
                    ...
                    info2 = new RadioResponseInfo();
                    info2.readFromParcel(hwParcel);
                    setSimCardPowerResponse_1_1(info2);
                    return;
                case 132:
                    if ((_hidl_flags & 1) != 0) {
                        z = true;
                    ...
                    info2 = new RadioResponseInfo();
                    info2.readFromParcel(hwParcel);
                    startNetworkScanResponse(info2);
                    return;
                case 133:
                    if ((_hidl_flags & 1) != 0) {
                        z = true;
                ...
                case 134:
                    ...
                    startKeepaliveResponse(info2, status);
                    return;
                case 135:
                    if ((_hidl_flags & 1) != 0) {
                        z = true;
