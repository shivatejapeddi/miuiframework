...
public final class CellIdentity {
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        childBlob = parcel.readEmbeddedBuffer((long) (_hidl_vec_size * 80), _hidl_blob.handle(), (_hidl_offset + 24) + 0, true);
        ...
        childBlob = parcel.readEmbeddedBuffer((long) (_hidl_vec_size * 56), _hidl_blob.handle(), (_hidl_offset + 40) + 0, true);
        ...
        childBlob = parcel.readEmbeddedBuffer((long) (_hidl_vec_size * 88), _hidl_blob.handle(), (_hidl_offset + 56) + 0, true);
        ...
        childBlob = parcel.readEmbeddedBuffer((long) (_hidl_vec_size2 * 88), _hidl_blob.handle(), (_hidl_offset + 72) + 0, true);
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        ...
        for (int _hidl_index_02 = 0; _hidl_index_02 < _hidl_vec_size; _hidl_index_02++) {
            ((CellIdentityGsm) this.cellIdentityGsm.get(_hidl_index_02)).writeEmbeddedToBlob(childBlob, (long) (_hidl_index_02 * 80));
        }
        ...
        HwBlob childBlob3 = new HwBlob(_hidl_vec_size * 56);
        for (_hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
            ((CellIdentityCdma) this.cellIdentityCdma.get(_hidl_index_0)).writeEmbeddedToBlob(childBlob3, (long) (_hidl_index_0 * 56));
        }
        ...
        childBlob3 = new HwBlob(_hidl_vec_size * 88);
        for (_hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
            ((CellIdentityLte) this.cellIdentityLte.get(_hidl_index_0)).writeEmbeddedToBlob(childBlob3, (long) (_hidl_index_0 * 88));
        }
        ...
        HwBlob childBlob4 = new HwBlob(_hidl_vec_size * 88);
        for (int _hidl_index_04 = 0; _hidl_index_04 < _hidl_vec_size; _hidl_index_04++) {
            ((CellIdentityTdscdma) this.cellIdentityTdscdma.get(_hidl_index_04)).writeEmbeddedToBlob(childBlob4, (long) (_hidl_index_04 * 88));
        }
