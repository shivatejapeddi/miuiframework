...
public final class NetworkScanRequest {
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        HwBlob childBlob2 = hwParcel2.readEmbeddedBuffer((long) (_hidl_vec_size2 * 16), _hidl_blob.handle(), (_hidl_offset + 40) + 0, true);
        this.mccMncs.clear();
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        ...
        for (int _hidl_index_02 = 0; _hidl_index_02 < _hidl_vec_size; _hidl_index_02++) {
            childBlob2.putString((long) (_hidl_index_02 * 16), (String) this.mccMncs.get(_hidl_index_02));
        }
