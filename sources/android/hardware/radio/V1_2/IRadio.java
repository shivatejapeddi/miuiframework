...
public interface IRadio extends android.hardware.radio.V1_1.IRadio {
    ...
    public static abstract class Stub extends HwBinder implements IRadio {
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            ...
            String str2 = android.hardware.radio.V1_1.IRadio.kInterfaceName;
            String str3 = android.hardware.radio.V1_0.IRadio.kInterfaceName;
            boolean z = false;
            boolean z2 = true;
            int serial;
            ...
            switch (_hidl_code) {
                ...
                case 137:
                    ...
                    startNetworkScan_1_2(serial3, request2);
                    return;
                case 138:
                    if ((_hidl_flags & 1) != 0) {
                        z = true;
                ...
                case 141:
                    ...
                    setupDataCall_1_2(serial4, accessNetwork, dataProfileInfo3, _hidl_request.readBool(), _hidl_request.readBool(), _hidl_request.readBool(), _hidl_request.readInt32(), _hidl_request.readStringVector(), _hidl_request.readStringVector());
                    return;
                case 142:
                    if ((_hidl_flags & 1) != 0) {
                        z = true;
