...
public final class CellInfo {
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        childBlob = parcel.readEmbeddedBuffer((long) (_hidl_vec_size * 80), _hidl_blob.handle(), (_hidl_offset + 40) + 0, true);
        this.cdma.clear();
        for (_hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
        ...
        childBlob = parcel.readEmbeddedBuffer((long) (_hidl_vec_size * 112), _hidl_blob.handle(), (_hidl_offset + 56) + 0, true);
        this.lte.clear();
        for (_hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
        ...
        childBlob = parcel.readEmbeddedBuffer((long) (_hidl_vec_size * 96), _hidl_blob.handle(), (_hidl_offset + 72) + 0, true);
        this.wcdma.clear();
        for (_hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
        ...
        childBlob = parcel.readEmbeddedBuffer((long) (_hidl_vec_size2 * 104), _hidl_blob.handle(), (_hidl_offset + 88) + 0, true);
        this.tdscdma.clear();
        for (_hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size2; _hidl_index_0++) {
            CellInfoTdscdma _hidl_vec_element5 = new CellInfoTdscdma();
            _hidl_vec_element5.readEmbeddedFromParcel(hwParcel, childBlob, (long) (_hidl_index_0 * 104));
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        ...
        HwBlob childBlob2 = new HwBlob(_hidl_vec_size * 104);
        for (int _hidl_index_02 = 0; _hidl_index_02 < _hidl_vec_size; _hidl_index_02++) {
            ((CellInfoTdscdma) this.tdscdma.get(_hidl_index_02)).writeEmbeddedToBlob(childBlob2, (long) (_hidl_index_02 * 104));
        }
