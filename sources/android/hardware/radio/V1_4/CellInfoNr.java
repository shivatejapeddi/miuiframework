...
public final class CellInfoNr {
    ...
    public final int hashCode() {
        return Objects.hash(new Object[]{Integer.valueOf(HidlSupport.deepHashCode(this.signalStrength)), Integer.valueOf(HidlSupport.deepHashCode(this.cellidentity))});
    }
    ...
    public static final void writeVectorToParcel(HwParcel parcel, ArrayList<CellInfoNr> _hidl_vec) {
        ...
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
            ((CellInfoNr) _hidl_vec.get(_hidl_index_0)).writeEmbeddedToBlob(childBlob, (long) (_hidl_index_0 * 112));
        }
