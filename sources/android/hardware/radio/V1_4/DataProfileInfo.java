...
public final class DataProfileInfo {
    ...
    public final String toString() {
        ...
        builder.append(PdpProtocolType.toString(this.protocol));
        builder.append(", .roamingProtocol = ");
        builder.append(PdpProtocolType.toString(this.roamingProtocol));
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        this.password = hwBlob.getString(_hidl_offset + 56);
    ...
    public static final void writeVectorToParcel(HwParcel parcel, ArrayList<DataProfileInfo> _hidl_vec) {
        ...
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
            ((DataProfileInfo) _hidl_vec.get(_hidl_index_0)).writeEmbeddedToBlob(childBlob, (long) (_hidl_index_0 * 112));
        }
