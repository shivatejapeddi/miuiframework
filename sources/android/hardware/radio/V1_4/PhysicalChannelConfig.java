...
public final class PhysicalChannelConfig {
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        this.rat = hwBlob.getInt32(_hidl_offset + 8);
        this.rfInfo.readEmbeddedFromParcel(parcel, hwBlob, _hidl_offset + 12);
        ...
        this.physicalCellId = hwBlob.getInt32(_hidl_offset + 40);
    }
    ...
    public static final void writeVectorToParcel(HwParcel parcel, ArrayList<PhysicalChannelConfig> _hidl_vec) {
        ...
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
            ((PhysicalChannelConfig) _hidl_vec.get(_hidl_index_0)).writeEmbeddedToBlob(childBlob, (long) (_hidl_index_0 * 48));
        }
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        ...
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
            childBlob.putInt32((long) (_hidl_index_0 * 4), ((Integer) this.contextIds.get(_hidl_index_0)).intValue());
        }
