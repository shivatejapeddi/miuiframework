...
public final class CellConfigLte {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (this.isEndcAvailable != ((CellConfigLte) otherObject).isEndcAvailable) {
            return false;
        }
        return true;
    }
    ...
    public static final void writeVectorToParcel(HwParcel parcel, ArrayList<CellConfigLte> _hidl_vec) {
        ...
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
            ((CellConfigLte) _hidl_vec.get(_hidl_index_0)).writeEmbeddedToBlob(childBlob, (long) (_hidl_index_0 * 1));
        }
