...
public final class CellIdentityNr {
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        this.nci = hwBlob.getInt64(_hidl_offset + 32);
        this.pci = hwBlob.getInt32(_hidl_offset + 40);
        this.tac = hwBlob.getInt32(_hidl_offset + 44);
        this.nrarfcn = hwBlob.getInt32(_hidl_offset + 48);
        this.operatorNames.readEmbeddedFromParcel(parcel, hwBlob, _hidl_offset + 56);
    }
    ...
    public static final void writeVectorToParcel(HwParcel parcel, ArrayList<CellIdentityNr> _hidl_vec) {
        ...
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
            ((CellIdentityNr) _hidl_vec.get(_hidl_index_0)).writeEmbeddedToBlob(childBlob, (long) (_hidl_index_0 * 88));
        }
