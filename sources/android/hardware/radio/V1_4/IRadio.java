...
public interface IRadio extends android.hardware.radio.V1_3.IRadio {
    ...
    public static final class Proxy implements IRadio {
        ...
        public void emergencyDial(int serial, Dial dialInfo, int categories, ArrayList<String> urns, int routing, boolean hasKnownUserIntentEmergency, boolean isTesting) throws RemoteException {
            ...
            _hidl_request.writeStringVector((ArrayList) urns);
    ...
    public static abstract class Stub extends HwBinder implements IRadio {
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            ...
            String str = android.hardware.radio.V1_3.IRadio.kInterfaceName;
            ...
            String str4 = IRadio.kInterfaceName;
            String str5 = android.hardware.radio.V1_0.IRadio.kInterfaceName;
            ...
            switch (_hidl_code) {
                ...
                case 28:
                    ...
                    radioTechnology = _hidl_request.readInt32();
                ...
                case 133:
                    ...
                    startNetworkScan(serial, request2);
                    return;
                case 134:
                    if ((_hidl_flags & 1) != 0) {
                        _hidl_is_oneway = true;
                ...
                case 137:
                    ...
                    serial = _hidl_request.readInt32();
                    request = new android.hardware.radio.V1_2.NetworkScanRequest();
                ...
                case 146:
                    ...
                    setupDataCall_1_4(radioTechnology, accessNetwork2, dataProfileInfo4, _hidl_request.readBool(), _hidl_request.readInt32(), _hidl_request.readStringVector(), _hidl_request.readStringVector());
                    return;
                case 147:
                    if ((_hidl_flags & 1) != 0) {
                        _hidl_is_oneway = true;
                    ...
                    setInitialAttachApn_1_4(serial, dataProfileInfo5);
                    return;
                case 148:
                    if ((_hidl_flags & 1) != 0) {
                        _hidl_is_oneway = true;
                ...
                case 149:
                    ...
                    emergencyDial(radioTechnology, dialInfo2, _hidl_request.readInt32(), _hidl_request.readStringVector(), _hidl_request.readInt32(), _hidl_request.readBool(), _hidl_request.readBool());
                    return;
                case 150:
                    if ((_hidl_flags & 1) != 0) {
                        _hidl_is_oneway = true;
                ...
                case 153:
                    ...
                    setAllowedCarriers_1_4(serial, carriers2, _hidl_request.readInt32());
                    return;
                case 154:
                    if ((_hidl_flags & 1) != 0) {
                        _hidl_is_oneway = true;
    ...
    void startNetworkScan_1_4(int i, android.hardware.radio.V1_2.NetworkScanRequest networkScanRequest) throws RemoteException;
