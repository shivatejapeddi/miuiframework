...
public final class NrIndicators {
    ...
    public final int hashCode() {
        return Objects.hash(new Object[]{Integer.valueOf(HidlSupport.deepHashCode(Boolean.valueOf(this.isEndcAvailable))), Integer.valueOf(HidlSupport.deepHashCode(Boolean.valueOf(this.isDcNrRestricted))), Integer.valueOf(HidlSupport.deepHashCode(Boolean.valueOf(this.isNrAvailable)))});
    }
    ...
    public static final void writeVectorToParcel(HwParcel parcel, ArrayList<NrIndicators> _hidl_vec) {
        ...
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
            ((NrIndicators) _hidl_vec.get(_hidl_index_0)).writeEmbeddedToBlob(childBlob, (long) (_hidl_index_0 * 3));
        }
