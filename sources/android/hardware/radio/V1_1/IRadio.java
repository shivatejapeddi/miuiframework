...
public interface IRadio extends android.hardware.radio.V1_0.IRadio {
    ...
    public static abstract class Stub extends HwBinder implements IRadio {
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            ...
            String str2 = android.hardware.radio.V1_0.IRadio.kInterfaceName;
            boolean z = false;
            boolean z2 = true;
            int serial;
            ...
            switch (_hidl_code) {
                ...
                case 28:
                    ...
                    setupDataCall(serial3, radioTechnology, dataProfileInfo, _hidl_request.readBool(), _hidl_request.readBool(), _hidl_request.readBool());
                    return;
                case 29:
                    if ((_hidl_flags & 1) != 0) {
                        z = true;
                ...
                case 133:
                    ...
                    startNetworkScan(serial2, request);
                    return;
                case 134:
                    if ((_hidl_flags & 1) != 0) {
                        z = true;
                ...
                case 135:
                    ...
                    startKeepalive(serial2, keepalive);
                    return;
                case 136:
                    if ((_hidl_flags & 1) != 0) {
                        z = true;
