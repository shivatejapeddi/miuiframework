...
public final class RadioAccessSpecifier {
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        for (int _hidl_index_03 = 0; _hidl_index_03 < _hidl_vec_size2; _hidl_index_03++) {
            this.channels.add(Integer.valueOf(childBlob3.getInt32((long) (_hidl_index_03 * 4))));
        }
    }
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        ...
        for (int _hidl_index_04 = 0; _hidl_index_04 < _hidl_vec_size; _hidl_index_04++) {
            childBlob4.putInt32((long) (_hidl_index_04 * 4), ((Integer) this.channels.get(_hidl_index_04)).intValue());
        }
