...
public final class CdmaInformationRecord {
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        _hidl_vec_size = hwBlob.getInt32((_hidl_offset + 24) + 8);
        childBlob = parcel.readEmbeddedBuffer((long) (_hidl_vec_size * 24), _hidl_blob.handle(), (_hidl_offset + 24) + 0, true);
        this.number.clear();
        for (_hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
        ...
        _hidl_vec_size = hwBlob.getInt32((_hidl_offset + 40) + 8);
        childBlob = parcel.readEmbeddedBuffer((long) (_hidl_vec_size * 4), _hidl_blob.handle(), (_hidl_offset + 40) + 0, true);
        this.signal.clear();
        for (_hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
        ...
        childBlob = parcel.readEmbeddedBuffer((long) (_hidl_vec_size * 32), _hidl_blob.handle(), (_hidl_offset + 56) + 0, true);
        this.redir.clear();
        for (_hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
        ...
        childBlob = parcel.readEmbeddedBuffer((long) (_hidl_vec_size * 4), _hidl_blob.handle(), (_hidl_offset + 72) + 0, true);
        this.lineCtrl.clear();
        for (_hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
        ...
        _hidl_vec_size = hwBlob.getInt32((_hidl_offset + 88) + 8);
        childBlob = parcel.readEmbeddedBuffer((long) (_hidl_vec_size * 1), _hidl_blob.handle(), (_hidl_offset + 88) + 0, true);
        this.clir.clear();
        for (_hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
        ...
        childBlob = parcel.readEmbeddedBuffer((long) (_hidl_vec_size2 * 2), _hidl_blob.handle(), (_hidl_offset + 104) + 0, true);
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        ...
        for (int _hidl_index_02 = 0; _hidl_index_02 < _hidl_vec_size; _hidl_index_02++) {
            ((CdmaDisplayInfoRecord) this.display.get(_hidl_index_02)).writeEmbeddedToBlob(childBlob, (long) (_hidl_index_02 * 16));
        }
        ...
        for (_hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
            ((CdmaSignalInfoRecord) this.signal.get(_hidl_index_0)).writeEmbeddedToBlob(childBlob3, (long) (_hidl_index_0 * 4));
        }
        ...
        childBlob3 = new HwBlob(_hidl_vec_size * 32);
        for (_hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
            ((CdmaRedirectingNumberInfoRecord) this.redir.get(_hidl_index_0)).writeEmbeddedToBlob(childBlob3, (long) (_hidl_index_0 * 32));
        }
        ...
        childBlob3 = new HwBlob(_hidl_vec_size * 4);
        for (_hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
            ((CdmaLineControlInfoRecord) this.lineCtrl.get(_hidl_index_0)).writeEmbeddedToBlob(childBlob3, (long) (_hidl_index_0 * 4));
        }
        ...
        for (_hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
            ((CdmaT53ClirInfoRecord) this.clir.get(_hidl_index_0)).writeEmbeddedToBlob(childBlob3, (long) (_hidl_index_0 * 1));
        }
        hwBlob.putBlob((_hidl_offset + 88) + 0, childBlob3);
        ...
        HwBlob childBlob4 = new HwBlob(_hidl_vec_size * 2);
        for (int _hidl_index_04 = 0; _hidl_index_04 < _hidl_vec_size; _hidl_index_04++) {
            ((CdmaT53AudioControlInfoRecord) this.audioCtrl.get(_hidl_index_04)).writeEmbeddedToBlob(childBlob4, (long) (_hidl_index_04 * 2));
        }
        hwBlob.putBlob((_hidl_offset + 104) + 0, childBlob4);
    }
}
