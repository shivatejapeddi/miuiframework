...
public final class SessionConfiguration implements Parcelable {
    public static final Creator<SessionConfiguration> CREATOR = new Creator<SessionConfiguration>() {
        public SessionConfiguration createFromParcel(Parcel source) {
            try {
                return new SessionConfiguration(source, null);
            } catch (Exception e) {
    ...
    /* synthetic */ SessionConfiguration(Parcel x0, AnonymousClass1 x1) {
        this(x0);
    }
    ...
    public boolean equals(Object obj) {
        ...
        for (int i = 0; i < this.mOutputConfigurations.size(); i++) {
            if (!((OutputConfiguration) this.mOutputConfigurations.get(i)).equals(other.mOutputConfigurations.get(i))) {
                return false;
            }
        }
        return true;
