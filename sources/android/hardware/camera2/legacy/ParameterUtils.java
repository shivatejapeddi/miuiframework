...
public class ParameterUtils {
    ...
    public static class WeightedRectangle {
        ...
        public MeteringRectangle toMetering() {
            ...
            return new MeteringRectangle(clipLower(this.rect.left, 0, this.rect, "left"), clipLower(this.rect.top, 0, this.rect, "top"), clipLower(this.rect.width(), 0, this.rect, "width"), clipLower(this.rect.height(), 0, this.rect, "height"), weight);
        }
        ...
        private static int clip(int value, int lo, int hi, Rect rect, String name) {
            String str = " too small, clip to ";
            String str2 = WifiEnterpriseConfig.CA_CERT_ALIAS_DELIMITER;
            String str3 = "toMetering - Rectangle ";
            String str4 = ParameterUtils.TAG;
    ...
    public static ZoomData convertScalerCropRegion(Rect activeArraySize, Rect cropRegion, Size previewSize, Parameters params) {
        ...
        Rect userCropRegion2 = cropRegion;
        if (userCropRegion2 == null) {
            userCropRegion = activeArraySizeOnly;
        } else {
            userCropRegion = userCropRegion2;
        }
