...
public class LegacyMetadataMapper {
    ...
    public static CameraCharacteristics createCharacteristics(Parameters parameters, CameraInfo info, int cameraId, Size displaySize) {
    ...
    public static CameraCharacteristics createCharacteristics(String parameters, android.hardware.CameraInfo info, int cameraId, Size displaySize) {
        Preconditions.checkNotNull(parameters, "parameters must not be null");
        Preconditions.checkNotNull(info, "info must not be null");
    ...
    private static void mapScalerStreamConfigs(CameraMetadataNative m, Parameters p) {
        ...
        while (!previewSizes.isEmpty()) {
            ...
            size = (Camera.Size) previewSizes.get(index);
        ...
        for (Camera.Size size2 : jpegSizes) {
    ...
    private static void mapControlAe(CameraMetadataNative m, Parameters p) {
        ...
        if (fpsRanges != null) {
            ...
            if (j > 0) {
                ...
                ranges = ArrayUtils.convertStringListToIntArray(p.getSupportedFlashModes(), new String[]{"off", "auto", "on", Parameters.FLASH_MODE_RED_EYE, Parameters.FLASH_MODE_TORCH}, new int[]{1, 2, 3, 4});
    ...
    private static void mapSensor(CameraMetadataNative m, Parameters p) {
        ...
        Object activeArrayRect = ParamsUtils.createRect((Size) largestJpegSize);
        ...
        m.set(CameraCharacteristics.SENSOR_INFO_PHYSICAL_SIZE, new SizeF(width, (float) Math.abs(((double) (focalLength * 2.0f)) * Math.tan(((((double) p.getVerticalViewAngle()) * 3.141592653589793d) / 180.0d) / 2.0d))));
    ...
    L_0x0004:
        ...
        r5 = 1;
        switch(r1) {
            case 109935: goto L_0x002e;
            case 1628397: goto L_0x0024;
            case 1658188: goto L_0x001a;
            case 3005871: goto L_0x0010;
    ...
    L_0x0042:
        ...
        r1.<init>();
        r2 = "convertAntiBandingMode - Unknown antibanding mode ";
        r1.append(r2);
        r1.append(r6);
        r1 = r1.toString();
        r2 = "LegacyMetadataMapper";
    ...
    static String convertAfModeToLegacy(int mode, List<String> supportedFocusModes) {
        ...
        if (supportedFocusModes == null || supportedFocusModes.isEmpty()) {
            Log.w(str, "No focus modes supported; API1 bug");
            return null;
        }
        String param = null;
        if (mode != 0) {
        ...
        } else if (supportedFocusModes.contains(Parameters.FOCUS_MODE_FIXED)) {
            param = Parameters.FOCUS_MODE_FIXED;
        } else {
            param = Parameters.FOCUS_MODE_INFINITY;
        }
        if (!supportedFocusModes.contains(param)) {
            Log.w(str, String.format("convertAfModeToLegacy - ignoring unsupported mode %d, defaulting to %s", new Object[]{Integer.valueOf(mode), (String) supportedFocusModes.get(0)}));
            param = defaultMode;
        }
        return param;
    }
