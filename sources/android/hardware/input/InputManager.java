...
public final class InputManager {
    ...
    public android.view.InputDevice getInputDevice(int r6) {
        /*
        r5 = this;
        r0 = r5.mInputDevicesLock;
        monitor-enter(r0);
        r5.populateInputDevicesLocked();	 Catch:{ all -> 0x0033 }
        r1 = r5.mInputDevices;	 Catch:{ all -> 0x0033 }
        r1 = r1.indexOfKey(r6);	 Catch:{ all -> 0x0033 }
    ...
    L_0x000e:
        ...
        return r2;
    L_0x0011:
        r2 = r5.mInputDevices;	 Catch:{ all -> 0x0033 }
        r2 = r2.valueAt(r1);	 Catch:{ all -> 0x0033 }
        r2 = (android.view.InputDevice) r2;	 Catch:{ all -> 0x0033 }
        if (r2 != 0) goto L_0x0031;
    L_0x001b:
        r3 = r5.mIm;	 Catch:{ RemoteException -> 0x002b }
        r3 = r3.getInputDevice(r6);	 Catch:{ RemoteException -> 0x002b }
        r2 = r3;
        if (r2 == 0) goto L_0x0031;
    L_0x0025:
        r3 = r5.mInputDevices;	 Catch:{ all -> 0x0033 }
        r3.setValueAt(r1, r2);	 Catch:{ all -> 0x0033 }
        goto L_0x0031;
    L_0x002b:
        r3 = move-exception;
        r4 = r3.rethrowFromSystemServer();	 Catch:{ all -> 0x0033 }
    ...
    public void switchTouchSensitiveMode(boolean modeOn) {
        if (modeOn) {
            try {
                this.mIm.switchTouchSensitiveMode(true);
            } catch (RemoteException ex) {
                Log.w(TAG, "SwitchTouchSensitiveMode: Error is :", ex);
                return;
            }
        }
        this.mIm.switchTouchSensitiveMode(false);
    }

    public void switchTouchStylusMode(boolean modeOn) {
        if (modeOn) {
            try {
                this.mIm.switchTouchStylusMode(true);
            } catch (RemoteException ex) {
                Log.w(TAG, "SwitchTouchStylusMode: Error is :", ex);
                return;
            }
        }
        this.mIm.switchTouchStylusMode(false);
    }

    public void switchTouchWakeupMode(boolean modeOn) {
        if (modeOn) {
            try {
                this.mIm.switchTouchWakeupMode(true);
            } catch (RemoteException ex) {
                Log.w(TAG, "SwitchTouchWakeupMode: Error is :", ex);
                return;
            }
        }
        this.mIm.switchTouchWakeupMode(false);
    }

    public void switchTouchCoverMode(boolean modeOn) {
        if (modeOn) {
            try {
                this.mIm.switchTouchCoverMode(true);
            } catch (RemoteException ex) {
                Log.w(TAG, "SwitchTouchCoverMode: Error is :", ex);
                return;
            }
        }
        this.mIm.switchTouchCoverMode(false);
    }
