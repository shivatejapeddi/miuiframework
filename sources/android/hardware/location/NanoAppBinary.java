    ...
    private void parseBinaryHeader() {
        ...
        try {
            ...
            if (this.mMagic != EXPECTED_MAGIC_VALUE) {
                ...
                String str3 = "0x%08X";
                stringBuilder2.append(String.format(str3, new Object[]{Integer.valueOf(this.mMagic)}));
                stringBuilder2.append("while parsing header (expected ");
                stringBuilder2.append(String.format(str3, new Object[]{Integer.valueOf(EXPECTED_MAGIC_VALUE)}));
            ...
            Log.e(str, "Not enough contents in nanoapp header");
        }
    }
