...
public class Camera {
        ...
        public void handleMessage(Message msg) {
            ...
            if (i == 1) {
                ...
                if (pCb != null) {
                    ...
                    CameraInjector.processPreviewFrame(this.mCamera, (byte[]) msg.obj);
                ...
                for (int i3 = 0; i3 < 257; i3++) {
                    statsdata[i3] = Camera.byteToInt((byte[]) msg.obj, i3 * 4);
                }
    ...
    public class Parameters {
        ...
        public void dump() {
            ...
            for (String k : this.mMap.keySet()) {
                ...
                stringBuilder3.append("dump: ");
                stringBuilder3.append(k);
                stringBuilder3.append("=");
                stringBuilder3.append((String) this.mMap.get(k));
        ...
        public void set(String key, String value) {
            int indexOf = key.indexOf(61);
            String str = "\" contains invalid character (= or ; or \\0)";
            String str2 = Camera.TAG;
            StringBuilder stringBuilder;
            if (indexOf != -1 || key.indexOf(59) != -1 || key.indexOf(0) != -1) {
                stringBuilder = new StringBuilder();
        ...
        public void setPreviewFpsRange(int min, int max) {
            ...
            set(KEY_PREVIEW_FPS_RANGE, stringBuilder.toString());
        }
        ...
        public void setWhiteBalance(String value) {
            String str = KEY_WHITE_BALANCE;
            if (!same(value, get(str))) {
                set(str, value);
        ...
        public void setTouchIndexAec(int x, int y) {
            String v = new StringBuilder();
            v.append(Integer.toString(x));
            v.append("x");
            v.append(Integer.toString(y));
            set(KEY_QC_TOUCH_INDEX_AEC, v.toString());
        }
        ...
        public void setTouchIndexAf(int x, int y) {
            ...
            v.append("x");
            v.append(Integer.toString(y));
            set(KEY_QC_TOUCH_INDEX_AF, v.toString());
        }
        ...
        private Coordinate strToCoordinate(String str) {
            ...
            int pos = str.indexOf(120);
            if (pos != -1) {
                return new Coordinate(Integer.parseInt(str.substring(null, pos)), Integer.parseInt(str.substring(pos + 1)));
            }
            StringBuilder stringBuilder = new StringBuilder();
    ...
    private int cameraInitVersion(int cameraId, int halVersion) {
        ...
        CameraInjector.initCamera(this, cameraId);
    ...
    public final void release() {
        CameraInjector.releaseCamera(this);
        native_release();
    ...
    private static void postEventFromNative(Object camera_ref, int what, int arg1, int arg2, Object obj) {
        ...
        if (c != null) {
            Message m = c.mEventHandler;
            if (m != null) {
                c.mEventHandler.sendMessage(m.obtainMessage(what, arg1, arg2, obj));
            }
        }
    }
    ...
    public final void takePicture(ShutterCallback shutter, PictureCallback raw, PictureCallback postview, PictureCallback jpeg) {
        ...
        CameraInjector.takePicture(this);
    ...
    private void updateAppOpsPlayAudio() {
        /*
        r9 = this;
        r0 = r9.mShutterSoundLock;
        monitor-enter(r0);
        r1 = r9.mHasAppOpsPlayAudio;	 Catch:{ all -> 0x005f }
        r2 = 1;
        r3 = 0;
        r4 = r9.mAppOps;	 Catch:{ RemoteException -> 0x0026 }
        if (r4 == 0) goto L_0x001e;
    L_0x000b:
        r4 = r9.mAppOps;	 Catch:{ RemoteException -> 0x0026 }
        r5 = 28;
        r6 = 13;
        r7 = android.os.Process.myUid();	 Catch:{ RemoteException -> 0x0026 }
        r8 = android.app.ActivityThread.currentPackageName();	 Catch:{ RemoteException -> 0x0026 }
        r4 = r4.checkAudioOperation(r5, r6, r7, r8);	 Catch:{ RemoteException -> 0x0026 }
        r2 = r4;
    L_0x001e:
    ...
    L_0x0026:
        r2 = move-exception;
        r4 = "Camera";
        r5 = "AppOpsService check audio operation failed";
        android.util.Log.e(r4, r5);	 Catch:{ all -> 0x005f }
        r9.mHasAppOpsPlayAudio = r3;	 Catch:{ all -> 0x005f }
    L_0x0030:
        r2 = r9.mHasAppOpsPlayAudio;	 Catch:{ all -> 0x005f }
    ...
    L_0x0038:
        r2 = "audio";
        r2 = android.os.ServiceManager.getService(r2);	 Catch:{ all -> 0x005f }
        r4 = android.media.IAudioService.Stub.asInterface(r2);	 Catch:{ all -> 0x005f }
        r5 = r4.isCameraSoundForced();	 Catch:{ RemoteException -> 0x004b }
    ...
    L_0x004b:
        r5 = move-exception;
        r6 = "Camera";
        r7 = "Audio service is unavailable for queries";
        android.util.Log.e(r6, r7);	 Catch:{ all -> 0x005f }
    L_0x0053:
        r9._enableShutterSound(r3);	 Catch:{ all -> 0x005f }
        goto L_0x005d;
    L_0x0058:
        r2 = r9.mShutterSoundEnabledFromApp;	 Catch:{ all -> 0x005f }
        r9.enableShutterSound(r2);	 Catch:{ all -> 0x005f }
    L_0x005d:
        monitor-exit(r0);	 Catch:{ all -> 0x005f }
        return;
    L_0x005f:
    ...
    public void setParameters(Parameters params) {
        ...
        CameraInjector.setParametersEx(this, params);
