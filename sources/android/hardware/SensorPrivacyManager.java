...
import android.hardware.ISensorPrivacyManager.Stub;
...
public final class SensorPrivacyManager {
    ...
    public static SensorPrivacyManager getInstance(Context context) {
        ...
        synchronized (sInstanceLock) {
            if (sInstance == null) {
                try {
                    sInstance = new SensorPrivacyManager(context, Stub.asInterface(ServiceManager.getServiceOrThrow(Context.SENSOR_PRIVACY_SERVICE)));
    ...
    public void addSensorPrivacyListener(final OnSensorPrivacyChangedListener listener) {
        synchronized (this.mListeners) {
            ISensorPrivacyListener iListener = (ISensorPrivacyListener) this.mListeners.get(listener);
            if (iListener == null) {
