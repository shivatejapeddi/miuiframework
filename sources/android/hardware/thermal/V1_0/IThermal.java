...
public interface IThermal extends IBase {
    ...
    public static abstract class Stub extends HwBinder implements IThermal {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList(Arrays.asList(new String[]{IThermal.kInterfaceName, IBase.kInterfaceName}));
        }
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, final HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            String str = IThermal.kInterfaceName;
