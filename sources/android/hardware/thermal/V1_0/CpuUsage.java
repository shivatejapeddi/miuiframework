...
public final class CpuUsage {
    ...
    public final int hashCode() {
        return Objects.hash(new Object[]{Integer.valueOf(HidlSupport.deepHashCode(this.name)), Integer.valueOf(HidlSupport.deepHashCode(Long.valueOf(this.active))), Integer.valueOf(HidlSupport.deepHashCode(Long.valueOf(this.total))), Integer.valueOf(HidlSupport.deepHashCode(Boolean.valueOf(this.isOnline)))});
    }
    ...
    public static final void writeVectorToParcel(HwParcel parcel, ArrayList<CpuUsage> _hidl_vec) {
        ...
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
            ((CpuUsage) _hidl_vec.get(_hidl_index_0)).writeEmbeddedToBlob(childBlob, (long) (_hidl_index_0 * 40));
        }
