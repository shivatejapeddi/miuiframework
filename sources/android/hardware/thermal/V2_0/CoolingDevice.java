...
public final class CoolingDevice {
    ...
    public final int hashCode() {
        return Objects.hash(new Object[]{Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.type))), Integer.valueOf(HidlSupport.deepHashCode(this.name)), Integer.valueOf(HidlSupport.deepHashCode(Long.valueOf(this.value)))});
    }
    ...
    public final String toString() {
        ...
        builder.append("{");
        builder.append(".type = ");
        builder.append(CoolingType.toString(this.type));
        builder.append(", .name = ");
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        this.value = hwBlob.getInt64(_hidl_offset + 24);
    }
    ...
    public static final void writeVectorToParcel(HwParcel parcel, ArrayList<CoolingDevice> _hidl_vec) {
        ...
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
            ((CoolingDevice) _hidl_vec.get(_hidl_index_0)).writeEmbeddedToBlob(childBlob, (long) (_hidl_index_0 * 32));
        }
