...
public final class Temperature {
    ...
    public final int hashCode() {
        return Objects.hash(new Object[]{Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.type))), Integer.valueOf(HidlSupport.deepHashCode(this.name)), Integer.valueOf(HidlSupport.deepHashCode(Float.valueOf(this.value))), Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.throttlingStatus)))});
    }
    ...
    public final String toString() {
        ...
        builder.append(ThrottlingSeverity.toString(this.throttlingStatus));
        builder.append("}");
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        this.value = hwBlob.getFloat(_hidl_offset + 24);
        this.throttlingStatus = hwBlob.getInt32(_hidl_offset + 28);
    }
    ...
    public static final void writeVectorToParcel(HwParcel parcel, ArrayList<Temperature> _hidl_vec) {
        ...
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
            ((Temperature) _hidl_vec.get(_hidl_index_0)).writeEmbeddedToBlob(childBlob, (long) (_hidl_index_0 * 32));
        }
