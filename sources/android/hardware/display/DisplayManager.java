...
public final class DisplayManager {
    ...
    private Display getOrCreateDisplayLocked(int displayId, boolean assumeValid) {
        ...
        if (display == null) {
            display = this.mGlobal.getCompatibleDisplay(displayId, (this.mContext.getDisplayId() == displayId ? this.mContext : this.mContext.getApplicationContext()).getResources());
            if (display == null) {
                return display;
            }
