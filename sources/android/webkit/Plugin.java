    ...
    private class DefaultClickHandler implements PreferencesClickHandler, OnClickListener {
        ...
        public void handleClickEvent(Context context) {
            if (this.mDialog == null) {
                this.mDialog = new Builder(context).setTitle(Plugin.this.mName).setMessage(Plugin.this.mDescription).setPositiveButton(17039370, (OnClickListener) this).setCancelable(false).show();
            }
        }
