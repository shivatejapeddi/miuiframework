...
public class Matrix4f {
    ...
    public void loadRotate(float rot, float x, float y, float z) {
        ...
        fArr2[0] = ((x2 * x2) * nc) + c;
        fArr2[4] = (recipLen * nc) - zs;
        fArr2[8] = (zx * nc) + ys;
        fArr2[1] = (recipLen * nc) + zs;
        fArr2[5] = ((y2 * y2) * nc) + c;
        fArr2[9] = (yz * nc) - xs;
        fArr2[2] = (zx * nc) - ys;
        fArr2[6] = (yz * nc) + xs;
    ...
    public boolean inverse() {
        ...
        f = (((f * fArr2[0]) + (fArr[4] * fArr2[1])) + (fArr[8] * fArr2[2])) + (fArr[12] * fArr2[3]);
        if (((double) Math.abs(f)) < 1.0E-6d) {
            return false;
        }
        float det = 1.0f / f;
        for (int i2 = 0; i2 < 16; i2++) {
            this.mMat[i2] = result.mMat[i2] * det;
        }
        return true;
    }
    ...
    public boolean inverseTranspose() {
        ...
        float f = fArr[0];
        float[] fArr2 = result.mMat;
        f = (((f * fArr2[0]) + (fArr[4] * fArr2[4])) + (fArr[8] * fArr2[8])) + (fArr[12] * fArr2[12]);
        if (((double) Math.abs(f)) < 1.0E-6d) {
            return false;
        }
        float det = 1.0f / f;
