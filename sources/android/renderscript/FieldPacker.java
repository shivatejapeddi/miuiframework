...
public class FieldPacker {
    ...
    public void addI64(long v) {
        ...
        int i2 = this.mPos;
        this.mPos = i2 + 1;
        bArr[i2] = (byte) ((int) ((v >> 16) & 255));
        i2 = this.mPos;
        this.mPos = i2 + 1;
        bArr[i2] = (byte) ((int) ((v >> 24) & 255));
        i2 = this.mPos;
        this.mPos = i2 + 1;
        bArr[i2] = (byte) ((int) ((v >> 32) & 255));
        i2 = this.mPos;
        this.mPos = i2 + 1;
        bArr[i2] = (byte) ((int) ((v >> 40) & 255));
        i2 = this.mPos;
        this.mPos = i2 + 1;
        bArr[i2] = (byte) ((int) ((v >> 48) & 255));
        i2 = this.mPos;
        this.mPos = i2 + 1;
        bArr[i2] = (byte) ((int) ((v >> 56) & 255));
    }
