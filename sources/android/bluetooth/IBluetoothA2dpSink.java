        ...
        private static class Proxy implements IBluetoothA2dpSink {
            ...
            public BluetoothAudioConfig getAudioConfig(BluetoothDevice device) throws RemoteException {
                ...
                try {
                    ...
                    BluetoothAudioConfig bluetoothAudioConfig = this.mRemote;
                    if (!bluetoothAudioConfig.transact(6, _data, _reply, 0)) {
                        bluetoothAudioConfig = Stub.getDefaultImpl();
                        if (bluetoothAudioConfig != null) {
                            bluetoothAudioConfig = Stub.getDefaultImpl().getAudioConfig(device);
