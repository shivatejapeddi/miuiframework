        ...
        if (fraction <= 0.0f) {
            ...
            for (int i2 = 1; i2 < this.mNumKeyframes; i2++) {
                ...
                if (fraction < nextKeyframe2.getFraction()) {
                    ...
                    prevFraction = (fraction - prevKeyframe.getFraction()) / (nextKeyframe2.getFraction() - prevKeyframe.getFraction());
                    int prevValue2 = prevKeyframe.getIntValue();
