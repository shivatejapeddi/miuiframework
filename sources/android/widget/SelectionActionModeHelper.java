...
public final class SelectionActionModeHelper {
    ...
    public void startSelectionActionModeAsync(boolean adjustSelection) {
        ...
        Supplier -__lambda_e-xesxlnxm7bcuvanjzcigfnqjq;
        Consumer -__lambda_selectionactionmodehelper_l1f1_v5lw6noqxi_3u11qf753iw;
        ...
        textClassificationHelper = this.mTextClassificationHelper;
        Objects.requireNonNull(textClassificationHelper);
        this.mTextClassificationAsyncTask = new TextClassificationAsyncTask(textView, timeoutDuration, -__lambda_e-xesxlnxm7bcuvanjzcigfnqjq, -__lambda_selectionactionmodehelper_l1f1_v5lw6noqxi_3u11qf753iw, new -$$Lambda$etfJkiCJnT2dqM2O4M2TCm9i_oA(textClassificationHelper)).execute((Object[]) new Void[0]);
    }
    ...
    public static <T> void mergeRectangleIntoList(List<T> list, RectF candidate, Function<T, RectF> extractor, Function<RectF, T> packer) {
        if (!candidate.isEmpty()) {
            ...
            for (index = elementCount - 1; index >= 0; index--) {
                if (((RectF) extractor.apply(list.get(index))).isEmpty()) {
                    list.remove(index);
                }
            }
