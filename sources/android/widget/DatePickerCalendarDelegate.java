...
class DatePickerCalendarDelegate extends AbstractDatePickerDelegate {
    ...
    public DatePickerCalendarDelegate(DatePicker delegator, Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        this.mContainer = (ViewGroup) ((LayoutInflater) this.mContext.getSystemService(Context.LAYOUT_INFLATER_SERVICE)).inflate(a.getResourceId(19, R.layout.date_picker_material), this.mDelegator, false);
    ...
    public /* synthetic */ void lambda$new$0$DatePickerCalendarDelegate(View v) {
        tryVibrate();
        switch (v.getId()) {
            case R.id.date_picker_header_date /*16908870*/:
                setCurrentView(0);
                return;
            case R.id.date_picker_header_year /*16908871*/:
                setCurrentView(1);
                return;
            default:
                return;
