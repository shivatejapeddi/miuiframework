...
public class GridLayout extends ViewGroup {
    ...
    /* Access modifiers changed, original: protected */
    public void onSetLayoutParams(View child, android.view.ViewGroup.LayoutParams layoutParams) {
    ...
    public void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        while (i < N) {
            ...
            if (c.getVisibility() == 8) {
                ...
                targetHeight = gridLayout.getMeasurement(c, true);
                paddingBottom2 = paddingBottom;
                paddingBottom = gridLayout.getMeasurement(c, false);
                hLocations2 = hLocations;
                ...
                View c2 = c;
                i2 = i;
                int alignmentOffsetX = boundsX.getOffset(this, c, hAlign, targetHeight + sumMarginsX, true);
                View c3 = c2;
                int alignmentOffsetY = boundsY2.getOffset(this, c3, vAlign, paddingBottom + sumMarginsY, false);
                int width = hAlign.getSizeInCell(c3, targetHeight, cellWidth - sumMarginsX);
                int height = vAlign.getSizeInCell(c3, paddingBottom, cellHeight - sumMarginsY);
                int dx = (x1 + gravityOffsetX) + alignmentOffsetX;
                if (isLayoutRtl()) {
                    i = (((targetWidth - width) - paddingRight) - rightMargin) - dx;
                } else {
                    i = (paddingLeft + leftMargin) + dx;
                }
                alignmentOffsetY = (((paddingTop + y1) + gravityOffsetY) + alignmentOffsetY) + topMargin;
                if (!(width == c3.getMeasuredWidth() && height == c3.getMeasuredHeight())) {
