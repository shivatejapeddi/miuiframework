...
class DayPickerPagerAdapter extends PagerAdapter {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        int i = position;
        View itemView = this.mInflater.inflate(this.mLayoutResId, viewGroup, false);
        ...
        if (colorStateList != null) {
            v.setDayHighlightColor(colorStateList);
        }
        colorStateList = this.mCalendarTextColor;
        if (colorStateList != null) {
            v.setMonthTextColor(colorStateList);
        ...
        ViewHolder holder = new ViewHolder(i, itemView, v);
        this.mItems.put(i, holder);
