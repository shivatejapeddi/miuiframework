...
public class RadialTimePickerView extends View {
    ...
    public void onLayout(boolean changed, int left, int top, int right, int bottom) {
        if (changed) {
            ...
            this.mMinDistForInnerNumber = i2 - i3;
            this.mMaxDistForOuterNumber = (i - iArr[0]) + i3;
    ...
    private void animatePicker(boolean hoursToMinutes, long duration) {
        ...
        this.mHoursToMinutesAnimator = ObjectAnimator.ofFloat((Object) this, this.HOURS_TO_MINUTES, hoursToMinutes ? 0.0f : 1.0f);
    ...
    private void drawMinutes(Canvas canvas, Path selectorPath, float alphaMod) {
        int minutesAlpha = (int) (((this.mHoursToMinutes * 255.0f) * alphaMod) + 1056964608);
        if (minutesAlpha > 0) {
            canvas.save(2);
            canvas.clipPath(selectorPath, Op.DIFFERENCE);
    ...
    private void drawSelector(Canvas canvas, Path selectorPath) {
        ...
        iArr = this.mSelectionDegrees;
        int minutesAngleDeg = iArr[1];
        if (iArr[1] % 30 == 0) {
        ...
        selCenterX = minutesDotScale;
        minutesDotScale = (float) (((int) (((double) lineLength) * sin)) + (i + ((int) (((double) i2) * sin))));
        float linePointY = (float) ((this.mYCenter - ((int) (((double) i2) * cos))) - ((int) (((double) lineLength) * cos)));
        ...
        float linePointX = minutesDotScale;
        canvas.drawLine((float) this.mXCenter, (float) this.mYCenter, minutesDotScale, linePointY2, dotPaint);
    }
    ...
    private void drawTextElements(Canvas canvas, float textSize, Typeface typeface, ColorStateList textColor, String[] texts, float[] textX, float[] textY, Paint paint, int alpha, boolean showActivated, int activatedDegrees, boolean activatedOnly) {
        ...
        int i3 = 0;
        while (i3 < i2) {
            boolean activated = activatedFloor == i3 || activatedCeil == i3;
            if (!activatedOnly || activated) {
                int i4 = (showActivated && activated) ? 32 : 0;
                int color = textColor.getColorForState(StateSet.get(8 | i4), 0);
