...
public final class GnssSingleSatCorrection implements Parcelable {
    public static final Creator<GnssSingleSatCorrection> CREATOR = new Creator<GnssSingleSatCorrection>() {
        public GnssSingleSatCorrection createFromParcel(Parcel parcel) {
            ...
            if (hasReflectingPlane) {
                singleSatCorrectionBuilder.setReflectingPlane((GnssReflectingPlane) GnssReflectingPlane.CREATOR.createFromParcel(parcel));
            }
    ...
    public static final class Builder {
        ...
        public GnssSingleSatCorrection build() {
            return new GnssSingleSatCorrection(this, null);
        }
    }

    /* synthetic */ GnssSingleSatCorrection(Builder x0, AnonymousClass1 x1) {
        this(x0);
    }
    ...
    public String toString() {
        ...
        String str = "   %-29s = %s\n";
        builder.append(String.format(str, new Object[]{"SingleSatCorrectionFlags = ", Integer.valueOf(this.mSingleSatCorrectionFlags)}));
        builder.append(String.format(str, new Object[]{"ConstellationType = ", Integer.valueOf(this.mConstellationType)}));
        builder.append(String.format(str, new Object[]{"SatId = ", Integer.valueOf(this.mSatId)}));
        builder.append(String.format(str, new Object[]{"CarrierFrequencyHz = ", Float.valueOf(this.mCarrierFrequencyHz)}));
        builder.append(String.format(str, new Object[]{"ProbSatIsLos = ", Float.valueOf(this.mProbSatIsLos)}));
        builder.append(String.format(str, new Object[]{"ExcessPathLengthMeters = ", Float.valueOf(this.mExcessPathLengthMeters)}));
        builder.append(String.format(str, new Object[]{"ExcessPathLengthUncertaintyMeters = ", Float.valueOf(this.mExcessPathLengthUncertaintyMeters)}));
        if (hasReflectingPlane()) {
            builder.append(String.format(str, new Object[]{"ReflectingPlane = ", this.mReflectingPlane}));
        }
