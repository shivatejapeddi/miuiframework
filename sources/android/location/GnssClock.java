...
public final class GnssClock implements Parcelable {
    ...
    public String toString() {
        ...
        objArr[3] = hasDriftUncertaintyNanosPerSecond() ? Double.valueOf(this.mDriftUncertaintyNanosPerSecond) : null;
        builder.append(String.format(str2, objArr));
        builder.append(String.format(str, new Object[]{"HardwareClockDiscontinuityCount", Integer.valueOf(this.mHardwareClockDiscontinuityCount)}));
        objArr = new Object[2];
        objArr[0] = "ElapsedRealtimeNanos";
        objArr[1] = hasElapsedRealtimeNanos() ? Long.valueOf(this.mElapsedRealtimeNanos) : null;
        builder.append(String.format(str, objArr));
        Object[] objArr3 = new Object[2];
        objArr3[0] = "ElapsedRealtimeUncertaintyNanos";
