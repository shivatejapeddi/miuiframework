...
public class Address implements Parcelable {
    ...
    public String getAddressLine(int index) {
        if (index >= 0) {
            HashMap hashMap = this.mAddressLines;
            return hashMap == null ? null : (String) hashMap.get(Integer.valueOf(index));
        } else {
    ...
    public void writeToParcel(Parcel parcel, int flags) {
        ...
        Set<Entry<Integer, String>> entries = this.mAddressLines;
        if (entries == null) {
            parcel.writeInt(0);
        } else {
