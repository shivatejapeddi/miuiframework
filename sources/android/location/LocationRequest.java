...
public final class LocationRequest implements Parcelable {
    ...
    public static LocationRequest createFromDeprecatedCriteria(Criteria criteria, long minTime, float minDistance, boolean singleShot) {
        ...
        LocationRequest request = new LocationRequest().setQuality(accuracy).setInterval(minTime).setFastestInterval(minTime).setSmallestDisplacement(minDistance);
        if (singleShot) {
            request.setNumUpdates(1);
        }
        return request;
    ...
    public void writeToParcel(Parcel parcel, int flags) {
        ...
        parcel.writeInt(this.mLocationSettingsIgnored);
    ...
    public String toString() {
        ...
        long expireIn = this.mExpireAt;
        if (expireIn != Long.MAX_VALUE) {
            expireIn -= SystemClock.elapsedRealtime();
            s.append(" expireIn=");
