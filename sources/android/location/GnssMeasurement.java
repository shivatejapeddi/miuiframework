...
public final class GnssMeasurement implements Parcelable {
    ...
    public String toString() {
        ...
        builder.append(String.format(str, new Object[]{"ConstellationType", Integer.valueOf(this.mConstellationType)}));
        builder.append(String.format(str, new Object[]{"TimeOffsetNanos", Double.valueOf(this.mTimeOffsetNanos)}));
        builder.append(String.format(str, new Object[]{"State", getStateString()}));
        String str2 = "   %-29s = %-25s   %-40s = %s\n";
        builder.append(String.format(str2, new Object[]{"ReceivedSvTimeNanos", Long.valueOf(this.mReceivedSvTimeNanos), "ReceivedSvTimeUncertaintyNanos", Long.valueOf(this.mReceivedSvTimeUncertaintyNanos)}));
        builder.append(String.format(str, new Object[]{"Cn0DbHz", Double.valueOf(this.mCn0DbHz)}));
        builder.append(String.format(str2, new Object[]{"PseudorangeRateMetersPerSecond", Double.valueOf(this.mPseudorangeRateMetersPerSecond), "PseudorangeRateUncertaintyMetersPerSecond", Double.valueOf(this.mPseudorangeRateUncertaintyMetersPerSecond)}));
        builder.append(String.format(str, new Object[]{"AccumulatedDeltaRangeState", getAccumulatedDeltaRangeStateString()}));
        builder.append(String.format(str2, new Object[]{"AccumulatedDeltaRangeMeters", Double.valueOf(this.mAccumulatedDeltaRangeMeters), "AccumulatedDeltaRangeUncertaintyMeters", Double.valueOf(this.mAccumulatedDeltaRangeUncertaintyMeters)}));
        ...
        objArr2[1] = hasAutomaticGainControlLevelDb() ? Double.valueOf(this.mAutomaticGainControlLevelInDb) : null;
        builder.append(String.format(str, objArr2));
