...
public class GpsMeasurement implements Parcelable {
    ...
    public String toString() {
        ...
        builder.append(String.format(str, new Object[]{"TimeOffsetInNs", Double.valueOf(this.mTimeOffsetInNs)}));
        builder.append(String.format(str, new Object[]{"State", getStateString()}));
        String str2 = "   %-29s = %-25s   %-40s = %s\n";
        builder.append(String.format(str2, new Object[]{"ReceivedGpsTowInNs", Long.valueOf(this.mReceivedGpsTowInNs), "ReceivedGpsTowUncertaintyInNs", Long.valueOf(this.mReceivedGpsTowUncertaintyInNs)}));
        builder.append(String.format(str, new Object[]{"Cn0InDbHz", Double.valueOf(this.mCn0InDbHz)}));
        builder.append(String.format(str2, new Object[]{"PseudorangeRateInMetersPerSec", Double.valueOf(this.mPseudorangeRateInMetersPerSec), "PseudorangeRateUncertaintyInMetersPerSec", Double.valueOf(this.mPseudorangeRateUncertaintyInMetersPerSec)}));
        builder.append(String.format(str, new Object[]{"PseudorangeRateIsCorrected", Boolean.valueOf(isPseudorangeRateCorrected())}));
        builder.append(String.format(str, new Object[]{"AccumulatedDeltaRangeState", getAccumulatedDeltaRangeStateString()}));
        builder.append(String.format(str2, new Object[]{"AccumulatedDeltaRangeInMeters", Double.valueOf(this.mAccumulatedDeltaRangeInMeters), "AccumulatedDeltaRangeUncertaintyInMeters", Double.valueOf(this.mAccumulatedDeltaRangeUncertaintyInMeters)}));
        ...
        builder.append(String.format(str2, objArr));
        builder.append(String.format(str, new Object[]{"LossOfLock", getLossOfLockString()}));
        objArr = new Object[2];
        objArr[0] = "BitNumber";
        ...
        builder.append(String.format(str2, objArr));
        builder.append(String.format(str, new Object[]{"MultipathIndicator", getMultipathIndicatorString()}));
        objArr = new Object[2];
        objArr[0] = "SnrInDb";
        ...
        builder.append(String.format(str, new Object[]{"UsedInFix", Boolean.valueOf(this.mUsedInFix)}));
        return builder.toString();
    }
