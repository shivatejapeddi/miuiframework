...
public abstract class PrintService extends Service {
        ...
        public void handleMessage(Message message) {
            ...
            switch (action) {
                ...
                case 8:
                    ...
                    return;
                case 9:
                    printJobInfo = (PrintJobInfo) message.obj;
                    printService = PrintService.this;
                    printService.onPrintJobQueued(new PrintJob(printService, printJobInfo, printService.mClient));
                    return;
                case 10:
                    printJobInfo = message.obj;
                    printService = PrintService.this;
                    printService.onRequestCancelPrintJob(new PrintJob(printService, printJobInfo, printService.mClient));
                    return;
                case 11:
    ...
    public final List<PrintJob> getActivePrintJobs() {
        ...
        List<PrintJobInfo> printJobInfos = this.mClient;
        if (printJobInfos == null) {
            return Collections.emptyList();
        }
        List<PrintJob> printJobs = null;
        try {
            printJobInfos = printJobInfos.getPrintJobInfos();
            if (printJobInfos != null) {
