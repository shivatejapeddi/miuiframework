...
public class Time {
    ...
    public int getActualMaximum(int field) {
        ...
        switch (field) {
            ...
            case 8:
                n = this.year;
                i = (n % 4 != 0 || (n % 100 == 0 && n % 400 != 0)) ? 364 : 365;
                return i;
            case 9:
    ...
    private boolean parseInternal(String s) {
        int len = s.length();
        String str = "String is too short: \"";
        if (len >= 8) {
            boolean inUtc = false;
    ...
    private boolean parse3339Internal(String s) {
        ...
        if (len >= 10) {
            ...
            if (len >= 19) {
                ...
                int tzIndex = 19;
                if (19 < len && str.charAt(19) == ClassUtils.PACKAGE_SEPARATOR_CHAR) {
                    do {
                        tzIndex++;
                        if (tzIndex >= len) {
                            break;
    ...
    public static int getJulianDay(long millis, long gmtoff) {
        return ((int) ((millis + (1000 * gmtoff)) / 86400000)) + EPOCH_JULIAN_DAY;
    }
