...
public final class AutoGrowArray {
    ...
    public static class ByteArray {
        ...
        private void ensureCapacity(int count) {
            int newCapacity = this.mSize;
            int requestedSize = newCapacity + count;
            if (requestedSize >= this.mValues.length) {
                byte[] newValues = ArrayUtils.newUnpaddedByteArray(AutoGrowArray.computeNewCapacity(newCapacity, requestedSize));
    ...
    public static class FloatArray {
        ...
        private void ensureCapacity(int count) {
            ...
            int requestedSize = newCapacity + count;
            if (requestedSize >= this.mValues.length) {
                float[] newValues = ArrayUtils.newUnpaddedFloatArray(AutoGrowArray.computeNewCapacity(newCapacity, requestedSize));
                System.arraycopy(this.mValues, 0, newValues, 0, this.mSize);
                this.mValues = newValues;
            }
        }
    ...
    public static class IntArray {
        ...
        private void ensureCapacity(int count) {
            ...
            int requestedSize = newCapacity + count;
            if (requestedSize >= this.mValues.length) {
                int[] newValues = ArrayUtils.newUnpaddedIntArray(AutoGrowArray.computeNewCapacity(newCapacity, requestedSize));
                System.arraycopy(this.mValues, 0, newValues, 0, this.mSize);
                this.mValues = newValues;
            }
        }
