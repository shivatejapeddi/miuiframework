...
public final class UiAutomation {
        ...
        public IAccessibilityServiceClientImpl(Looper looper) {
            super(null, looper, new Callbacks(UiAutomation.this) {
                ...
                public void onAccessibilityEvent(AccessibilityEvent event) {
                    ...
                    if (listener != null) {
                        r2.mLocalCallbackHandler.sendMessage(PooledLambda.obtainMessage(-$$Lambda$GnVtsLTLDH5bZdtLeTd6cfwpgcs.INSTANCE, listener, AccessibilityEvent.obtain(event)));
                    }
                }
    ...
    public android.view.accessibility.AccessibilityEvent executeAndWaitForEvent(java.lang.Runnable r20, android.app.UiAutomation.AccessibilityEventFilter r21, long r22) throws java.util.concurrent.TimeoutException {
        ...
        r0 = r10.remove(r4);	 Catch:{ all -> 0x0086 }
        r0 = (android.view.accessibility.AccessibilityEvent) r0;	 Catch:{ all -> 0x0086 }
        r11 = r0;	 Catch:{ all -> 0x0086 }
        r12 = r11.getEventTime();	 Catch:{ all -> 0x0086 }
        r0 = (r12 > r5 ? 1 : (r12 == r5 ? 0 : -1));
        if (r0 >= 0) goto L_0x004f;
        goto L_0x0039;
        r12 = r21;
        r0 = r12.accept(r11);	 Catch:{ all -> 0x0084 }
        ...
        r11 = r1.mLock;	 Catch:{ all -> 0x00d6, all -> 0x00dc }
        monitor-enter(r11);	 Catch:{ all -> 0x00d6, all -> 0x00dc }
        r0 = r1.mEventQueue;	 Catch:{ all -> 0x00d6, all -> 0x00dc }
        r0 = r0.isEmpty();	 Catch:{ all -> 0x00d6, all -> 0x00dc }
        if (r0 == 0) goto L_0x00ad;
        r0 = r1.mLock;	 Catch:{ InterruptedException -> 0x00ac }
        ...
        r11 = new java.lang.StringBuilder;	 Catch:{ all -> 0x00d6, all -> 0x00dc }
        r11.<init>();	 Catch:{ all -> 0x00d6, all -> 0x00dc }
        r6 = "Expected event not received within: ";	 Catch:{ all -> 0x00d6, all -> 0x00dc }
        r11.append(r6);	 Catch:{ all -> 0x00d6, all -> 0x00dc }
        r11.append(r2);	 Catch:{ all -> 0x00d6, all -> 0x00dc }
        r6 = " ms among: ";	 Catch:{ all -> 0x00d6, all -> 0x00dc }
        r11.append(r6);	 Catch:{ all -> 0x00d6, all -> 0x00dc }
        r11.append(r7);	 Catch:{ all -> 0x00d6, all -> 0x00dc }
        r6 = r11.toString();	 Catch:{ all -> 0x00d6, all -> 0x00dc }
    ...
    public void connect(int r11) {
        ...
        r1 = r10.mIsConnecting;	 Catch:{ all -> 0x0077 }
    ...
    L_0x000c:
        ...
        r1 = new android.os.HandlerThread;	 Catch:{ all -> 0x0077 }
        r2 = "UiAutomation";
        r1.<init>(r2);	 Catch:{ all -> 0x0077 }
        r10.mRemoteCallbackThread = r1;	 Catch:{ all -> 0x0077 }
        r1 = r10.mRemoteCallbackThread;	 Catch:{ all -> 0x0077 }
        r1.start();	 Catch:{ all -> 0x0077 }
        r1 = new android.app.UiAutomation$IAccessibilityServiceClientImpl;	 Catch:{ all -> 0x0077 }
        r2 = r10.mRemoteCallbackThread;	 Catch:{ all -> 0x0077 }
        r2 = r2.getLooper();	 Catch:{ all -> 0x0077 }
        r1.<init>(r2);	 Catch:{ all -> 0x0077 }
        r10.mClient = r1;	 Catch:{ all -> 0x0077 }
        monitor-exit(r0);	 Catch:{ all -> 0x0077 }
        r0 = r10.mUiAutomationConnection;	 Catch:{ RemoteException -> 0x006e }
        r1 = r10.mClient;	 Catch:{ RemoteException -> 0x006e }
        r0.connect(r1, r11);	 Catch:{ RemoteException -> 0x006e }
        r10.mFlags = r11;	 Catch:{ RemoteException -> 0x006e }
        r0 = r10.mLock;
        monitor-enter(r0);
        r1 = android.os.SystemClock.uptimeMillis();	 Catch:{ all -> 0x006b }
    L_0x003c:
        r3 = 0;
        r4 = r10.isConnectedLocked();	 Catch:{ all -> 0x0067 }
        if (r4 == 0) goto L_0x0049;
        r10.mIsConnecting = r3;	 Catch:{ all -> 0x006b }
        monitor-exit(r0);	 Catch:{ all -> 0x006b }
        return;
    L_0x0049:
        r4 = android.os.SystemClock.uptimeMillis();	 Catch:{ all -> 0x0067 }
        r4 = r4 - r1;
    ...
    L_0x0057:
        r8 = r10.mLock;	 Catch:{ InterruptedException -> 0x005d }
    ...
    L_0x005e:
        goto L_0x003c;
    L_0x005f:
        r8 = new java.lang.RuntimeException;	 Catch:{ all -> 0x0067 }
    ...
    L_0x006e:
        ...
        r2 = "Error while connecting UiAutomation";
        r1.<init>(r2, r0);
        throw r1;
    L_0x0077:
        r1 = move-exception;
    ...
    public void waitForIdle(long idleTimeoutMillis, long globalTimeoutMillis) throws TimeoutException {
        ...
        synchronized (this.mLock) {
            ...
            while (true) {
                ...
                if (j2 - (currentTimeMillis - startTimeMillis) > elapsedIdleTimeMillis) {
