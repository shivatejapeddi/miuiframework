...
public final class DirectAction implements Parcelable {
    public static final Creator<DirectAction> CREATOR = new Creator<DirectAction>() {
        public DirectAction createFromParcel(Parcel in) {
            return new DirectAction(in, null);
        }
    ...
    /* synthetic */ DirectAction(Parcel x0, AnonymousClass1 x1) {
        this(x0);
    }
