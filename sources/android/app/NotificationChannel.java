...
public final class NotificationChannel implements Parcelable {
    ...
    private void populateFromXml(XmlPullParser parser, boolean forRestore, Context context) {
        boolean z = (forRestore && context == null) ? false : true;
        Preconditions.checkArgument(z, "forRestore is true but got null context");
    ...
    private static AudioAttributes safeAudioAttributes(XmlPullParser parser) {
        ...
        return new Builder().setUsage(usage).setContentType(contentType).setFlags(safeInt(parser, "flags", 0)).build();
    }
    ...
    public void dump(PrintWriter pw, String prefix, boolean redacted) {
        ...
        output.append("NotificationChannel{mId='");
        output.append(this.mId);
        output.append(DateFormat.QUOTE);
        output.append(", mName=");
        output.append(redactedName);
        output.append(", mDescription=");
        output.append(!TextUtils.isEmpty(this.mDesc) ? "hasDescription " : "");
        output.append(", mImportance=");
        output.append(this.mImportance);
        output.append(", mBypassDnd=");
        output.append(this.mBypassDnd);
        output.append(", mLockscreenVisibility=");
        output.append(this.mLockscreenVisibility);
        output.append(", mSound=");
        output.append(this.mSound);
        output.append(", mLights=");
        output.append(this.mLights);
        output.append(", mLightColor=");
        output.append(this.mLightColor);
        output.append(", mVibration=");
        output.append(Arrays.toString(this.mVibration));
        output.append(", mUserLockedFields=");
        output.append(Integer.toHexString(this.mUserLockedFields));
        output.append(", mFgServiceShown=");
        output.append(this.mFgServiceShown);
        output.append(", mVibrationEnabled=");
        output.append(this.mVibrationEnabled);
        output.append(", mShowBadge=");
        output.append(this.mShowBadge);
        output.append(", mDeleted=");
        output.append(this.mDeleted);
        output.append(", mGroup='");
        output.append(this.mGroup);
        output.append(DateFormat.QUOTE);
        output.append(", mAudioAttributes=");
        output.append(this.mAudioAttributes);
        output.append(", mBlockableSystem=");
        output.append(this.mBlockableSystem);
        output.append(", mAllowBubbles=");
        output.append(this.mAllowBubbles);
        output.append(", mImportanceLockedByOEM=");
        output.append(this.mImportanceLockedByOEM);
        output.append(", mImportanceLockedDefaultApp=");
        output.append(this.mImportanceLockedDefaultApp);
        output.append('}');
