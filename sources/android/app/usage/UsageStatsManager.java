...
public final class UsageStatsManager {
    ...
    public List<UsageStats> queryUsageStatsAsUser(int intervalType, long beginTime, long endTime, int userId) {
        try {
            ParceledListSlice<UsageStats> slice = this.mService.queryUsageStatsAsUser(intervalType, beginTime, endTime, this.mContext.getOpPackageName(), userId);
            if (slice != null) {
                return slice.getList();
            }
        } catch (RemoteException e) {
