...
public abstract class Service extends ContextWrapper implements ComponentCallbacks2 {
    ...
    public final void stopSelf(int startId) {
        ...
        if (iActivityManager != null) {
            try {
                iActivityManager.stopServiceToken(new ComponentName((Context) this, this.mClassName), this.mToken, startId);
    ...
    public final boolean stopSelfResult(int startId) {
        ...
        try {
            return iActivityManager.stopServiceToken(new ComponentName((Context) this, this.mClassName), this.mToken, startId);
        } catch (RemoteException e) {
            return false;
        }
    }
    ...
    public final void stopForeground(int flags) {
        try {
            this.mActivityManager.setServiceForeground(new ComponentName((Context) this, this.mClassName), this.mToken, 0, null, flags, 0);
        } catch (RemoteException e) {
        }
    }
