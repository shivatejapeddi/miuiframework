...
public class SearchManager implements android.content.DialogInterface.OnDismissListener, android.content.DialogInterface.OnCancelListener {
    ...
    SearchManager(Context context, Handler handler) throws ServiceNotFoundException {
        ...
        this.mService = Stub.asInterface(ServiceManager.getServiceOrThrow("search"));
    }
    ...
    public void startGlobalSearch(String initialQuery, boolean selectInitialQuery, Bundle appSearchData, Rect sourceBounds) {
        ...
        if (globalSearchActivity == null) {
            Log.w(str, "No global search activity found.");
            return;
        }
        ...
        String str2 = Slice.SUBTYPE_SOURCE;
        if (!appSearchData.containsKey(str2)) {
            appSearchData.putString(str2, this.mContext.getPackageName());
        }
    ...
    public boolean isVisible() {
        SearchDialog searchDialog = this.mSearchDialog;
        return searchDialog == null ? false : searchDialog.isShowing();
    }
    ...
    public Intent getAssistIntent(boolean inclContext) {
        try {
            ...
            if (inclContext) {
                Bundle extras = ActivityTaskManager.getService().getAssistContextExtras(null);
                if (extras != null) {
