...
public class DevicePolicyEventLogger {
    ...
    public void write() {
        StatsLogInternal.write(103, this.mEventId, this.mAdminPackageName, this.mIntValue, this.mBooleanValue, this.mTimePeriodMs, stringArrayValueToBytes(this.mStringArrayValue));
    }
