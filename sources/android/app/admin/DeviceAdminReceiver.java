...
public class DeviceAdminReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        boolean equals = ACTION_PASSWORD_CHANGED.equals(action);
        String str = Intent.EXTRA_USER;
        if (equals) {
            onPasswordChanged(context, intent, (UserHandle) intent.getParcelableExtra(str));
        } else if (ACTION_PASSWORD_FAILED.equals(action)) {
            onPasswordFailed(context, intent, (UserHandle) intent.getParcelableExtra(str));
        } else if (ACTION_PASSWORD_SUCCEEDED.equals(action)) {
            onPasswordSucceeded(context, intent, (UserHandle) intent.getParcelableExtra(str));
            ...
            onPasswordExpiring(context, intent, (UserHandle) intent.getParcelableExtra(str));
            ...
            onUserAdded(context, intent, (UserHandle) intent.getParcelableExtra(str));
        } else if (ACTION_USER_REMOVED.equals(action)) {
            onUserRemoved(context, intent, (UserHandle) intent.getParcelableExtra(str));
        } else if (ACTION_USER_STARTED.equals(action)) {
            onUserStarted(context, intent, (UserHandle) intent.getParcelableExtra(str));
        } else if (ACTION_USER_STOPPED.equals(action)) {
            onUserStopped(context, intent, (UserHandle) intent.getParcelableExtra(str));
        } else if (ACTION_USER_SWITCHED.equals(action)) {
            onUserSwitched(context, intent, (UserHandle) intent.getParcelableExtra(str));
            ...
            onTransferAffiliatedProfileOwnershipComplete(context, (UserHandle) intent.getParcelableExtra(str));
        }
    }
}
