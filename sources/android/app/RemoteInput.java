...
public final class RemoteInput implements Parcelable {
    ...
    /* synthetic */ RemoteInput(String x0, CharSequence x1, CharSequence[] x2, int x3, int x4, Bundle x5, ArraySet x6, AnonymousClass1 x7) {
            ...
            if (key.startsWith(str)) {
                ...
                if (str != null) {
                    if (!str.isEmpty()) {
                        ...
                        if (uriStr != null) {
                            if (!uriStr.isEmpty()) {
                                results.put(str, Uri.parse(uriStr));
                            }
                        }
                    }
                }
