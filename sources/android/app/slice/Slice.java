...
public final class Slice implements Parcelable {
    ...
    public static class Builder {
        ...
        public Builder setCallerNeeded(boolean callerNeeded) {
            String str = Slice.HINT_CALLER_NEEDED;
            if (callerNeeded) {
                this.mHints.add(str);
            } else {
                this.mHints.remove(str);
            }
            return this;
        }
        ...
        public Builder addAction(PendingIntent action, Slice s, String subType) {
            ...
            Slice slice = s;
            this.mItems.add(new SliceItem(pendingIntent, slice, "action", subType, (String[]) hints.toArray(new String[hints.size()])));
            return this;
        }

        public Builder addText(CharSequence text, String subType, List<String> hints) {
            this.mItems.add(new SliceItem((Object) text, "text", subType, (List) hints));
            return this;
        }
