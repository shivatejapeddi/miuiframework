...
public class JobInfo implements Parcelable {
    ...
    public static final class Builder {
        ...
        public Builder setPeriodic(long intervalMillis, long flexMillis) {
            ...
            String str = " is too small; raising to ";
            String str2 = " for job ";
            if (intervalMillis < minPeriod) {
                access$2700 = JobInfo.TAG;
            ...
            if (flexMillis < minFlex) {
                ...
                Log.w(access$2700, stringBuilder2.toString());
                flexMillis = minFlex;
            }
    ...
    public int hashCode() {
        ...
        hashCode = (hashCode2 * 31) + this.constraintFlags;
        TriggerContentUri[] triggerContentUriArr = this.triggerContentUris;
        if (triggerContentUriArr != null) {
            hashCode = (hashCode * 31) + Arrays.hashCode(triggerContentUriArr);
        }
        hashCode = (((((((hashCode * 31) + Long.hashCode(this.triggerContentUpdateDelay)) * 31) + Long.hashCode(this.triggerContentMaxDelay)) * 31) + Boolean.hashCode(this.hasEarlyConstraint)) * 31) + Boolean.hashCode(this.hasLateConstraint);
        NetworkRequest networkRequest = this.networkRequest;
        if (networkRequest != null) {
