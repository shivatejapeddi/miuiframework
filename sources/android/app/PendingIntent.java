...
public final class PendingIntent implements Parcelable {
    ...
    public void unregisterCancelListener(android.app.PendingIntent.CancelListener r5) {
        ...
        r4 = this;
        monitor-enter(r4);
        r0 = r4.mCancelListeners;	 Catch:{ all -> 0x0030 }
    ...
    L_0x0007:
        r0 = r4.mCancelListeners;	 Catch:{ all -> 0x0030 }
        r0 = r0.isEmpty();	 Catch:{ all -> 0x0030 }
        r1 = r4.mCancelListeners;	 Catch:{ all -> 0x0030 }
        r1.remove(r5);	 Catch:{ all -> 0x0030 }
        r1 = r4.mCancelListeners;	 Catch:{ all -> 0x0030 }
        r1 = r1.isEmpty();	 Catch:{ all -> 0x0030 }
        if (r1 == 0) goto L_0x002e;
    L_0x001a:
        if (r0 != 0) goto L_0x002e;
    L_0x001c:
        r1 = android.app.ActivityManager.getService();	 Catch:{ RemoteException -> 0x0028 }
        r2 = r4.mTarget;	 Catch:{ RemoteException -> 0x0028 }
        r3 = r4.mCancelReceiver;	 Catch:{ RemoteException -> 0x0028 }
        r1.unregisterIntentSenderCancelListener(r2, r3);	 Catch:{ RemoteException -> 0x0028 }
        goto L_0x002e;
    L_0x0028:
        r1 = move-exception;
        r2 = r1.rethrowFromSystemServer();	 Catch:{ all -> 0x0030 }
