...
public class StatusBarManager {
    ...
    public static final class DisableInfo {
        ...
        public String toString() {
            ...
            String str = "disabled";
            String str2 = "enabled";
            sb.append(this.mStatusBarExpansion ? str : str2);
            sb.append(" mNavigateHome=");
            sb.append(this.mNavigateHome ? str : str2);
            sb.append(" mNotificationPeeking=");
            sb.append(this.mNotificationPeeking ? str : str2);
            sb.append(" mRecents=");
            sb.append(this.mRecents ? str : str2);
            sb.append(" mSearch=");
            if (!this.mSearch) {
                str = str2;
            }
        ...
        public Pair<Integer, Integer> toFlags() {
            ...
            return new Pair(Integer.valueOf(disable1), Integer.valueOf(0));
        }
    }
    ...
    public void setStatus(int what, String action, Bundle ext) {
        try {
            IStatusBarService svc = getService();
            if (svc != null) {
                svc.setStatus(what, this.mToken, action, ext);
            }
        } catch (RemoteException ex) {
