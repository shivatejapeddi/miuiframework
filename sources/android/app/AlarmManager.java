...
public class AlarmManager {
    ...
    final class ListenerWrapper extends Stub implements Runnable {
        ...
        public void run() {
            String str = "Unable to report completion to Alarm Manager!";
            String str2 = AlarmManager.TAG;
            try {
    ...
    private void setImpl(int type, long triggerAtMillis, long windowMillis, long intervalMillis, int flags, PendingIntent operation, OnAlarmListener listener, String listenerTag, Handler targetHandler, WorkSource workSource, AlarmClockInfo alarmClock) {
        ...
        if (onAlarmListener != null) {
            ...
            synchronized (AlarmManager.class) {
                ...
                recipientWrapper2 = (ListenerWrapper) sWrappers.get(onAlarmListener);
                if (recipientWrapper2 == null) {
                    recipientWrapper2 = new ListenerWrapper(onAlarmListener);
                    sWrappers.put(onAlarmListener, recipientWrapper2);
                }
            }
    ...
    public void cancel(PendingIntent operation) {
        if (operation == null) {
            ...
            String str = "cancel() called with a null PendingIntent";
