...
public final class AppTarget implements Parcelable {
    public static final Creator<AppTarget> CREATOR = new Creator<AppTarget>() {
        public AppTarget createFromParcel(Parcel parcel) {
            return new AppTarget(parcel, null);
        }
    ...
    public static final class Builder {
        ...
        public AppTarget build() {
            ...
            if (str != null) {
                return new AppTarget(this.mId, str, this.mUser, this.mShortcutInfo, this.mClassName, this.mRank, null);
            }
            throw new IllegalStateException("No target is set");
        }
    }

    /* synthetic */ AppTarget(AppTargetId x0, String x1, UserHandle x2, ShortcutInfo x3, String x4, int x5, AnonymousClass1 x6) {
        this(x0, x1, x2, x3, x4, x5);
    }

    /* synthetic */ AppTarget(Parcel x0, AnonymousClass1 x1) {
        this(x0);
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(this.mClassName == null && other.mClassName == null)) {
            String str = this.mClassName;
            if (str == null || !str.equals(other.mClassName)) {
                sameClassName = false;
                if (!(this.mShortcutInfo == null && other.mShortcutInfo == null)) {
                    shortcutInfo = this.mShortcutInfo;
                    if (shortcutInfo == null || other.mShortcutInfo == null || shortcutInfo.getId() != other.mShortcutInfo.getId()) {
                        sameShortcutInfo = false;
