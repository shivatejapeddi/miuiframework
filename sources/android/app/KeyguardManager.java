...
public class KeyguardManager {
    ...
    private final INotificationManager mNotificationManager = Stub.asInterface(ServiceManager.getServiceOrThrow("notification"));
    ...
    public Intent createConfirmFactoryResetCredentialIntent(CharSequence title, CharSequence description, CharSequence alternateButtonLabel) {
        boolean frpCredentialEnabled = LockPatternUtils.frpCredentialEnabled(this.mContext);
        String str = "not supported on this device";
        String str2 = TAG;
        if (!frpCredentialEnabled) {
            Log.w(str2, "Factory reset credentials not supported.");
            ...
            try {
                ...
                if (pdb == null) {
                    Log.e(str2, "No persistent data block service");
                    throw new UnsupportedOperationException(str);
                    ...
                    Log.i(str2, "The persistent data block does not have a factory reset credential.");
                    return null;
                }
            } catch (RemoteException e) {
            ...
            Log.e(str2, "Factory reset credential cannot be verified after provisioning.");
    ...
    private String getSettingsPackageForIntent(Intent intent) {
        ...
        return SettingsTree.SETTINGS_PACKAGE;
    }
