...
public final class DisconnectCause implements Parcelable {
    ...
    public String toString() {
        ...
        String label = this.mDisconnectLabel;
        String reason = "";
        label = label == null ? reason : label.toString();
        String description = this.mDisconnectDescription;
        description = description == null ? reason : description.toString();
