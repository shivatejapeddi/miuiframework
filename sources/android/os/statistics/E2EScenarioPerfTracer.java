...
public final class E2EScenarioPerfTracer {
    ...
    L_0x001a:
        ...
        r5 = r13;
        r6 = r14;
        r0 = r2.beginScenario(r3, r4, r5, r6, r7, r8, r10);	 Catch:{ RemoteException -> 0x002b }
        return r0;
    L_0x002b:
        r2 = move-exception;
        return r0;
    ...
    /* JADX WARNING: Missing block: B:12:0x0038, code skipped:
            return;
     */
    public static void asyncBeginScenario(android.os.statistics.E2EScenario r15, android.os.statistics.E2EScenarioSettings r16, java.lang.String r17, android.os.statistics.E2EScenarioPayload r18) {
        /*
    ...
    L_0x0011:
        goto L_0x0037;
    L_0x0012:
        r9 = com.miui.daemon.performance.PerfShielderManager.getService();
    ...
    L_0x0019:
        ...
        r13 = executor;
        r14 = new android.os.statistics.E2EScenarioPerfTracer$1;
        r0 = r14;
        r1 = r9;
        r2 = r15;
        r3 = r16;
