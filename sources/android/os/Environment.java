...
public class Environment {
    ...
    public static final String[] STANDARD_DIRECTORIES = new String[]{DIRECTORY_MUSIC, DIRECTORY_PODCASTS, DIRECTORY_RINGTONES, DIRECTORY_ALARMS, DIRECTORY_NOTIFICATIONS, DIRECTORY_PICTURES, DIRECTORY_MOVIES, DIRECTORY_DOWNLOADS, DIRECTORY_DCIM, DIRECTORY_DOCUMENTS, DIRECTORY_AUDIOBOOKS};
    ...
    public static boolean isExternalStorageLegacy(File path) {
        ...
        if (packageManager.checkPermission(permission.WRITE_MEDIA_STORAGE, context.getPackageName()) == 0) {
            return true;
        }
        if (packageManager.checkPermission(permission.INSTALL_PACKAGES, context.getPackageName()) == 0) {
            return true;
        }
