    ...
    public static class Waveform extends VibrationEffect implements Parcelable {
        ...
        public Waveform scale(float gamma, int maxAmplitude) {
            if (maxAmplitude > 255 || maxAmplitude < 0) {
                ...
                int[] scaledAmplitudes = this.mAmplitudes;
                scaledAmplitudes = Arrays.copyOf(scaledAmplitudes, scaledAmplitudes.length);
        ...
        public Waveform resolve(int defaultAmplitude) {
            ...
            int[] resolvedAmplitudes = this.mAmplitudes;
            resolvedAmplitudes = Arrays.copyOf(resolvedAmplitudes, resolvedAmplitudes.length);
        ...
        public void validate() {
            ...
            if (jArr.length != this.mAmplitudes.length) {
                ...
                int i3 = this.mRepeat;
                if (i3 < -1 || i3 >= this.mTimings.length) {
                    stringBuilder = new StringBuilder();
    ...
    public static VibrationEffect get(Uri uri, Context context) {
        ...
        while (i < uris.length && i < RINGTONES.length) {
            if (uris[i] != null) {
                ...
                if (mappedUri != null && mappedUri.equals(uncanonicalUri)) {
