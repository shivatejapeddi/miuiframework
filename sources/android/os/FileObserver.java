...
public abstract class FileObserver {
    ...
    private static class ObserverThread extends Thread {
        ...
        public int[] startWatching(List<File> files, int mask, FileObserver observer) {
            ...
            for (int i = 0; i < count; i++) {
                paths[i] = ((File) files.get(i)).getAbsolutePath();
            }
        ...
        public void onEvent(int wfd, int mask, String path) {
            ...
            if (observer != null) {
                try {
                    ...
                    Log.wtf(FileObserver.LOG_TAG, stringBuilder.toString(), throwable);
                }
            }
        }
    }
    ...
    public FileObserver(File file, int mask) {
        this(Arrays.asList(new File[]{file}), mask);
    }
