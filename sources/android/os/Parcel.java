...
public final class Parcel {
    ...
    public static boolean sLogClassNotFoundException = true;
    ...
    public final Object getClassCookie(Class clz) {
        ArrayMap arrayMap = this.mClassCookies;
        return arrayMap != null ? arrayMap.get(clz) : null;
    }
    ...
    public <T extends Parcelable> void writeTypedArrayMap(ArrayMap<String, T> val, int parcelableFlags) {
        ...
        for (int i = 0; i < count; i++) {
            writeString((String) val.keyAt(i));
            writeTypedObject((Parcelable) val.valueAt(i), parcelableFlags);
        }
    }
    ...
    public final void readException(int code, String msg) {
        ...
        if (remoteStackTrace != null) {
            ...
            try {
                ...
                Log.e(TAG, stringBuilder2.toString(), ex);
            }
        }
    ...
    public final <T extends Parcelable> SparseArray<T> createTypedSparseArray(Creator<T> creator) {
        int count = readInt();
        if (count < 0) {
            return null;
        }
    ...
    public final <T extends Parcelable> ArrayMap<String, T> createTypedArrayMap(Creator<T> creator) {
        int count = readInt();
        if (count < 0) {
            return null;
        }
