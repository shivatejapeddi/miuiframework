...
public final class TvContract {
    ...
    public static final class Channels implements BaseTvColumns {
        ...
        static {
            Map map = VIDEO_FORMAT_TO_RESOLUTION_MAP;
            String str = VIDEO_RESOLUTION_SD;
            map.put(VIDEO_FORMAT_480I, str);
            map = VIDEO_FORMAT_TO_RESOLUTION_MAP;
            String str2 = VIDEO_RESOLUTION_ED;
            map.put(VIDEO_FORMAT_480P, str2);
            VIDEO_FORMAT_TO_RESOLUTION_MAP.put(VIDEO_FORMAT_576I, str);
            VIDEO_FORMAT_TO_RESOLUTION_MAP.put(VIDEO_FORMAT_576P, str2);
            map = VIDEO_FORMAT_TO_RESOLUTION_MAP;
            str = VIDEO_RESOLUTION_HD;
            map.put(VIDEO_FORMAT_720P, str);
            VIDEO_FORMAT_TO_RESOLUTION_MAP.put(VIDEO_FORMAT_1080I, str);
            VIDEO_FORMAT_TO_RESOLUTION_MAP.put(VIDEO_FORMAT_1080P, VIDEO_RESOLUTION_FHD);
            map = VIDEO_FORMAT_TO_RESOLUTION_MAP;
            str = VIDEO_RESOLUTION_UHD;
            map.put(VIDEO_FORMAT_2160P, str);
            VIDEO_FORMAT_TO_RESOLUTION_MAP.put(VIDEO_FORMAT_4320P, str);
        }
