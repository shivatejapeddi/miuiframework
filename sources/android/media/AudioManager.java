...
public class AudioManager {
    ...
    public static final int AUDIOFOCUS_FLAG_NAVI_LOCK = 16;
    @SystemApi
                ...
                this.mHandler = new Handler(looper, AudioManager.this) {
                    public void handleMessage(Message msg) {
                        ...
                        if (i == 0 || i == 1) {
                            ...
                            audioDeviceCallback = callback;
                            if (audioDeviceCallback != null) {
                                audioDeviceCallback.onAudioDevicesRemoved((AudioDeviceInfo[]) msg.obj);
                            }
                        }
                    }
                };
    ...
    static {
        FLAG_NAMES.put(Integer.valueOf(1), "FLAG_SHOW_UI");
    ...
    public static String flagsToString(int flags) {
        ...
        for (Entry<Integer, String> entry : FLAG_NAMES.entrySet()) {
            int flag = ((Integer) entry.getKey()).intValue();
            if ((flags & flag) != 0) {
                if (sb.length() > 0) {
                    sb.append(',');
                }
    ...
    private static IAppOpsService getAppOpsService() {
        IAppOpsService iAppOpsService = sAppOpsService;
        if (iAppOpsService != null) {
            return iAppOpsService;
        }
        sAppOpsService = IAppOpsService.Stub.asInterface(ServiceManager.getService(Context.APP_OPS_SERVICE));
        return sAppOpsService;
    }

    private boolean isRestricted(int streamType) {
        boolean z = false;
        try {
            int mode = getAppOpsService().checkAudioOperation(28, new Builder().setInternalLegacyStreamType(streamType).build().getUsage(), Process.myUid(), getContext().getPackageName());
            String str = TAG;
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("getStreamVolume isRestricted mode = ");
    ...
    public void setSpeakerphoneOn(boolean on) {
        ...
        stringBuilder.append(this.mApplicationContext.getOpPackageName());
    ...
    public boolean isBluetoothA2dpOn() {
        String str = "";
        if (AudioSystem.getDeviceConnectionState(128, str) == 1 || AudioSystem.getDeviceConnectionState(256, str) == 1 || AudioSystem.getDeviceConnectionState(512, str) == 1) {
            return true;
        }
        return false;
    }
    ...
    public boolean isWiredHeadsetOn() {
        String str = "";
        if (AudioSystem.getDeviceConnectionState(4, str) == 0 && AudioSystem.getDeviceConnectionState(8, str) == 0 && AudioSystem.getDeviceConnectionState(67108864, str) == 0) {
            return false;
        }
        return true;
    }
    ...
    /* JADX WARNING: Missing block: B:13:0x0025, code skipped:
            return;
     */
    public void playSoundEffect(int r4) {
        /*
        r3 = this;
    ...
    L_0x0006:
        goto L_0x0025;
    L_0x0007:
        r0 = android.os.Process.myUserHandle();
        r0 = r0.getIdentifier();
        r0 = r3.querySoundEffectsEnabled(r0);
        if (r0 != 0) goto L_0x0016;
    L_0x0015:
        return;
    L_0x0016:
        r0 = getService();
        r0.playSoundEffect(r4);	 Catch:{ RemoteException -> 0x001f }
        return;
    L_0x001f:
        r1 = move-exception;
    ...
    /* JADX WARNING: Missing block: B:13:0x001d, code skipped:
            return;
     */
    public void playSoundEffect(int r4, int r5) {
        /*
        r3 = this;
    ...
    L_0x0006:
        goto L_0x001d;
    L_0x0007:
        r0 = r3.querySoundEffectsEnabled(r5);
        if (r0 != 0) goto L_0x000e;
    L_0x000d:
        return;
    L_0x000e:
        r0 = getService();
        r0.playSoundEffect(r4);	 Catch:{ RemoteException -> 0x0017 }
        return;
    L_0x0017:
        r1 = move-exception;
        r2 = r1.rethrowFromSystemServer();
    ...
    public int requestAudioFocus(OnAudioFocusChangeListener l, int streamType, int durationHint) {
        String str = TAG;
        PlayerBase.deprecateStreamTypeForPlayback(streamType, str, "requestAudioFocus()");
        try {
            str = requestAudioFocus(l, new Builder().setInternalLegacyStreamType(streamType).build(), durationHint, 0);
            return str;
        } catch (IllegalArgumentException e) {
            Log.e(str, "Audio focus request denied due to ", e);
            return 0;
        }
    }
    ...
    L_0x0002:
        r0 = r5.mPlaybackCallbackLock;
        monitor-enter(r0);
        r1 = r5.mPlaybackCallbackList;	 Catch:{ all -> 0x0042 }
        if (r1 != 0) goto L_0x0012;
    L_0x0009:
        r1 = "AudioManager";
        r2 = "attempt to call unregisterAudioPlaybackCallback() on a callback that was never registered";
    ...
    L_0x0012:
        ...
        r2 = r5.removePlaybackCallback_sync(r6);	 Catch:{ all -> 0x0042 }
        if (r2 == 0) goto L_0x0039;
    L_0x001e:
        r2 = r5.mPlaybackCallbackList;	 Catch:{ all -> 0x0042 }
        r2 = r2.size();	 Catch:{ all -> 0x0042 }
        if (r1 <= 0) goto L_0x0038;
    L_0x0026:
        if (r2 != 0) goto L_0x0038;
    L_0x0028:
        r3 = getService();	 Catch:{ RemoteException -> 0x0032 }
        r4 = r5.mPlayCb;	 Catch:{ RemoteException -> 0x0032 }
        r3.unregisterPlaybackCallback(r4);	 Catch:{ RemoteException -> 0x0032 }
        goto L_0x0038;
    L_0x0032:
        r3 = move-exception;
        r4 = r3.rethrowFromSystemServer();	 Catch:{ all -> 0x0042 }
        throw r4;	 Catch:{ all -> 0x0042 }
    L_0x0038:
        goto L_0x0040;
    L_0x0039:
        r2 = "AudioManager";
        r3 = "attempt to call unregisterAudioPlaybackCallback() on a callback already unregistered or never registered";
    ...
    L_0x0045:
        ...
        r1 = "Illegal null AudioPlaybackCallback argument";
        r0.<init>(r1);
        throw r0;
        */
    ...
    L_0x0002:
        r0 = r6.mRecordCallbackLock;
        monitor-enter(r0);
        r1 = r6.mRecordCallbackList;	 Catch:{ all -> 0x003b }
    ...
    L_0x000b:
        r1 = r6.mRecordCallbackList;	 Catch:{ all -> 0x003b }
        r1 = r1.size();	 Catch:{ all -> 0x003b }
        r2 = r6.removeRecordCallback_sync(r7);	 Catch:{ all -> 0x003b }
        if (r2 == 0) goto L_0x0032;
    L_0x0017:
        r2 = r6.mRecordCallbackList;	 Catch:{ all -> 0x003b }
        r2 = r2.size();	 Catch:{ all -> 0x003b }
        if (r1 <= 0) goto L_0x0031;
    L_0x001f:
        if (r2 != 0) goto L_0x0031;
    L_0x0021:
        r3 = getService();	 Catch:{ all -> 0x003b }
        r4 = r6.mRecCb;	 Catch:{ RemoteException -> 0x002b }
        r3.unregisterRecordingCallback(r4);	 Catch:{ RemoteException -> 0x002b }
        goto L_0x0031;
    L_0x002b:
        r4 = move-exception;
        r5 = r4.rethrowFromSystemServer();	 Catch:{ all -> 0x003b }
        throw r5;	 Catch:{ all -> 0x003b }
    L_0x0031:
        goto L_0x0039;
    L_0x0032:
        r2 = "AudioManager";
        r3 = "attempt to call unregisterAudioRecordingCallback() on a callback already unregistered or never registered";
        android.util.Log.w(r2, r3);	 Catch:{ all -> 0x003b }
    L_0x0039:
        monitor-exit(r0);	 Catch:{ all -> 0x003b }
        return;
    L_0x003b:
    ...
    L_0x003e:
        r0 = new java.lang.IllegalArgumentException;
        r1 = "Illegal null AudioRecordingCallback argument";
        r0.<init>(r1);
        throw r0;
        */
    ...
    static int updateAudioPortCache(java.util.ArrayList<android.media.AudioPort> r17, java.util.ArrayList<android.media.AudioPatch> r18, java.util.ArrayList<android.media.AudioPort> r19) {
        ...
        r2 = r18;
        r3 = r19;
        r0 = sAudioPortEventHandler;
        r0.init();
        r4 = sAudioPortGeneration;
        monitor-enter(r4);
        r0 = sAudioPortGeneration;	 Catch:{ all -> 0x012d }
        r0 = r0.intValue();	 Catch:{ all -> 0x012d }
        r5 = 0;
        if (r0 != 0) goto L_0x010d;
    L_0x0017:
        r0 = 1;
        r6 = new int[r0];	 Catch:{ all -> 0x012d }
        r0 = new int[r0];	 Catch:{ all -> 0x012d }
        r7 = new java.util.ArrayList;	 Catch:{ all -> 0x012d }
        r7.<init>();	 Catch:{ all -> 0x012d }
        r8 = new java.util.ArrayList;	 Catch:{ all -> 0x012d }
        r8.<init>();	 Catch:{ all -> 0x012d }
    L_0x0026:
        r7.clear();	 Catch:{ all -> 0x012d }
        r9 = android.media.AudioSystem.listAudioPorts(r7, r0);	 Catch:{ all -> 0x012d }
        if (r9 == 0) goto L_0x0039;
    L_0x002f:
        r5 = "AudioManager";
        r10 = "updateAudioPortCache: listAudioPorts failed";
        android.util.Log.w(r5, r10);	 Catch:{ all -> 0x012d }
        monitor-exit(r4);	 Catch:{ all -> 0x012d }
        return r9;
    L_0x0039:
        r8.clear();	 Catch:{ all -> 0x012d }
        r10 = android.media.AudioSystem.listAudioPatches(r8, r6);	 Catch:{ all -> 0x012d }
        r9 = r10;
        if (r9 == 0) goto L_0x004d;
    L_0x0043:
        r5 = "AudioManager";
        r10 = "updateAudioPortCache: listAudioPatches failed";
        android.util.Log.w(r5, r10);	 Catch:{ all -> 0x012d }
        monitor-exit(r4);	 Catch:{ all -> 0x012d }
        return r9;
    L_0x004d:
    ...
    L_0x0060:
        r10 = r5;
    L_0x0061:
        r11 = r8.size();	 Catch:{ all -> 0x012d }
        if (r10 >= r11) goto L_0x00c4;
    L_0x0067:
        r11 = r5;
    L_0x0068:
        r12 = r8.get(r10);	 Catch:{ all -> 0x012d }
        r12 = (android.media.AudioPatch) r12;	 Catch:{ all -> 0x012d }
        r12 = r12.sources();	 Catch:{ all -> 0x012d }
        r12 = r12.length;	 Catch:{ all -> 0x012d }
    ...
    L_0x0075:
        ...
        r12 = updatePortConfig(r12, r7);	 Catch:{ all -> 0x012d }
        r13 = r8.get(r10);	 Catch:{ all -> 0x012d }
        r13 = (android.media.AudioPatch) r13;	 Catch:{ all -> 0x012d }
        r13 = r13.sources();	 Catch:{ all -> 0x012d }
    ...
    L_0x0095:
        r12 = r8.get(r10);	 Catch:{ all -> 0x012d }
        r12 = (android.media.AudioPatch) r12;	 Catch:{ all -> 0x012d }
        r12 = r12.sinks();	 Catch:{ all -> 0x012d }
        r12 = r12.length;	 Catch:{ all -> 0x012d }
    ...
    L_0x00a2:
        ...
        r13 = r8.get(r10);	 Catch:{ all -> 0x012d }
        r13 = (android.media.AudioPatch) r13;	 Catch:{ all -> 0x012d }
        r13 = r13.sinks();	 Catch:{ all -> 0x012d }
        r13[r11] = r12;	 Catch:{ all -> 0x012d }
        r11 = r11 + 1;
        goto L_0x0095;
    L_0x00c1:
        ...
        goto L_0x0061;
    L_0x00c4:
        r10 = r8.iterator();	 Catch:{ all -> 0x012d }
    L_0x00c8:
        r11 = r10.hasNext();	 Catch:{ all -> 0x012d }
        if (r11 == 0) goto L_0x00fd;
    L_0x00ce:
        r11 = r10.next();	 Catch:{ all -> 0x012d }
        r11 = (android.media.AudioPatch) r11;	 Catch:{ all -> 0x012d }
        r12 = 0;
        r13 = r11.sources();	 Catch:{ all -> 0x012d }
        r14 = r13.length;	 Catch:{ all -> 0x012d }
        r15 = r5;
    L_0x00db:
    ...
    L_0x00e3:
        ...
        goto L_0x00db;
    L_0x00e6:
        r13 = r11.sinks();	 Catch:{ all -> 0x012d }
        r14 = r13.length;	 Catch:{ all -> 0x012d }
        r15 = r5;
    L_0x00ec:
    ...
    L_0x00fc:
        goto L_0x00c8;
    L_0x00fd:
        r10 = sAudioPortsCached;	 Catch:{ all -> 0x012d }
    ...
    public static void setPortIdForMicrophones(ArrayList<MicrophoneInfo> microphones) {
        ...
        while (i >= 0) {
            ...
            for (AudioDeviceInfo device : devices) {
                if (device.getPort().type() == ((MicrophoneInfo) microphones.get(i)).getInternalDeviceType() && TextUtils.equals(device.getAddress(), ((MicrophoneInfo) microphones.get(i)).getAddress())) {
                    ((MicrophoneInfo) microphones.get(i)).setId(device.getId());
                    foundPortId = true;
                    break;
                }
            }
            if (!foundPortId) {
                ...
                stringBuilder.append(((MicrophoneInfo) microphones.get(i)).getType());
                stringBuilder.append(" address:");
                stringBuilder.append(((MicrophoneInfo) microphones.get(i)).getAddress());
                Log.i(TAG, stringBuilder.toString());
    ...
    public List<MicrophoneInfo> getMicrophones() throws IOException {
        ...
        if (status != 0) {
            ...
            Log.i(str, "fallback on device info");
    ...
    public List<BluetoothCodecConfig> getHwOffloadEncodingFormatsSupportedForA2DP() {
        ...
        Iterator it = formatsList.iterator();
        while (it.hasNext()) {
            int btSourceCodec = AudioSystem.audioFormatToBluetoothSourceCodec(((Integer) it.next()).intValue());
