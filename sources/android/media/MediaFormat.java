...
public final class MediaFormat {
    ...
    private abstract class FilteredMappedKeySet extends AbstractSet<String> {
        ...
        private class KeyIterator implements Iterator<String> {
            ...
            public KeyIterator() {
                this.mIterator = ((List) FilteredMappedKeySet.this.mKeys.stream().filter(new -$$Lambda$MediaFormat$FilteredMappedKeySet$KeyIterator$3C8D_OYFyxgHLBDv-csQxBIPlfc(this)).collect(Collectors.toList())).iterator();
            }
            ...
            public String next() {
                this.mLast = (String) this.mIterator.next();
        ...
        public int size() {
            return (int) this.mKeys.stream().filter(new -$$Lambda$MediaFormat$FilteredMappedKeySet$S0dX0CM54Hgdu801GLdPbYKEcds(this)).count();
        }
    }
    ...
    private class UnprefixedKeySet extends FilteredMappedKeySet {
        ...
        /* Access modifiers changed, original: protected */
        public boolean keepKey(String key) {
            return key.startsWith(this.mPrefix) ^ 1;
        }
