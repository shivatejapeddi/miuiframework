...
public class AudioSystem {
    ...
    public static int[] DEFAULT_STREAM_VOLUME = new int[]{4, 7, 5, 5, 6, 5, 7, 7, 5, 5, 5};
    ...
    public static final int FORCE_EARPIECE = 15;
    ...
    public static final int FOR_LB_TEST = 8;
    public static final int FOR_LOOPBACK = 9;
    ...
    public interface AudioRecordingCallback {
        void onRecordingConfigurationChanged(int i, int i2, int i3, int i4, int i5, int i6, boolean z, int[] iArr, Descriptor[] descriptorArr, Descriptor[] descriptorArr2, int i7, String str);
    }
    ...
    public static int audioFormatToBluetoothSourceCodec(int audioFormat) {
        ...
        if (audioFormat == AUDIO_FORMAT_SBC) {
            return 0;
        }
        if (audioFormat == 536870912) {
            return 2;
        }
        if (audioFormat == AUDIO_FORMAT_APTX_HD) {
            return 3;
        }
        if (audioFormat == AUDIO_FORMAT_LDAC) {
            return 5;
        }
        if (audioFormat == AUDIO_FORMAT_CELT) {
            return 8;
        }
        if (audioFormat == AUDIO_FORMAT_APTX_ADAPTIVE) {
            return 4;
        }
        if (audioFormat != AUDIO_FORMAT_APTX_TWSP) {
            return 1000000;
        }
        return 6;
    }
    ...
    private static void recordingCallbackFromNative(int r18, int r19, int r20, int r21, int r22, int r23, boolean r24, int[] r25, android.media.audiofx.AudioEffect.Descriptor[] r26, android.media.audiofx.AudioEffect.Descriptor[] r27, int r28) {
        ...
        r15 = r27;
        r1 = 0;
        r2 = android.media.AudioSystem.class;
        monitor-enter(r2);
        r0 = sRecordingCallback;	 Catch:{ all -> 0x0048 }
        r16 = r0;
