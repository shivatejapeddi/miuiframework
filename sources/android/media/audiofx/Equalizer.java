...
public class Equalizer extends AudioEffect {
    ...
    public Equalizer(int priority, int audioSession) throws IllegalStateException, IllegalArgumentException, UnsupportedOperationException, RuntimeException {
        ...
        String str = TAG;
        if (audioSession == 0) {
            Log.w(str, "WARNING: attaching an Equalizer to global output mix is deprecated!");
        }
        getNumberOfBands();
        ...
        if (i != 0) {
            ...
            for (int i2 = 0; i2 < this.mNumPresets; i2++) {
                ...
                try {
                    this.mPresetNames[i2] = new String(value, 0, length, SimpleRequest.ISO_8859_1);
                } catch (UnsupportedEncodingException e) {
                    Log.e(str, "preset name decode error");
                }
            }
        }
    }
