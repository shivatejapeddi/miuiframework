...
public class SearchIndexablesContract {
    ...
    public static final String[] INDEXABLES_RAW_COLUMNS = new String[]{BaseColumns.COLUMN_RANK, "title", "summaryOn", "summaryOff", RawData.COLUMN_ENTRIES, "keywords", RawData.COLUMN_SCREEN_TITLE, BaseColumns.COLUMN_CLASS_NAME, "iconResId", "intentAction", "intentTargetPackage", "intentTargetClass", "key", "user_id", RawData.PAYLOAD_TYPE, RawData.PAYLOAD};
    ...
    public static final String[] INDEXABLES_XML_RES_COLUMNS = new String[]{BaseColumns.COLUMN_RANK, XmlResource.COLUMN_XML_RESID, BaseColumns.COLUMN_CLASS_NAME, "iconResId", "intentAction", "intentTargetPackage", "intentTargetClass"};
    ...
    static {
        String str = "key";
        NON_INDEXABLES_KEYS_COLUMNS = new String[]{str};
        SLICE_URI_PAIRS_COLUMNS = new String[]{str, "slice_uri"};
    }
}
