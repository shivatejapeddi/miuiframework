...
public final class Settings {
    ...
    public static final class Bookmarks implements BaseColumns {
        ...
        public static CharSequence getTitle(Context context, Cursor cursor) {
            ...
            try {
                ...
                if (info != null) {
                    charSequence = info.loadLabel(packageManager);
                }
                return charSequence;
            } catch (URISyntaxException e) {
                return charSequence;
    ...
    public static class NameValueTable implements BaseColumns {
        ...
        protected static boolean putString(ContentResolver resolver, Uri uri, String name, String value) {
            try {
                ...
                Log.w(Settings.TAG, stringBuilder.toString(), e);
                return false;
            }
        }
    ...
    public static final class Global extends NameValueTable {
        ...
        private static final Validator APPLY_RAMPING_RINGER_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        ...
        private static final Validator AWARE_ALLOWED_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        ...
        private static final Validator DYNAMIC_POWER_SAVINGS_VALIDATOR = new InclusiveIntegerRangeValidator(0, 100);
        ...
        private static final Validator LOW_POWER_MODE_STICKY_AUTO_DISABLE_LEVEL_VALIDATOR = new InclusiveIntegerRangeValidator(0, 100);
        ...
        private static final Validator POWER_BUTTON_LONG_PRESS_VALIDATOR = new InclusiveIntegerRangeValidator(0, 5);
        ...
        private static final Validator POWER_BUTTON_VERY_LONG_PRESS_VALIDATOR = new InclusiveIntegerRangeValidator(0, 1);
        ...
        private static final Validator WIFI_LINK_PROBING_ENABLED_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        ...
        private static final Validator WIFI_PNO_FREQUENCY_CULLING_ENABLED_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        public static final String WIFI_PNO_RECENCY_SORTING_ENABLED = "wifi_pno_recency_sorting_enabled";
        private static final Validator WIFI_PNO_RECENCY_SORTING_ENABLED_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        ...
        private static final Validator WIFI_SCAN_THROTTLE_ENABLED_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        ...
        static {
            String str = "1";
            String str2 = "0";
            NETWORK_RECOMMENDATIONS_ENABLED_VALIDATOR = new DiscreteValueValidator(new String[]{"-1", str2, str});
            String str3 = "2";
            EMERGENCY_TONE_VALIDATOR = new DiscreteValueValidator(new String[]{str2, str, str3});
            ENABLE_AUTOMATIC_SYSTEM_SERVER_HEAP_DUMPS_VALIDATOR = new DiscreteValueValidator(new String[]{str2, str});
            LOW_POWER_MODE_STICKY_AUTO_DISABLE_ENABLED_VALIDATOR = new DiscreteValueValidator(new String[]{str2, str});
            AUTOMATIC_POWER_SAVE_MODE_VALIDATOR = new DiscreteValueValidator(new String[]{str2, str});
            ENCODED_SURROUND_OUTPUT_VALIDATOR = new DiscreteValueValidator(new String[]{str2, str, str3, "3"});
            ...
            str2 = "charging_sounds_enabled";
            VALIDATORS.put(str2, CHARGING_SOUNDS_ENABLED_VALIDATOR);
            ...
            str3 = "zen_duration";
            VALIDATORS.put(str3, ZEN_DURATION_VALIDATOR);
            String str4 = "charging_vibration_enabled";
            VALIDATORS.put(str4, CHARGING_VIBRATION_ENABLED_VALIDATOR);
            ...
            MOVED_TO_SECURE.add(str2);
            MOVED_TO_SECURE.add(str4);
     ...
     */
        /* JADX WARNING: Missing block: B:53:0x009b, code skipped:
     ...
     */
        /* JADX WARNING: Missing block: B:59:?, code skipped:
            ...
            r2 = r0;
     */
        /* JADX WARNING: Missing block: B:63:0x00c8, code skipped:
            r2 = r21.call(r24.getPackageName(), android.provider.Settings.ContentProviderHolder.access$000(r1.mProviderHolder).getAuthority(), r1.mCallGetCommand, r25, r16);
     */
        /* JADX WARNING: Missing block: B:64:0x00e3, code skipped:
            if (r2 == null) goto L_0x0146;
     */
        /* JADX WARNING: Missing block: B:65:0x00e5, code skipped:
            r3 = r2.getString("value");
     */
        /* JADX WARNING: Missing block: B:66:0x00ed, code skipped:
            if (r12 == false) goto L_0x013c;
     */
        /* JADX WARNING: Missing block: B:67:0x00ef, code skipped:
            monitor-enter(r23);
     */
        /* JADX WARNING: Missing block: B:68:0x00f0, code skipped:
            if (r17 == false) goto L_0x0126;
     */
     ...
     */
        /* JADX WARNING: Missing block: B:72:0x0103, code skipped:
     ...
     */
        /* JADX WARNING: Missing block: B:74:0x010d, code skipped:
            if (r1.mGenerationTracker == null) goto L_0x011a;
     */
        /* JADX WARNING: Missing block: B:76:0x0113, code skipped:
            if (android.provider.Settings.isInSystemServer() != false) goto L_0x011a;
     */
        /* JADX WARNING: Missing block: B:77:0x0115, code skipped:
            r1.mGenerationTracker.destroy();
     */
        /* JADX WARNING: Missing block: B:78:0x011a, code skipped:
            r1.mGenerationTracker = new android.provider.Settings.GenerationTracker(r0, r4, r5, new android.provider.-$$Lambda$Settings$NameValueCache$qSyMM6rUAHCa-5rsP-atfAqR3sA(r1));
     */
        /* JADX WARNING: Missing block: B:80:0x0128, code skipped:
            if (r1.mGenerationTracker == null) goto L_0x0137;
     */
        /* JADX WARNING: Missing block: B:82:0x0130, code skipped:
            if (r13 != r1.mGenerationTracker.getCurrentGeneration()) goto L_0x0137;
     */
        /* JADX WARNING: Missing block: B:83:0x0132, code skipped:
            r1.mValues.put(r8, r3);
     */
        /* JADX WARNING: Missing block: B:84:0x0137, code skipped:
            monitor-exit(r23);
     */
        /* JADX WARNING: Missing block: B:90:0x013c, code skipped:
            return r3;
     */
        ...
        L_0x0015:
            monitor-enter(r23);
            r0 = r1.mGenerationTracker;	 Catch:{ all -> 0x0048 }
            if (r0 == 0) goto L_0x0045;
        L_0x001a:
            r0 = r1.mGenerationTracker;	 Catch:{ all -> 0x0048 }
            r0 = r0.isGenerationChanged();	 Catch:{ all -> 0x0048 }
            if (r0 == 0) goto L_0x0028;
        L_0x0022:
            r0 = r1.mValues;	 Catch:{ all -> 0x0048 }
            r0.clear();	 Catch:{ all -> 0x0048 }
            goto L_0x003a;
        L_0x0028:
            r0 = r1.mValues;	 Catch:{ all -> 0x0048 }
            r0 = r0.containsKey(r8);	 Catch:{ all -> 0x0048 }
            if (r0 == 0) goto L_0x003a;
        L_0x0030:
            r0 = r1.mValues;	 Catch:{ all -> 0x0048 }
            r0 = r0.get(r8);	 Catch:{ all -> 0x0048 }
            r0 = (java.lang.String) r0;	 Catch:{ all -> 0x0048 }
            monitor-exit(r23);	 Catch:{ all -> 0x0048 }
            return r0;
        L_0x003a:
            r0 = r1.mGenerationTracker;	 Catch:{ all -> 0x0048 }
            if (r0 == 0) goto L_0x0045;
        L_0x003e:
            r0 = r1.mGenerationTracker;	 Catch:{ all -> 0x0048 }
            r0 = r0.getCurrentGeneration();	 Catch:{ all -> 0x0048 }
            r2 = r0;
        L_0x0045:
            monitor-exit(r23);	 Catch:{ all -> 0x0048 }
            r13 = r2;
        ...
        L_0x004b:
            r13 = r2;
        L_0x004c:
            r0 = r1.mProviderHolder;
            r14 = r24;
            r21 = r0.getProvider(r14);
            r0 = r1.mCallGetCommand;
            r15 = 0;
        ...
        L_0x005c:
            r2 = new android.os.Bundle;	 Catch:{ RemoteException -> 0x0145 }
            r2.<init>();	 Catch:{ RemoteException -> 0x0145 }
            r0 = r2;
            r2 = "_user";
            r0.putInt(r2, r9);	 Catch:{ RemoteException -> 0x0145 }
            r2 = r0;
            goto L_0x006a;
        L_0x0069:
            r2 = r0;
        L_0x006a:
            r3 = 0;
            monitor-enter(r23);	 Catch:{ RemoteException -> 0x0145 }
            if (r12 == 0) goto L_0x0088;
        L_0x006e:
            r0 = r1.mGenerationTracker;	 Catch:{ all -> 0x0085 }
            if (r0 != 0) goto L_0x0088;
        L_0x0072:
            r3 = 1;
            if (r2 != 0) goto L_0x007b;
        L_0x0075:
            r0 = new android.os.Bundle;	 Catch:{ all -> 0x0085 }
            r0.<init>();	 Catch:{ all -> 0x0085 }
            r2 = r0;
        L_0x007b:
            r0 = "_track_generation";
            r2.putString(r0, r15);	 Catch:{ all -> 0x0085 }
            r16 = r2;
            r17 = r3;
            goto L_0x008c;
        L_0x0085:
        ...
        L_0x0088:
            ...
            r17 = r3;
        L_0x008c:
            monitor-exit(r23);	 Catch:{ all -> 0x013e }
            r0 = android.provider.Settings.isInSystemServer();	 Catch:{ RemoteException -> 0x0145 }
            if (r0 == 0) goto L_0x00c8;
        L_0x0093:
            r0 = android.os.Binder.getCallingUid();	 Catch:{ RemoteException -> 0x0145 }
            r2 = android.os.Process.myUid();	 Catch:{ RemoteException -> 0x0145 }
            if (r0 == r2) goto L_0x00c8;
        L_0x009d:
            r2 = android.os.Binder.clearCallingIdentity();	 Catch:{ RemoteException -> 0x0145 }
            r18 = r2;
            r3 = r24.getPackageName();	 Catch:{ all -> 0x00c3 }
            r0 = r1.mProviderHolder;	 Catch:{ all -> 0x00c3 }
            r0 = r0.mUri;	 Catch:{ all -> 0x00c3 }
            r4 = r0.getAuthority();	 Catch:{ all -> 0x00c3 }
            r5 = r1.mCallGetCommand;	 Catch:{ all -> 0x00c3 }
            r2 = r21;
            r6 = r25;
            r7 = r16;
            r0 = r2.call(r3, r4, r5, r6, r7);	 Catch:{ all -> 0x00c3 }
            android.os.Binder.restoreCallingIdentity(r18);	 Catch:{ RemoteException -> 0x0145 }
            r2 = r0;
            goto L_0x00e3;
        L_0x00c3:
            r0 = move-exception;
            android.os.Binder.restoreCallingIdentity(r18);	 Catch:{ RemoteException -> 0x0145 }
            throw r0;	 Catch:{ RemoteException -> 0x0145 }
        L_0x00c8:
            r3 = r24.getPackageName();	 Catch:{ RemoteException -> 0x0145 }
            r0 = r1.mProviderHolder;	 Catch:{ RemoteException -> 0x0145 }
            r0 = r0.mUri;	 Catch:{ RemoteException -> 0x0145 }
            r4 = r0.getAuthority();	 Catch:{ RemoteException -> 0x0145 }
            r5 = r1.mCallGetCommand;	 Catch:{ RemoteException -> 0x0145 }
            r2 = r21;
            r6 = r25;
            r7 = r16;
            r0 = r2.call(r3, r4, r5, r6, r7);	 Catch:{ RemoteException -> 0x0145 }
            r2 = r0;
        L_0x00e3:
            if (r2 == 0) goto L_0x013d;
        L_0x00e5:
            r0 = "value";
            r0 = r2.getString(r0);	 Catch:{ RemoteException -> 0x0145 }
            r3 = r0;
        ...
        L_0x00f2:
            r0 = "_track_generation";
            r0 = r2.getParcelable(r0);	 Catch:{ all -> 0x0139 }
            r0 = (android.util.MemoryIntArray) r0;	 Catch:{ all -> 0x0139 }
            r4 = "_generation_index";
            r5 = -1;
            r4 = r2.getInt(r4, r5);	 Catch:{ all -> 0x0139 }
            if (r0 == 0) goto L_0x0126;
        L_0x0103:
            if (r4 < 0) goto L_0x0126;
        L_0x0105:
            r5 = "_generation";
            r5 = r2.getInt(r5, r11);	 Catch:{ all -> 0x0139 }
            r6 = r1.mGenerationTracker;	 Catch:{ all -> 0x0139 }
            if (r6 == 0) goto L_0x011a;
        L_0x010f:
            r6 = android.provider.Settings.isInSystemServer();	 Catch:{ all -> 0x0139 }
            if (r6 != 0) goto L_0x011a;
        L_0x0115:
            r6 = r1.mGenerationTracker;	 Catch:{ all -> 0x0139 }
            r6.destroy();	 Catch:{ all -> 0x0139 }
        L_0x011a:
            r6 = new android.provider.Settings$GenerationTracker;	 Catch:{ all -> 0x0139 }
            r7 = new android.provider.-$$Lambda$Settings$NameValueCache$qSyMM6rUAHCa-5rsP-atfAqR3sA;	 Catch:{ all -> 0x0139 }
            r7.<init>(r1);	 Catch:{ all -> 0x0139 }
            r6.<init>(r0, r4, r5, r7);	 Catch:{ all -> 0x0139 }
            r1.mGenerationTracker = r6;	 Catch:{ all -> 0x0139 }
        L_0x0126:
            r0 = r1.mGenerationTracker;	 Catch:{ all -> 0x0139 }
            if (r0 == 0) goto L_0x0137;
        L_0x012a:
            r0 = r1.mGenerationTracker;	 Catch:{ all -> 0x0139 }
            r0 = r0.getCurrentGeneration();	 Catch:{ all -> 0x0139 }
            if (r13 != r0) goto L_0x0137;
        L_0x0132:
            r0 = r1.mValues;	 Catch:{ all -> 0x0139 }
            r0.put(r8, r3);	 Catch:{ all -> 0x0139 }
        L_0x0137:
            monitor-exit(r23);	 Catch:{ all -> 0x0139 }
            goto L_0x013c;
        L_0x0139:
            r0 = move-exception;
            monitor-exit(r23);	 Catch:{ all -> 0x0139 }
        ...
        L_0x013e:
            ...
            r3 = r17;
        L_0x0143:
            monitor-exit(r23);	 Catch:{ all -> 0x0085 }
            throw r0;	 Catch:{ RemoteException -> 0x0145 }
        L_0x0145:
            r0 = move-exception;
        L_0x0146:
            r22 = 0;
            r0 = "name=?";
            r2 = new java.lang.String[r10];	 Catch:{ RemoteException -> 0x01fa }
            r2[r11] = r8;	 Catch:{ RemoteException -> 0x01fa }
            r6 = android.content.ContentResolver.createSqlQueryBundle(r0, r2, r15);	 Catch:{ RemoteException -> 0x01fa }
            r0 = android.provider.Settings.isInSystemServer();	 Catch:{ RemoteException -> 0x01fa }
            if (r0 == 0) goto L_0x0187;
        L_0x0159:
            r0 = android.os.Binder.getCallingUid();	 Catch:{ RemoteException -> 0x01fa }
            r2 = android.os.Process.myUid();	 Catch:{ RemoteException -> 0x01fa }
            if (r0 == r2) goto L_0x0187;
        L_0x0163:
            r2 = android.os.Binder.clearCallingIdentity();	 Catch:{ RemoteException -> 0x01fa }
            r16 = r2;
            r3 = r24.getPackageName();	 Catch:{ all -> 0x0182 }
            r4 = r1.mUri;	 Catch:{ all -> 0x0182 }
            r5 = SELECT_VALUE_PROJECTION;	 Catch:{ all -> 0x0182 }
            r7 = 0;
            r2 = r21;
            r0 = r2.query(r3, r4, r5, r6, r7);	 Catch:{ all -> 0x0182 }
            r22 = r0;
            android.os.Binder.restoreCallingIdentity(r16);	 Catch:{ RemoteException -> 0x01fa }
            r2 = r15;
            r3 = r22;
            goto L_0x019d;
        L_0x0182:
            r0 = move-exception;
            android.os.Binder.restoreCallingIdentity(r16);	 Catch:{ RemoteException -> 0x01fa }
            throw r0;	 Catch:{ RemoteException -> 0x01fa }
        L_0x0187:
            r16 = r24.getPackageName();	 Catch:{ RemoteException -> 0x01fa }
            r0 = r1.mUri;	 Catch:{ RemoteException -> 0x01fa }
            r18 = SELECT_VALUE_PROJECTION;	 Catch:{ RemoteException -> 0x01fa }
            r20 = 0;
            r2 = r15;
            r15 = r21;
            r17 = r0;
            r19 = r6;
            r0 = r15.query(r16, r17, r18, r19, r20);	 Catch:{ RemoteException -> 0x01f6 }
            r3 = r0;
        L_0x019d:
            if (r3 != 0) goto L_0x01c6;
        L_0x019f:
            r0 = "Settings";
            r4 = new java.lang.StringBuilder;	 Catch:{ RemoteException -> 0x01f2, all -> 0x01ee }
            r4.<init>();	 Catch:{ RemoteException -> 0x01f2, all -> 0x01ee }
            r5 = "Can't get key ";
            r4.append(r5);	 Catch:{ RemoteException -> 0x01f2, all -> 0x01ee }
            r4.append(r8);	 Catch:{ RemoteException -> 0x01f2, all -> 0x01ee }
            r5 = " from ";
            r4.append(r5);	 Catch:{ RemoteException -> 0x01f2, all -> 0x01ee }
            r5 = r1.mUri;	 Catch:{ RemoteException -> 0x01f2, all -> 0x01ee }
            r4.append(r5);	 Catch:{ RemoteException -> 0x01f2, all -> 0x01ee }
            r4 = r4.toString();	 Catch:{ RemoteException -> 0x01f2, all -> 0x01ee }
            android.util.Log.w(r0, r4);	 Catch:{ RemoteException -> 0x01f2, all -> 0x01ee }
        ...
        L_0x01c5:
            return r2;
        L_0x01c6:
            r0 = r3.moveToNext();	 Catch:{ RemoteException -> 0x01f2, all -> 0x01ee }
            if (r0 == 0) goto L_0x01d1;
        L_0x01cc:
            r15 = r3.getString(r11);	 Catch:{ RemoteException -> 0x01f2, all -> 0x01ee }
            goto L_0x01d2;
        L_0x01d1:
            r15 = r2;
        L_0x01d2:
            r4 = r15;
            monitor-enter(r23);	 Catch:{ RemoteException -> 0x01f2, all -> 0x01ee }
            r0 = r1.mGenerationTracker;	 Catch:{ all -> 0x01eb }
            if (r0 == 0) goto L_0x01e5;
        L_0x01d8:
            r0 = r1.mGenerationTracker;	 Catch:{ all -> 0x01eb }
            r0 = r0.getCurrentGeneration();	 Catch:{ all -> 0x01eb }
            if (r13 != r0) goto L_0x01e5;
        L_0x01e0:
            r0 = r1.mValues;	 Catch:{ all -> 0x01eb }
            r0.put(r8, r4);	 Catch:{ all -> 0x01eb }
        L_0x01e5:
            monitor-exit(r23);	 Catch:{ all -> 0x01eb }
            r3.close();
            return r4;
        L_0x01eb:
            r0 = move-exception;
            monitor-exit(r23);	 Catch:{ all -> 0x01eb }
            throw r0;	 Catch:{ RemoteException -> 0x01f2, all -> 0x01ee }
        L_0x01ee:
            r0 = move-exception;
            r22 = r3;
            goto L_0x0223;
        ...
        L_0x01fc:
            r3 = "Settings";
            r4 = new java.lang.StringBuilder;	 Catch:{ all -> 0x01f8 }
            r4.<init>();	 Catch:{ all -> 0x01f8 }
            r5 = "Can't get key ";
            r4.append(r5);	 Catch:{ all -> 0x01f8 }
            r4.append(r8);	 Catch:{ all -> 0x01f8 }
            r5 = " from ";
            r4.append(r5);	 Catch:{ all -> 0x01f8 }
            r5 = r1.mUri;	 Catch:{ all -> 0x01f8 }
            r4.append(r5);	 Catch:{ all -> 0x01f8 }
            r4 = r4.toString();	 Catch:{ all -> 0x01f8 }
            android.util.Log.w(r3, r4, r0);	 Catch:{ all -> 0x01f8 }
    ...
    public static final class Secure extends NameValueTable {
        ...
        private static final Validator ACCESSIBILITY_CAPTIONING_PRESET_VALIDATOR = new DiscreteValueValidator(new String[]{"-1", "0", "1", "2", "3", "4"});
        @UnsupportedAppUsage
        ...
        private static final Validator AWARE_ENABLED_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        public static final String AWARE_LOCK_ENABLED = "aware_lock_enabled";
        private static final Validator AWARE_LOCK_ENABLED_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        @Deprecated
        ...
        private static final Validator DISPLAY_WHITE_BALANCE_ENABLED_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        ...
        private static final Validator DOZE_ALWAYS_ON_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        public static final String DOZE_DOUBLE_TAP_GESTURE = "doze_pulse_on_double_tap";
        private static final Validator DOZE_DOUBLE_TAP_GESTURE_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        @UnsupportedAppUsage
        ...
        private static final Validator DOZE_PICK_UP_GESTURE_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        ...
        private static final Validator DOZE_TAP_SCREEN_GESTURE_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        public static final String DOZE_WAKE_SCREEN_GESTURE = "doze_wake_screen_gesture";
        private static final Validator DOZE_WAKE_SCREEN_GESTURE_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        ...
        private static final Validator FACE_UNLOCK_ALWAYS_REQUIRE_CONFIRMATION_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        public static final String FACE_UNLOCK_APP_ENABLED = "face_unlock_app_enabled";
        private static final Validator FACE_UNLOCK_APP_ENABLED_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        ...
        private static final Validator FACE_UNLOCK_DISMISSES_KEYGUARD_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        ...
        private static final Validator FACE_UNLOCK_EDUCATION_INFO_DISPLAYED_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        public static final String FACE_UNLOCK_KEYGUARD_ENABLED = "face_unlock_keyguard_enabled";
        private static final Validator FACE_UNLOCK_KEYGUARD_ENABLED_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        ...
        private static final Validator GLOBAL_ACTIONS_PANEL_ENABLED_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        @Deprecated
        public static final String HTTP_PROXY = "http_proxy";
        @SystemApi
        ...
        private static final Validator IN_CALL_NOTIFICATION_ENABLED_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        ...
        private static final Validator LOCK_SCREEN_CUSTOM_CLOCK_FACE_VALIDATOR = SettingsValidators.ANY_STRING_VALIDATOR;
        @Deprecated
        ...
        private static final Validator LOCK_SCREEN_WHEN_TRUST_LOST_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        ...
        private static final Validator NOTIFICATION_BUBBLES_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        public static final String NOTIFICATION_DISMISS_RTL = "notification_dismiss_rtl";
        private static final Validator NOTIFICATION_DISMISS_RTL_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        ...
        private static final Validator ODI_CAPTIONS_ENABLED_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        ...
        public static final int SHOW_ROTATION_SUGGESTIONS_DEFAULT = 0;
        ...
        private static final Validator SILENCE_GESTURE_COUNT_VALIDATOR = SettingsValidators.NON_NEGATIVE_INTEGER_VALIDATOR;
        private static final Validator SILENCE_GESTURE_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        ...
        private static final Validator SKIP_GESTURE_COUNT_VALIDATOR = SettingsValidators.NON_NEGATIVE_INTEGER_VALIDATOR;
        private static final Validator SKIP_GESTURE_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        ...
        private static final Validator THEME_CUSTOMIZATION_OVERLAY_PACKAGES_VALIDATOR = SettingsValidators.JSON_OBJECT_VALIDATOR;
        ...
        private static final Validator TRUST_AGENTS_EXTEND_UNLOCK_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        ...
        private static final Validator UI_NIGHT_MODE_VALIDATOR = new InclusiveIntegerRangeValidator(0, 2);
        ...
        private static final Validator WIFI_DISCONNECT_DELAY_DURATION_VALIDATOR = SettingsValidators.NON_NEGATIVE_INTEGER_VALIDATOR;
        @Deprecated
        public static final String WIFI_IDLE_MS = "wifi_idle_ms";
        @Deprecated
        public static final String WIFI_MAX_DHCP_RETRY_COUNT = "wifi_max_dhcp_retry_count";
        ...
        static {
            ...
            String str = "bugreport_in_power_menu";
            MOVED_TO_GLOBAL.add(str);
            ...
            MOVED_TO_GLOBAL.add(Global.NTP_SERVER_2);
            ...
            String str2 = "usb_mass_storage_enabled";
            MOVED_TO_GLOBAL.add(str2);
            ...
            String str3 = "wifi_networks_available_notification_on";
            MOVED_TO_GLOBAL.add(str3);
            String str4 = "wifi_networks_available_repeat_delay";
            MOVED_TO_GLOBAL.add(str4);
            String str5 = "wifi_num_open_networks_kept";
            MOVED_TO_GLOBAL.add(str5);
            ...
            MOVED_TO_GLOBAL.add(Global.WIFI_COVERAGE_EXTEND_FEATURE_ENABLED);
            ...
            String str6 = ":";
            ENABLED_ACCESSIBILITY_SERVICES_VALIDATOR = new ComponentNameListValidator(str6);
            TOUCH_EXPLORATION_GRANTED_ACCESSIBILITY_SERVICES_VALIDATOR = new ComponentNameListValidator(str6);
            String str7 = "2";
            String str8 = "1";
            String str9 = "0";
            ACCESSIBILITY_CAPTIONING_EDGE_TYPE_VALIDATOR = new DiscreteValueValidator(new String[]{str9, str8, str7});
            ACCESSIBILITY_DISPLAY_DALTONIZER_VALIDATOR = new DiscreteValueValidator(new String[]{"-1", str9, "11", "12", "13"});
            PREFERRED_TTY_MODE_VALIDATOR = new DiscreteValueValidator(new String[]{str9, str8, str7, "3"});
            INCALL_POWER_BUTTON_BEHAVIOR_VALIDATOR = new DiscreteValueValidator(new String[]{str8, str7});
            ENABLED_NOTIFICATION_ASSISTANT_VALIDATOR = new ComponentNameListValidator(str6);
            ENABLED_NOTIFICATION_LISTENERS_VALIDATOR = new ComponentNameListValidator(str6);
            ENABLED_NOTIFICATION_POLICY_ACCESS_PACKAGES_VALIDATOR = new PackageNameListValidator(str6);
            ENABLED_VR_LISTENERS_VALIDATOR = new ComponentNameListValidator(str6);
            VR_DISPLAY_MODE_VALIDATOR = new DiscreteValueValidator(new String[]{str9, str8});
            NAVIGATION_MODE_VALIDATOR = new DiscreteValueValidator(new String[]{str9, str8, str7});
            VALIDATORS.put(str, BUGREPORT_IN_POWER_MENU_VALIDATOR);
            Map map = VALIDATORS;
            Validator validator = ALLOW_MOCK_LOCATION_VALIDATOR;
            str6 = ALLOW_MOCK_LOCATION;
            map.put(str6, validator);
            VALIDATORS.put(str2, USB_MASS_STORAGE_ENABLED_VALIDATOR);
            map = VALIDATORS;
            validator = ACCESSIBILITY_DISPLAY_INVERSION_ENABLED_VALIDATOR;
            str2 = ACCESSIBILITY_DISPLAY_INVERSION_ENABLED;
            map.put(str2, validator);
            map = VALIDATORS;
            validator = ACCESSIBILITY_DISPLAY_DALTONIZER_VALIDATOR;
            str7 = ACCESSIBILITY_DISPLAY_DALTONIZER;
            map.put(str7, validator);
            ...
            map = VALIDATORS;
            validator = ENABLED_ACCESSIBILITY_SERVICES_VALIDATOR;
            str8 = ENABLED_ACCESSIBILITY_SERVICES;
            map.put(str8, validator);
            ...
            VALIDATORS.put(str3, WIFI_NETWORKS_AVAILABLE_NOTIFICATION_ON_VALIDATOR);
            VALIDATORS.put(str4, WIFI_NETWORKS_AVAILABLE_REPEAT_DELAY_VALIDATOR);
            VALIDATORS.put(str5, WIFI_NUM_OPEN_NETWORKS_KEPT_VALIDATOR);
            ...
            CLONE_TO_MANAGED_PROFILE.add(str6);
            CLONE_TO_MANAGED_PROFILE.add(ALLOWED_GEOLOCATION_ORIGINS);
            CLONE_TO_MANAGED_PROFILE.add(CONTENT_CAPTURE_ENABLED);
            CLONE_TO_MANAGED_PROFILE.add(str8);
            ...
            INSTANT_APP_SETTINGS.add(str8);
            INSTANT_APP_SETTINGS.add(ACCESSIBILITY_SPEAK_PASSWORD);
            INSTANT_APP_SETTINGS.add(str2);
    ...
    public static final class System extends NameValueTable {
        ...
        private static final Validator ADAPTIVE_SLEEP_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
        @Deprecated
        public static final String ADB_ENABLED = "adb_enabled";
        ...
        private static final Validator MASTER_BALANCE_VALIDATOR = new InclusiveFloatRangeValidator(-1.0f, 1.0f);
        @UnsupportedAppUsage
        ...
        private static final Validator PEAK_REFRESH_RATE_VALIDATOR = new InclusiveFloatRangeValidator(24.0f, Float.MAX_VALUE);
        @UnsupportedAppUsage
        ...
        public static final Validator TIME_12_24_VALIDATOR = new DiscreteValueValidator(new String[]{"12", "24", null});
        @Deprecated
        public static final String TRANSITION_ANIMATION_SCALE = "transition_animation_scale";
        @UnsupportedAppUsage
        ...
        static {
            ...
            DEFAULT_RINGTONE_URI = getUriFor(str3);
            String str4 = NOTIFICATION_SOUND;
            DEFAULT_NOTIFICATION_URI = getUriFor(str4);
            String str5 = ALARM_ALERT;
            DEFAULT_ALARM_ALERT_URI = getUriFor(str5);
            String str6 = SIP_ALWAYS;
            SIP_CALL_OPTIONS_VALIDATOR = new DiscreteValueValidator(new String[]{str6, SIP_ADDRESS_ONLY});
            Set set = PUBLIC_SETTINGS;
            String str7 = END_BUTTON_BEHAVIOR;
            set.add(str7);
            set = PUBLIC_SETTINGS;
            String str8 = WIFI_USE_STATIC_IP;
            set.add(str8);
            ...
            set = PUBLIC_SETTINGS;
            String str12 = SOUND_EFFECTS_ENABLED;
            set.add(str12);
            set = PUBLIC_SETTINGS;
            String str13 = HAPTIC_FEEDBACK_ENABLED;
            set.add(str13);
            PUBLIC_SETTINGS.add(SHOW_WEB_SUGGESTIONS);
            PUBLIC_SETTINGS.add(VIBRATE_WHEN_RINGING);
            PRIVATE_SETTINGS.add(str8);
            PRIVATE_SETTINGS.add(str7);
            ...
            PRIVATE_SETTINGS.add(str2);
            PRIVATE_SETTINGS.add(str);
            ...
            VALIDATORS.put("stay_on_while_plugged_in", STAY_ON_WHILE_PLUGGED_IN_VALIDATOR);
            VALIDATORS.put(str7, END_BUTTON_BEHAVIOR_VALIDATOR);
            VALIDATORS.put(str8, WIFI_USE_STATIC_IP_VALIDATOR);
            ...
            VALIDATORS.put(str3, RINGTONE_VALIDATOR);
            VALIDATORS.put(str4, NOTIFICATION_SOUND_VALIDATOR);
            VALIDATORS.put(str5, ALARM_ALERT_VALIDATOR);
            ...
            VALIDATORS.put(str9, TEXT_SHOW_PASSWORD_VALIDATOR);
            VALIDATORS.put("auto_time", AUTO_TIME_VALIDATOR);
            VALIDATORS.put("auto_time_zone", AUTO_TIME_ZONE_VALIDATOR);
            ...
            VALIDATORS.put(str10, TIME_12_24_VALIDATOR);
            VALIDATORS.put(str11, DATE_FORMAT_VALIDATOR);
            ...
            VALIDATORS.put(str12, SOUND_EFFECTS_ENABLED_VALIDATOR);
            VALIDATORS.put(str13, HAPTIC_FEEDBACK_ENABLED_VALIDATOR);
            VALIDATORS.put(str2, POWER_SOUNDS_ENABLED_VALIDATOR);
            VALIDATORS.put(str, DOCK_SOUNDS_ENABLED_VALIDATOR);
            ...
            VALIDATORS.put(str6, SIP_ALWAYS_VALIDATOR);
            ...
            CLONE_TO_MANAGED_PROFILE.add(str11);
            CLONE_TO_MANAGED_PROFILE.add(str13);
            CLONE_TO_MANAGED_PROFILE.add(str12);
            CLONE_TO_MANAGED_PROFILE.add(str9);
            CLONE_TO_MANAGED_PROFILE.add(str10);
            CLONE_FROM_PARENT_ON_VALUE.put(str3, Secure.SYNC_PARENT_SOUNDS);
            CLONE_FROM_PARENT_ON_VALUE.put(str4, Secure.SYNC_PARENT_SOUNDS);
            CLONE_FROM_PARENT_ON_VALUE.put(str5, Secure.SYNC_PARENT_SOUNDS);
            ...
            INSTANT_APP_SETTINGS.add(str9);
            INSTANT_APP_SETTINGS.add(str11);
            INSTANT_APP_SETTINGS.add(FONT_SCALE);
            INSTANT_APP_SETTINGS.add(str13);
            INSTANT_APP_SETTINGS.add(str10);
            INSTANT_APP_SETTINGS.add(str12);
        ...
        public static String getStringForUser(ContentResolver resolver, String name, int userHandle) {
            ...
            boolean contains = MOVED_TO_SECURE.contains(name);
            String str = "Setting ";
        ...
        public static void adjustConfigurationForUser(ContentResolver cr, Configuration outConfig, int userHandle, boolean updateSettingsIfEmpty) {
            ...
            String str = SYSTEM_LOCALES;
            String localeValue = getStringForUser(cr, str, userHandle);
            if (localeValue != null) {
                outConfig.setLocales(LocaleList.forLanguageTags(localeValue));
            } else if (updateSettingsIfEmpty) {
                putStringForUser(cr, str, outConfig.getLocales().toLanguageTags(), userHandle);
            }
            MiuiSettings.getConfigurationForUser(cr, outConfig, userHandle);
        }
        ...
        public static boolean putConfigurationForUser(ContentResolver cr, Configuration config, int userHandle) {
            if (putFloatForUser(cr, FONT_SCALE, config.fontScale, userHandle)) {
                if (putStringForUser(cr, SYSTEM_LOCALES, config.getLocales().toLanguageTags(), userHandle)) {
                    return true;
                }
            }
            return false;
    ...
    static {
        String str = permission.WRITE_SETTINGS;
        PM_WRITE_SETTINGS = new String[]{str};
        PM_CHANGE_NETWORK_STATE = new String[]{permission.CHANGE_NETWORK_STATE, str};
    }
