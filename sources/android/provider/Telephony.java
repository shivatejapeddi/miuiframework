...
public final class Telephony {
     ...
     */
            static long getOrCreateCanonicalAddressId(android.content.ContentResolver r6, java.lang.String r7) {
                /*
                r0 = "Telephony";
                r1 = android.provider.Telephony.RcsColumns.CONTENT_AND_AUTHORITY;
                r1 = r1.buildUpon();
                r2 = "canonical-address";
                r1.appendPath(r2);
                r2 = "address";
                r1.appendQueryParameter(r2, r7);
                r2 = r1.build();
                r3 = 0;
                r3 = r6.query(r2, r3, r3, r3);
                if (r3 == 0) goto L_0x0033;
            L_0x001d:
                r4 = r3.moveToFirst();	 Catch:{ all -> 0x0031 }
                if (r4 == 0) goto L_0x0033;
            L_0x0023:
                r0 = "_id";
                r0 = r3.getColumnIndex(r0);	 Catch:{ all -> 0x0031 }
                r4 = r3.getLong(r0);	 Catch:{ all -> 0x0031 }
                r3.close();
                return r4;
            L_0x0031:
                r0 = move-exception;
                goto L_0x004c;
            L_0x0033:
                r4 = "getOrCreateCanonicalAddressId returned no rows";
                android.telephony.Rlog.e(r0, r4);	 Catch:{ all -> 0x0031 }
                if (r3 == 0) goto L_0x003e;
            L_0x003b:
                r3.close();
            L_0x003e:
                r3 = "getOrCreateCanonicalAddressId failed";
                android.telephony.Rlog.e(r0, r3);
                r0 = new java.lang.IllegalArgumentException;
                r3 = "Unable to find or allocate a canonical address ID";
                r0.<init>(r3);
                throw r0;
            L_0x004c:
        ...
        public static final class Intents {
            ...
            public static SmsMessage[] getMessagesFromIntent(Intent intent) {
                ...
                try {
                    ...
                    if (messages == null) {
                        Rlog.e(str, "pdus does not exist in the intent");
                        return null;
                    }
        ...
        public static long getOrCreateThreadId(Context context, Set<String> recipients) {
            ...
            if (cursor != null) {
                try {
                    ...
                    Rlog.e(str, "getOrCreateThreadId returned no rows!");
                    cursor.close();
                } finally {
                    cursor.close();
                }
