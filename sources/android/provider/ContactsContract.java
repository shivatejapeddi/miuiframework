...
public final class ContactsContract {
    ...
    public static final class CommonDataKinds {
        ...
        public static final class Phone implements DataColumnsWithJoins, CommonColumns, ContactCounts {
            ...
            static {
                ...
                String str = Phones.CONTENT_DIRECTORY;
                CONTENT_URI = Uri.withAppendedPath(uri, str);
                ENTERPRISE_CONTENT_URI = Uri.withAppendedPath(Data.ENTERPRISE_CONTENT_URI, str);
            }
    ...
    public static class Contacts implements BaseColumns, ContactsColumns, ContactOptionsColumns, ContactNameColumns, ContactStatusColumns, ContactCounts {
            ...
            public static final class Builder {
                ...
                public Uri build() {
                    ...
                    for (int i2 = 0; i2 < i; i2++) {
                        ...
                        stringBuilder.append((String) this.mValues.get(i2));
        ...
        static {
            String str = "filter";
            CONTENT_FILTER_URI = Uri.withAppendedPath(CONTENT_URI, str);
            CONTENT_STREQUENT_FILTER_URI = Uri.withAppendedPath(CONTENT_STREQUENT_URI, str);
        }
    ...
    public static final class Groups implements BaseColumns, GroupsColumns, SyncColumns {
        ...
        public static final Uri CONTENT_URI = Uri.withAppendedPath(ContactsContract.AUTHORITY_URI, LogSwitchesConfigManager.EXTRA_KEY_TAGGROUPS);
    ...
    public static class StatusUpdates implements StatusColumns, PresenceColumns {
        ...
        static {
            String str = "status_updates";
            CONTENT_URI = Uri.withAppendedPath(ContactsContract.AUTHORITY_URI, str);
            PROFILE_CONTENT_URI = Uri.withAppendedPath(Profile.CONTENT_URI, str);
        }
    ...
    public static final class QuickContact {
        ...
        public static Intent rebuildManagedQuickContactsIntent(String lookupKey, long contactId, boolean isContactIdIgnored, long directoryId, Intent originalIntent) {
            ...
            intent.putExtra(str, originalIntent.getIntExtra(str, 3));
            String str2 = EXTRA_EXCLUDE_MIMES;
            intent.putExtra(str2, originalIntent.getStringArrayExtra(str2));
            return intent;
        }
    ...
    public static final class RawContacts implements BaseColumns, RawContactsColumns, ContactOptionsColumns, ContactNameColumns, SyncColumns {
        ...
        private static class EntityIteratorImpl extends CursorEntityIterator {
            ...
            public android.content.Entity getEntityAndIncrementCursor(Cursor cursor) throws RemoteException {
                String str = "_id";
                int columnRawContactId = cursor.getColumnIndexOrThrow(str);
                ...
                DatabaseUtils.cursorLongToContentValuesIfPresent(cursor, cv, str);
                ...
                while (rawContactId == cursor.getLong(columnRawContactId)) {
                    ...
                    cv.put(str, Long.valueOf(cursor.getLong(cursor.getColumnIndexOrThrow("data_id"))));
                    ...
                    String str2 = DataColumns.DATA_VERSION;
                    DatabaseUtils.cursorLongToContentValuesIfPresent(cursor, cv, str2);
                    DatabaseUtils.cursorStringToContentValuesIfPresent(cursor, cv, GroupMembership.GROUP_SOURCE_ID);
                    DatabaseUtils.cursorStringToContentValuesIfPresent(cursor, cv, str2);
    ...
    public static final class RawContactsEntity implements BaseColumns, DataColumns, RawContactsColumns {
        ...
        static {
            String str = "raw_contact_entities";
            CONTENT_URI = Uri.withAppendedPath(ContactsContract.AUTHORITY_URI, str);
            PROFILE_CONTENT_URI = Uri.withAppendedPath(Profile.CONTENT_URI, str);
        }
    }
