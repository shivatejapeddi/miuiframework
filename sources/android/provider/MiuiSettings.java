...
public class MiuiSettings {
    ...
    /* renamed from: android.provider.MiuiSettings$1 */
    ...
    public static final class AntiSpam {
        ...
        public static final HashMap<Integer, HashMap<Integer, String>> mapIdToMarkTime = new HashMap<Integer, HashMap<Integer, String>>() {
            {
                ...
                hashMap = (HashMap) get(valueOf);
                Integer valueOf4 = Integer.valueOf(10);
                hashMap.put(valueOf4, AntiSpam.MARK_TIME_HARASS);
        ...
        public static final HashMap<Integer, HashMap<Integer, String>> mapIdToState = new HashMap<Integer, HashMap<Integer, String>>() {
            {
                ...
                hashMap = (HashMap) get(valueOf);
                Integer valueOf4 = Integer.valueOf(10);
                hashMap.put(valueOf4, AntiSpam.HARASS_NUM_STATE);
        ...
        public static boolean shouldShowGuidingDialog(Context context, int id) {
            if (Build.IS_INTERNATIONAL_BUILD || ((HashMap) mapIdToState.get(Integer.valueOf(1))).get(Integer.valueOf(id)) == null || isMarkNumBlockOpen(context, 1) || isMarkNumBlockOpen(context, 2) || isMarkNumBlockSet(context) || isMarkingTypeGuided(context, mapIdToString(id))) {
                return false;
            }
            return true;
        }
     ...
     */
        public static boolean isQuietModeEnableForCurrentUser(android.content.Context r7) {
            /*
            r0 = 0;
            r1 = r7.getContentResolver();	 Catch:{ Exception -> 0x002a }
            r2 = "content://antispamCommon/zenmode";
            r2 = android.net.Uri.parse(r2);	 Catch:{ Exception -> 0x002a }
            r3 = "1";
            r2 = android.net.Uri.withAppendedPath(r2, r3);	 Catch:{ Exception -> 0x002a }
            r3 = 0;
            r4 = 0;
            r5 = 0;
            r6 = 0;
            r1 = r1.query(r2, r3, r4, r5, r6);	 Catch:{ Exception -> 0x002a }
            r0 = r1;
        ...
        public static int getEndTimeForQuietMode(Context context) {
            return android.provider.Settings.Secure.getInt(context.getContentResolver(), END_TIME_OF_QM, DisplayMetrics.DENSITY_420);
        }
    ...
    public static final class ForceTouch {
        ...
        private static long getTotalInternalMemory() {
            ...
            String str = "mixed";
            if (!str.equals(SystemProperties.get("ro.boot.sdcard.type", str))) {
    ...
    public static final class Key {
        ...
        public static String getKeyAndGestureShortcutAction(Context context, String function) {
            String action = KEY_NONE;
            if (function == null) {
                return action;
            }
            if (function.equals(getKeyAndGestureShortcutFunction(context, LONG_PRESS_POWER_KEY))) {
                return LONG_PRESS_POWER_KEY;
            }
            if (function.equals(getKeyAndGestureShortcutFunction(context, DOUBLE_CLICK_POWER_KEY))) {
                return DOUBLE_CLICK_POWER_KEY;
            }
            if (function.equals(getKeyAndGestureShortcutFunction(context, THREE_GESTURE_DOWN))) {
                return THREE_GESTURE_DOWN;
            }
            if (function.equals(getKeyAndGestureShortcutFunction(context, LONG_PRESS_MENU_KEY_WHEN_LOCK))) {
                return LONG_PRESS_MENU_KEY_WHEN_LOCK;
            }
            if (function.equals(getKeyAndGestureShortcutFunction(context, LONG_PRESS_HOME_KEY))) {
                return LONG_PRESS_HOME_KEY;
            }
            if (function.equals(getKeyAndGestureShortcutFunction(context, LONG_PRESS_MENU_KEY))) {
                return LONG_PRESS_MENU_KEY;
            }
            if (function.equals(getKeyAndGestureShortcutFunction(context, LONG_PRESS_BACK_KEY))) {
                return LONG_PRESS_BACK_KEY;
            }
            if (function.equals(getKeyAndGestureShortcutFunction(context, KEY_COMBINATION_POWER_HOME))) {
                return KEY_COMBINATION_POWER_HOME;
            }
            if (function.equals(getKeyAndGestureShortcutFunction(context, KEY_COMBINATION_POWER_BACK))) {
                return KEY_COMBINATION_POWER_BACK;
            }
            if (function.equals(getKeyAndGestureShortcutFunction(context, KEY_COMBINATION_POWER_MENU))) {
        ...
        public static String getKeyAndGestureShortcutFunction(Context context, String action) {
            String function = getKeyAndGestureShortcutSetFunction(context, action);
            if (TextUtils.isEmpty(function)) {
                if (LONG_PRESS_POWER_KEY.equals(action)) {
                    function = null;
                } else if (DOUBLE_CLICK_POWER_KEY.equals(action)) {
                    function = null;
                } else if (THREE_GESTURE_DOWN.equals(action)) {
                    function = SCREEN_SHOT;
                } else if (LONG_PRESS_HOME_KEY.equals(action)) {
                    function = !Build.IS_GLOBAL_BUILD ? LAUNCH_VOICE_ASSISTANT : LAUNCH_GOOGLE_SEARCH;
                } else if (LONG_PRESS_MENU_KEY.equals(action)) {
                    function = "show_menu";
                } else if (LONG_PRESS_MENU_KEY_WHEN_LOCK.equals(action)) {
                    function = TURN_ON_TORCH;
                } else if (LONG_PRESS_BACK_KEY.equals(action)) {
                    function = null;
                } else if (KEY_COMBINATION_POWER_HOME.equals(action)) {
                    function = null;
                } else if (KEY_COMBINATION_POWER_BACK.equals(action)) {
                    function = null;
                } else if (KEY_COMBINATION_POWER_MENU.equals(action)) {
                    function = null;
                }
            }
        ...
        private static String getKeyAndGestureShortcutSetFunction(Context context, String action) {
            if (context != null) {
                return android.provider.Settings.System.getStringForUser(context.getContentResolver(), action, -2);
            }
            return null;
        }
        ...
        public static void updateOldKeyFunctionToNew(Context context) {
            ...
            if (android.provider.Settings.System.getIntForUser(contentResolver, str, 0, -2) == 0) {
                ...
                boolean equals = str2.equals(homeAction);
                ...
                } else if (str2.equals(backAction)) {
                    android.provider.Settings.System.putStringForUser(context.getContentResolver(), str4, str6, -2);
                } else if (str2.equals(menuAction)) {
                    android.provider.Settings.System.putStringForUser(context.getContentResolver(), str3, str6, -2);
                }
                str2 = "close_app";
                if (str2.equals(backAction)) {
                    android.provider.Settings.System.putStringForUser(context.getContentResolver(), str4, str2, -2);
                } else if (str2.equals(homeAction)) {
                    android.provider.Settings.System.putStringForUser(context.getContentResolver(), str5, str2, -2);
                } else if (str2.equals(menuAction)) {
                    android.provider.Settings.System.putStringForUser(context.getContentResolver(), str3, str2, -2);
                }
        ...
        public static void setPowerKeyLaunchVoiceAssistant(Context context) {
            ...
            String voiceAssistantAction = getKeyAndGestureShortcutAction(context, str);
            boolean equals = KEY_NONE.equals(voiceAssistantAction);
            ...
            if (equals) {
                ...
                android.provider.Settings.System.putStringForUser(context.getContentResolver(), voiceAssistantAction, str3, -2);
                android.provider.Settings.System.putStringForUser(context.getContentResolver(), str2, voiceAssistantAction, -2);
            }
    ...
    public static final class Privacy {
        ...
        public static void setEnabled(Context context, String key, boolean enabled) {
            ((SecurityManager) context.getSystemService(Context.SECURITY_SERVICE)).setAppPrivacyStatus(key, enabled);
        }

        public static boolean isEnabled(Context context, String key) {
            return ((SecurityManager) context.getSystemService(Context.SECURITY_SERVICE)).isAppPrivacyEnabled(key);
        }
    }
            ...
            if (!TextUtils.isEmpty(packageList)) {
                ...
                if (packageArr != null) {
                    for (String pair : packageArr) {
                        ...
                        pkg2PaperMode.put(pair.substring(null, equalIndex), Boolean.valueOf(pair.substring(equalIndex + 1)));
                    }
                }
            }
    ...
    public static class Secure extends android.provider.SystemSettings.Secure {
        ...
        public static final String CLOUD_CLIPBOARD_CONTENT_SAVED = "cloud_clipboard_content_saved";
        ...
        public static void showSetPasswordConfirmDialog(final Fragment fragment, final OnClickListener dialogClickListener, final String businessKey, final int setPasswordRequestCode) {
            showConfirmDialog(fragment.getActivity(), new OnClickListener() {
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    OnClickListener onClickListener = dialogClickListener;
        ...
        private static void showConfirmDialog(Activity activity, OnClickListener listener) {
            new Builder(activity).setCancelable(false).setIconAttribute(16843605).setTitle((int) R.string.set_password_title).setMessage((int) R.string.set_password_message).setPositiveButton((int) R.string.set_password_action, listener).setNegativeButton((int) R.string.cancel_action, listener).create().show();
        }
        ...
        public static void showApplyPasswordConfirmDialog(final Activity act, final OnClickListener clickListener, final String businessKey, String businessName) {
            ...
            new Builder(act).setCancelable(false).setIconAttribute(16843605).setTitle(act.getString(R.string.apply_password_confirm_dlg_title, businessName)).setMessage(act.getString(R.string.apply_password_confirm_dlg_msg, businessName)).setPositiveButton((int) R.string.apply_password_action, listener).setNegativeButton((int) R.string.cancel_action, listener).create().show();
        }
        ...
        static void recordAccessibilityModifications(ContentResolver cr, String name, String value, int userHandle) {
            ...
            String str = value;
            int i = userHandle;
            String oldValue = android.provider.Settings.Secure.ENABLED_ACCESSIBILITY_SERVICES;
            if (oldValue.equals(name)) {
                String str2;
                String str3;
                int length;
                oldValue = android.provider.Settings.Secure.getStringForUser(contentResolver, oldValue, i);
                String[] newServices = ":";
                int i2 = 0;
                String[] oldServices = oldValue == null ? new String[0] : oldValue.split(newServices);
                newServices = str == null ? new String[0] : str.split(newServices);
                int length2 = oldServices.length;
                int i3 = 0;
                while (true) {
                    str2 = Session.SESSION_SEPARATION_CHAR_CHILD;
                    str3 = "\\W";
                    if (i3 >= length2) {
                        break;
                    }
                    String oldService = oldServices[i3];
                    if (!TextUtils.isEmpty(oldService)) {
                        boolean contains = false;
                        length = newServices.length;
                        for (int i4 = i2; i4 < length; i4++) {
                            if (oldService.equals(newServices[i4])) {
                                contains = true;
                                break;
                            }
                        }
                        if (!contains) {
                            ...
                            stringBuilder.append(oldService.replaceAll(str3, str2));
                            android.provider.Settings.Secure.putStringForUser(contentResolver, stringBuilder.toString(), cr.getPackageName(), i);
                        }
                    }
                    i3++;
                    i2 = 0;
                ...
                for (String newService : newServices) {
                    if (!TextUtils.isEmpty(newService)) {
                        ...
                        for (String oldService2 : oldServices) {
                            if (oldService2.equals(newService)) {
                                contains2 = true;
                                break;
                            }
                        }
                        if (!contains2) {
                            ...
                            stringBuilder2.append("enable_");
                            stringBuilder2.append(newService.replaceAll(str3, str2));
                            android.provider.Settings.Secure.putStringForUser(contentResolver, stringBuilder2.toString(), cr.getPackageName(), i);
                        }
                    }
                }
            }
    ...
    public static final class SilenceMode {
        ...
        public static final String[] MISTAT_RINGERMODE_LIST = new String[]{"normal", "DND", "null", "silence", "new"};
    ...
    public static class System extends android.provider.SystemSettings.System {
        ...
        public static final int CALL_BREATHING_LIGHT_COLOR_DEFAULT = Resources.getSystem().getColor(R.color.android_config_defaultNotificationColor);
        public static final String CALL_BREATHING_LIGHT_FREQ = "call_breathing_light_freq";
        public static final int CALL_BREATHING_LIGHT_FREQ_DEFAULT = Resources.getSystem().getInteger(R.integer.config_defaultNotificationLedFreq);
        ...
        public static final String[] POWER_MODE_VALUES = new String[]{POWER_MODE_VALUE_HIGH, "middle"};
        ...
        public static final boolean SHOW_LOCK_BEFORE_UNLOCK_DEFAULT = (Build.IS_CM_CUSTOMIZATION_TEST ^ 1);
        ...
        public static boolean isMiuiPublicSettings(PackageInfo packageInfo, String name) {
            String str = "SystemSettings";
            if (PUBLIC_SETTINGS_OPEN.contains(name)) {
                Slog.d(str, "Hit MiuiSettings.System.PUBLIC_SETTINGS_OPEN");
                return true;
            } else if (PUBLIC_SETTINGS.contains(name) && (packageInfo.applicationInfo.flags & 1) != 0) {
                return true;
            } else {
                Slog.d(str, "Want to modify SystemSettings? See MiuiSettings.System.PUBLIC_SETTINGS");
                return false;
            }
        }
        ...
        static {
            ...
            String str5;
            String str6;
            String themeClockSettingPrefix;
            Set set;
            ...
            if (!(Build.IS_CTA_BUILD || Build.IS_CM_CUSTOMIZATION_TEST || Build.IS_CU_CUSTOMIZATION_TEST)) {
                if (!"mx_telcel".equals(SystemProperties.get("ro.miui.customized.region", ""))) {
                    ...
                    PUBLIC_SETTINGS.add(MiProfile.SETTINGS_MIPROFILE_USER_NOTICE);
                    PUBLIC_SETTINGS.add(MiProfile.SETTINGS_MIPROFILE_BADGE_NOTICE);
                    PUBLIC_SETTINGS.add(MiProfile.SETTINGS_MIPROFILE_SET);
                    PUBLIC_SETTINGS.add(MiProfile.SETTINGS_MIPROFILE_ON);
                    PUBLIC_SETTINGS.add(MiProfile.SETTINGS_MIPROFILE_VISIBLE);
                    ...
                    PUBLIC_SETTINGS.add(LivetalkUtils.LIVETALK_SERVICE_STATUS);
                    PUBLIC_SETTINGS.add(LivetalkUtils.LIVETALK_ENABLED);
                    PUBLIC_SETTINGS.add(LivetalkUtils.LIVETALK_SWITCH_STATE);
                    PUBLIC_SETTINGS.add(LivetalkUtils.NEED_PROMPT);
                    PUBLIC_SETTINGS.add(LivetalkUtils.LIVETALK_USE_CURRENT_MI_ACCOUNT);
                    PUBLIC_SETTINGS.add(LivetalkUtils.LIVETALK_INTERNAL_DIAL_AVAIABLE);
                    PUBLIC_SETTINGS.add(LivetalkUtils.LIVETALK_INTERNATIONAL_DIAL_AVAIABLE);
                    PUBLIC_SETTINGS.add(LivetalkUtils.LIVETALK_RECENT_COUNTRY_REMAIN_MINS);
                    PUBLIC_SETTINGS.add(LivetalkUtils.LIVETALK_DIAL_RANGE);
                    PUBLIC_SETTINGS.add(LivetalkUtils.LIVETALK_AVAILABLE_STATUS);
                    PUBLIC_SETTINGS.add(LivetalkUtils.LIVETALK_REMAIN_MINUTES);
                    PUBLIC_SETTINGS.add("lock_wallpaper_provider_authority");
                    themeClockSettingPrefix = "clock_changed_time_";
                    set = PUBLIC_SETTINGS;
        ...
        public static boolean isHapticFeedbackDisabled(Context context) {
            return android.provider.Settings.System.getIntForUser(context.getContentResolver(), android.provider.Settings.System.HAPTIC_FEEDBACK_ENABLED, 0, -3) == 0;
        }

        public static int getShowCustomCarrierDefault() {
            return (Build.IS_CM_CUSTOMIZATION_TEST || Build.IS_CU_CUSTOMIZATION_TEST || Build.IS_CT_CUSTOMIZATION_TEST || Resources.getSystem().getBoolean(R.bool.config_show_status_bar_carrier)) ? 1 : 0;
        }
        ...
        public static String getScreenKeyLongPressAction(Context context, String key) {
            ...
            action = "none";
            String[] defaultActions = context.getResources().getStringArray(R.array.screen_key_long_press_default_action);
        ...
        public static ArrayList<Integer> getScreenKeyOrder(Context context) {
            ...
            if (!TextUtils.isEmpty(keyList)) {
                String[] keys = keyList.split(WifiEnterpriseConfig.CA_CERT_ALIAS_DELIMITER);
                int i = 0;
                while (i < keys.length) {
                    try {
        ...
        public static void updateScreenColor() {
            if (!"1".equals(SystemProperties.get("sys.boot_completed", "0")) || !FeatureParser.getBoolean("support_screen_color_persist", false)) {
                ...
                Slog.d(str, "updateScreenColor end");
            }
        }
        ...
        public static Rect getDisplayWindowSizeInSmartCover() {
            ...
            int[] defaultSize = new int[]{res.getInteger(R.integer.config_smartcover_smallwindow_left), res.getInteger(R.integer.config_smartcover_smallwindow_top), res.getInteger(R.integer.config_smartcover_smallwindow_right), res.getInteger(R.integer.config_smartcover_smallwindow_bottom)};
            Rect rect = new Rect(defaultSize[0], defaultSize[1], defaultSize[2], defaultSize[3]);
            if (type == null) {
                return rect;
            }
            displaySize = new int[4];
            displaySize[0] = FeatureParser.getInteger("smartcover_smallwindow_left", defaultSize[0]);
            displaySize[1] = FeatureParser.getInteger("smartcover_smallwindow_top", defaultSize[1]);
            displaySize[2] = FeatureParser.getInteger("smartcover_smallwindow_right", defaultSize[2]);
            displaySize[3] = FeatureParser.getInteger("smartcover_smallwindow_bottom", defaultSize[3]);
            if (FeatureParser.getBoolean("support_multiple_small_win_cover", false)) {
                int i = AnonymousClass1.$SwitchMap$android$provider$MiuiSettings$System$SmallWindowType[type.ordinal()];
                if (i == 1) {
        ...
        public static SmallWindowType getSmallWindowMode() {
            ...
            if (win == -99) {
                ...
                if (FeatureParser.getBoolean("support_multiple_small_win_cover", false)) {
                    typeArray = FeatureParser.getIntArray(str);
                } else {
                    typeArray = new int[1];
                    if (FeatureParser.getBoolean("support_small_win_cover", false)) {
                        typeArray[0] = FeatureParser.getInteger(str, -1);
                    } else {
                        typeArray[0] = -1;
                    }
                }
        ...
        public static void setSmartCoverMode(boolean enable) {
            boolean supportHallSensor = FeatureParser.getBoolean("support_hall_sensor", false);
            String str = SMARTCOVER_MODE_KEY;
            if (supportHallSensor && enable) {
                SmallWindowType coverType = getSmallWindowMode();
                if (coverType == null) {
                    SystemProperties.set(str, String.valueOf(1));
                    return;
                }
                int i = AnonymousClass1.$SwitchMap$android$provider$MiuiSettings$System$SmallWindowType[coverType.ordinal()];
                if (i == 1 || i == 2) {
        ...
        public static boolean isTouchAssistantEnabledForUser(Context context, int userId, boolean hasNavBar) {
            if (android.provider.Settings.System.getIntForUser(context.getContentResolver(), KEY_TOUCH_ASSISTANT_ENABLED, 0, userId) == 1) {
                return true;
            }
            return false;
        }
        ...
        public static boolean isSuperSaveModeOpen(Context context, int userId) {
            if (android.provider.Settings.System.getIntForUser(context.getContentResolver(), POWERMODE_SUPERSAVE_OPEN, 0, userId) != 0) {
                return true;
            }
            return false;
        }
    ...
    public static final class XSpace {
        ...
        static {
            CROSS_PROFILE_SECURE_SETTINGS.add(android.provider.Settings.Secure.LOCK_SCREEN_ALLOW_PRIVATE_NOTIFICATIONS);
            CROSS_PROFILE_SECURE_SETTINGS.add(android.provider.Settings.Secure.LOCK_SCREEN_SHOW_NOTIFICATIONS);
        ...
        public static void setAskType(Context context, String appType, int askType) {
            if (appType.equals(KEY_WEIXIN_SEND_TO_FRIEND) || appType.equals(KEY_WEIXIN_SEND_TO_CIRCLE) || appType.equals(KEY_WEIXIN_OPEN)) {
                appType = KEY_WEIXIN_SHARE;
            } else if (appType.equals(KEY_WEIBO_SEND)) {
                appType = KEY_WEIBO_SHARE;
            } else if (appType.equals(KEY_XSPACE_QQ_SEND_TO_FRIEND) || appType.equals(KEY_XSPACE_QQ_SEND_TO_PC) || appType.equals(KEY_XSPACE_QQ_OPEN)) {
        ...
        public static int getAskType(Context context, String appType) {
            try {
                if (!(appType.equals(KEY_WEIXIN_SEND_TO_FRIEND) || appType.equals(KEY_WEIXIN_SEND_TO_CIRCLE))) {
                    if (!appType.equals(KEY_WEIXIN_OPEN)) {
        ...
        public static String getSettingAppType(String preKey) {
            ...
            if (PREKEY_XSPACE_QQ_OPEN.equals(preKey)) {
                return KEY_XSPACE_QQ_OPEN_FROM_XIAOAI;
            }
            if (PREKEY_XSPACE_WHATSAPP_SEND.equals(preKey)) {
                return KEY_WHATSAPP_SEND;
            }
            if (PREKEY_XSPACE_WHATSAPP_OPEN.equals(preKey)) {
                return KEY_WHATSAPP_OPEN_FROM_GOOGLE_VOICE_ASSISTANT;
            }
            if (PREKEY_XSPACE_FACEBOOK_SEND.equals(preKey)) {
                return KEY_FACEBOOK_SEND;
            }
            if (PREKEY_XSPACE_FACEBOOK_LOGIN.equals(preKey)) {
                return KEY_FACEBOOK_LOGIN;
            }
            if (PREKEY_XSPACE_FACEBOOK_OPEN.equals(preKey)) {
                return KEY_FACEBOOK_OPEN_FROM_GOOGLE_VOICE_ASSISTANT;
            }
            if (PREKEY_XSPACE_INSTAGRAM_SEND.equals(preKey)) {
                return KEY_INSTAGRAM_SEND;
            }
            if (PREKEY_XSPACE_INSTAGRAM_OPEN.equals(preKey)) {
                return KEY_INSTAGRAM_OPEN_FROM_GOOGLE_VOICE_ASSISTANT;
            }
            return askType;
        }
        ...
        public static void resetDefaultSetting(Context context, String pkgName) {
            ...
            } else if (INSTAGRAM_PACKAGE_NAME.equals(pkgName)) {
        ...
        public static int getGuideNotificationTimes(Context context, String key) {
            int i = 0;
            try {
                i = android.provider.Settings.Secure.getIntForUser(context.getContentResolver(), key, 0);
                return i;
            } catch (SettingNotFoundException e) {
                return i;
            }
    ...
    static {
        ...
        CROSS_PROFILE_SETTINGS.add(android.provider.Settings.System.NOTIFICATION_SOUND);
        CROSS_PROFILE_SETTINGS.add(android.provider.Settings.System.ALARM_ALERT);
        CROSS_PROFILE_SETTINGS.add(android.provider.Settings.System.USER_ROTATION);
        CROSS_PROFILE_SETTINGS.add(android.provider.Settings.System.ACCELEROMETER_ROTATION);
        CROSS_PROFILE_SETTINGS.add(android.provider.Settings.System.HIDE_ROTATION_LOCK_TOGGLE_FOR_ACCESSIBILITY);
