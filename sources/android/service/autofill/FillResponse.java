...
public final class FillResponse implements Parcelable {
    public static final Creator<FillResponse> CREATOR = new Creator<FillResponse>() {
        public FillResponse createFromParcel(Parcel parcel) {
            ...
            ParceledListSlice<Dataset> datasetSlice = (ParceledListSlice) parcel2.readParcelable(null);
            ...
            builder.setSaveInfo((SaveInfo) parcel2.readParcelable(null));
            builder.setClientState((Bundle) parcel2.readParcelable(null));
            AutofillId[] authenticationIds = (AutofillId[]) parcel2.readParcelableArray(null, AutofillId.class);
            IntentSender authentication = (IntentSender) parcel2.readParcelable(null);
            RemoteViews presentation = (RemoteViews) parcel2.readParcelable(null);
            if (authenticationIds != null) {
                builder.setAuthentication(authenticationIds, authentication, presentation);
            }
            RemoteViews header = (RemoteViews) parcel2.readParcelable(null);
            if (header != null) {
                builder.setHeader(header);
            }
            RemoteViews footer = (RemoteViews) parcel2.readParcelable(null);
            if (footer != null) {
                builder.setFooter(footer);
            }
            UserData userData = (UserData) parcel2.readParcelable(null);
            if (userData != null) {
                builder.setUserData(userData);
            }
            builder.setIgnoredIds((AutofillId[]) parcel2.readParcelableArray(null, AutofillId.class));
            long disableDuration = parcel.readLong();
            if (disableDuration > 0) {
                builder.disableAutofill(disableDuration);
            }
            AutofillId[] fieldClassifactionIds = (AutofillId[]) parcel2.readParcelableArray(null, AutofillId.class);
    ...
    private boolean mContainCaptcha;
    ...
    public static final class Builder {
        ...
        public Builder setContainCaptcha(boolean isContainCaptcha) {
            throwIfDestroyed();
            this.mContainCaptcha = isContainCaptcha;
            return this;
        }

        public FillResponse build() {
            throwIfDestroyed();
            if (this.mAuthentication == null && this.mDatasets == null && this.mSaveInfo == null && this.mDisableDuration == 0 && this.mFieldClassificationIds == null && this.mClientState == null && !this.mContainCaptcha) {
    ...
    private FillResponse(Builder builder) {
        ...
        this.mContainCaptcha = builder.mContainCaptcha;
    }
    ...
    public List<Dataset> getDatasets() {
        ParceledListSlice parceledListSlice = this.mDatasets;
    ...
    public boolean isContainCaptcha() {
        return this.mContainCaptcha;
    }

    public void setContainCaptcha(boolean containCaptcha) {
        this.mContainCaptcha = containCaptcha;
    }
    ...
    public String toString() {
        ...
        builder.append(", containCaptcha=");
        builder.append(this.mContainCaptcha);
        if (this.mFlags != 0) {
    ...
    public void writeToParcel(Parcel parcel, int flags) {
        ...
        parcel.writeInt(this.mContainCaptcha);
