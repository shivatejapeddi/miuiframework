...
public final class SaveInfo implements Parcelable {
    ...
    public static final class Builder {
        ...
        public Builder addSanitizer(Sanitizer sanitizer, AutofillId... ids) {
            throwIfDestroyed();
            Preconditions.checkArgument(ArrayUtils.isEmpty((Object[]) ids) ^ 1, "ids cannot be empty or null");
            ...
            for (AutofillId id : ids) {
                Preconditions.checkArgument(this.mSanitizerIds.contains(id) ^ 1, "already added %s", id);
        ...
        public SaveInfo build() {
            throwIfDestroyed();
            boolean z = (ArrayUtils.isEmpty(this.mRequiredIds) && ArrayUtils.isEmpty(this.mOptionalIds) && (this.mFlags & 4) == 0) ? false : true;
            Preconditions.checkState(z, "must have at least one required or optional id or FLAG_DELAYED_SAVE");
