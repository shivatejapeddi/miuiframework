...
public class VoiceInteractionSession implements Callback, ComponentCallbacks2 {
    ...
    public static final class AbortVoiceRequest extends Request {
        ...
        public CharSequence getMessage() {
            ...
            return prompt != null ? prompt.getVoicePromptAt(0) : null;
        }
    ...
    public static class ActivityId {
        ...
        public boolean equals(Object o) {
            ...
            if (iBinder != null) {
                z = iBinder.equals(that.mAssistToken);
            } else if (that.mAssistToken != null) {
                z = false;
            }
            return z;
        }
        ...
        public int hashCode() {
            int result = this.mTaskId * 31;
            IBinder iBinder = this.mAssistToken;
            return result + (iBinder != null ? iBinder.hashCode() : 0);
        }
    }
    ...
    public static final class PickOptionRequest extends Request {
        ...
        /* Access modifiers changed, original: 0000 */
        public void sendPickOptionResult(boolean finished, Option[] selections, Bundle result) {
            if (finished) {
                try {
                    finishRequest();
                } catch (RemoteException e) {
    ...
    private static class SafeResultListener implements OnResultListener {
        ...
        public void onResult(Bundle result) {
            ...
            if (session != null) {
                Consumer<Bundle> consumer = session.removeSafeResultListener(this);
                if (consumer != null) {
    ...
    public VoiceInteractionSession(Context context, Handler handler) {
        ...
        this.mInteractor = new IVoiceInteractor.Stub() {
            ...
            public void notifyDirectActionsChanged(int taskId, IBinder assistToken) {
                VoiceInteractionSession.this.mHandlerCaller.getHandler().sendMessage(PooledLambda.obtainMessage(-$$Lambda$lR4OeV3qsxUC-rL-7Xl2vrhTvEo.INSTANCE, VoiceInteractionSession.this, new ActivityId(taskId, assistToken)));
            }
            ...
            public void handleAssist(int taskId, IBinder assistToken, Bundle data, AssistStructure structure, AssistContent content, int index, int count) {
                ...
                new Thread("AssistStructure retriever") {
                    public void run() {
                        ...
                        AssistStructure assistStructure = assistStructure;
    ...
    public void doShow(Bundle args, int flags, final IVoiceInteractionSessionShowCallback showCallback) {
        boolean z = this.mInShowWindow;
        String str = TAG;
        if (z) {
            Log.w(str, "Re-entrance in to showWindow");
            return;
        }
        try {
            ...
            Log.w(str, "Error calling onShown", e);
        } catch (Throwable th) {
    ...
    public final void requestDirectActions(ActivityId activityId, CancellationSignal cancellationSignal, Executor resultExecutor, Consumer<List<DirectAction>> callback) {
        ...
        if (this.mToken != null) {
            ...
            if (cancellationSignal != null) {
                cancellationCallback = new RemoteCallback(new -$$Lambda$VoiceInteractionSession$KRmvXWbKzOj6uOiuAkDjhkUvQiw(cancellationSignal));
            } else {
                cancellationCallback = null;
            }
            try {
                this.mSystemService.requestDirectActions(this.mToken, activityId.getTaskId(), activityId.getAssistToken(), cancellationCallback, new RemoteCallback(createSafeResultListener(new -$$Lambda$VoiceInteractionSession$ONdRuCs-OqsJCBOvPdgOMEsz684(resultExecutor, callback))));
                return;
            } catch (RemoteException e) {
    ...
    static /* synthetic */ void lambda$requestDirectActions$0(CancellationSignal cancellationSignal, Bundle b) {
        if (b != null) {
            IBinder cancellation = b.getBinder(VoiceInteractor.KEY_CANCELLATION_SIGNAL);
    ...
    static /* synthetic */ void lambda$requestDirectActions$2(Executor resultExecutor, Consumer callback, Bundle result) {
        ...
        resultExecutor.execute(new -$$Lambda$VoiceInteractionSession$fvrSEzYI3LvOp-mfME5kNVi91bw(callback, list));
    }
    ...
    public final void performDirectAction(DirectAction action, Bundle extras, CancellationSignal cancellationSignal, Executor resultExecutor, Consumer<Bundle> resultListener) {
        if (this.mToken != null) {
            ...
            if (cancellationSignal != null) {
                cancellationCallback = new RemoteCallback(createSafeResultListener(new -$$Lambda$VoiceInteractionSession$2YI2merL0-kdgL83g93OW541J8w(cancellationSignal)));
            } else {
                cancellationCallback = null;
            }
            try {
                this.mSystemService.performDirectAction(this.mToken, action.getId(), extras, action.getTaskId(), action.getActivityId(), cancellationCallback, new RemoteCallback(createSafeResultListener(new -$$Lambda$VoiceInteractionSession$9GV3ALC6LWOMyg5zazTo6TodsHU(resultExecutor, resultListener))));
                return;
            } catch (RemoteException e) {
                e.rethrowFromSystemServer();
                return;
    ...
    static /* synthetic */ void lambda$performDirectAction$6(Executor resultExecutor, Consumer resultListener, Bundle b) {
        if (b != null) {
            resultExecutor.execute(new -$$Lambda$VoiceInteractionSession$sg0qPgWHpOBD2lLJ7BGNEVSsBdo(resultListener, b));
        } else {
            resultExecutor.execute(new -$$Lambda$VoiceInteractionSession$bujvs7MJfXO9xSx9M8NS3hINZ_k(resultListener));
        }
    }
    ...
    private Consumer<Bundle> removeSafeResultListener(SafeResultListener listener) {
        Consumer consumer;
        synchronized (this) {
            consumer = (Consumer) this.mRemoteCallbacks.remove(listener);
        }
        return consumer;
    }
}
