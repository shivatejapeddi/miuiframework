...
public class VoiceInteractionServiceInfo {
    ...
    public VoiceInteractionServiceInfo(PackageManager pm, ServiceInfo si) {
        ...
        String str = "error parsing voice interaction service meta-data";
        String str2 = TAG;
        String str3 = "Error parsing voice interation service meta-data: ";
        if (si == null) {
            this.mParseError = "Service not available";
            return;
        }
        if (permission.BIND_VOICE_INTERACTION.equals(si.permission)) {
