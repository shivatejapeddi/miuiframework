...
public abstract class MediaBrowserService extends Service {
    ...
    public final Bundle getBrowserRootHints() {
        ...
        if (connectionRecord != null) {
            return connectionRecord.rootHints == null ? null : new Bundle(this.mCurConnection.rootHints);
        } else {
    ...
    public final RemoteUserInfo getCurrentBrowserInfo() {
        ConnectionRecord connectionRecord = this.mCurConnection;
        if (connectionRecord != null) {
            return new RemoteUserInfo(connectionRecord.pkg, this.mCurConnection.pid, this.mCurConnection.uid);
        }
        throw new IllegalStateException("This should be called inside of onGetRoot or onLoadChildren or onLoadItem methods");
    }
