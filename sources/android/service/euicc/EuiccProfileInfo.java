...
public final class EuiccProfileInfo implements Parcelable {
    ...
    public static final class Builder {
        ...
        public EuiccProfileInfo build() {
            ...
            if (str != null) {
                return new EuiccProfileInfo(str, this.mNickname, this.mServiceProviderName, this.mProfileName, this.mProfileClass, this.mState, this.mCarrierIdentifier, this.mPolicyRules, this.mAccessRules, null);
            }
