...
public abstract class PackageManagerInternal {
    ...
    public interface PackageListObserver {
        ...
        void onPackageChanged(String packageName, int uid) {
        }
    }
    ...
    public abstract void forEachInstalledPackage(Consumer<Package> consumer, int i);

    public abstract void forEachPackage(Consumer<Package> consumer);
    ...
    public abstract Package getDisabledSystemPackage(String str);
