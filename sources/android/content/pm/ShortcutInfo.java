...
public final class ShortcutInfo implements Parcelable {
    ...
    public void enforceMandatoryFields(boolean forPinned) {
        ...
        String str = "Shortcut Intent must be provided";
        Preconditions.checkNotNull(this.mIntents, str);
        Preconditions.checkArgument(this.mIntents.length > 0, str);
    }
    ...
    public void resolveResourceStrings(Resources res) {
        ...
        if (this.mTitleResId != 0 || this.mTextResId != 0 || this.mDisabledMessageResId != 0) {
            ...
            i = this.mTextResId;
            if (i != 0) {
                this.mText = getResourceString(res, i, this.mText);
            }
            i = this.mDisabledMessageResId;
            if (i != 0) {
                this.mDisabledMessage = getResourceString(res, i, this.mDisabledMessage);
            }
        }
    }
    ...
    public static int lookUpResourceId(Resources res, String resourceName, String resourceType, String packageName) {
        ...
        try {
            i = Integer.parseInt(resourceName);
            return i;
        } catch (NumberFormatException e) {
            try {
                i = res.getIdentifier(resourceName, resourceType, packageName);
                return i;
    ...
    public void lookupAndFillInResourceIds(Resources res) {
        if (this.mTitleResName != null || this.mTextResName != null || this.mDisabledMessageResName != null || this.mIconResName != null) {
            ...
            String str3 = RES_TYPE_STRING;
            this.mTitleResId = lookUpResourceId(res, str, str3, str2);
            this.mTextResId = lookUpResourceId(res, this.mTextResName, str3, this.mPackageName);
            this.mDisabledMessageResId = lookUpResourceId(res, this.mDisabledMessageResName, str3, this.mPackageName);
    ...
    public void copyNonNullFieldsFrom(ShortcutInfo source) {
        ...
        ArraySet arraySet = source.mCategories;
        if (arraySet != null) {
