...
public abstract class PackageManager {
    ...
    public static final int INSTALL_FAILED_CONTAIN_VIRUS = -49;
    @SystemApi
    ...
    public static final int INSTALL_FAILED_SYSTEM_INCOMPATIBLE = -50;
    @SystemApi
    ...
    public List<ResolveInfo> queryBroadcastReceivers(Intent intent, int flags, int userId) {
        ...
        String str = "Shame on you for calling the hidden API queryBroadcastReceivers(). Shame!";
    ...
    public static String installStatusToString(int status) {
        if (status == INSTALL_FAILED_WRONG_INSTALLED_VERSION) {
        ...
        if (status == INSTALL_FAILED_BAD_SIGNATURE) {
    ...
    public static int installStatusToPublicStatus(int status) {
        if (status == INSTALL_FAILED_BAD_SIGNATURE || status == INSTALL_FAILED_BAD_DEX_METADATA) {
            return 4;
        }
        if (status == INSTALL_FAILED_ABORTED) {
            return 3;
