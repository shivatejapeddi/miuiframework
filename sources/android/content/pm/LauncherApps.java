...
public class LauncherApps {
    ...
    public static final class AppUsageLimit implements Parcelable {
        public static final Creator<AppUsageLimit> CREATOR = new Creator<AppUsageLimit>() {
            public AppUsageLimit createFromParcel(Parcel source) {
                return new AppUsageLimit(source, null);
            }
    ...
    public void startPackageInstallerSessionDetailsActivity(SessionInfo sessionInfo, Rect sourceBounds, Bundle opts) {
        try {
    ...
    private Drawable loadDrawableResourceFromPackage(String packageName, int resId, UserHandle user, int density) {
        ...
        try {
            drawable = this.mContext.getPackageManager().getResourcesForApplication(getApplicationInfo(packageName, null, user)).getDrawableForDensity(resId, density);
            return drawable;
    ...
    public void registerPackageInstallerSessionCallback(Executor executor, SessionCallback callback) {
        if (executor != null) {
            synchronized (this.mDelegates) {
                SessionCallbackDelegate delegate = new SessionCallbackDelegate(callback, executor);
                try {
    ...
    public List<SessionInfo> getAllPackageInstallerSessions() {
        try {
