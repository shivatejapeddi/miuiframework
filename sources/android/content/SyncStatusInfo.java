...
import com.miui.internal.content.MiSyncStatusInfo;
...
public class SyncStatusInfo implements Parcelable {
    ...
    public MiSyncStatusInfo miSyncStatusInfo;
    @UnsupportedAppUsage
    ...
    public SyncStatusInfo(int authorityId) {
        ...
        this.miSyncStatusInfo = new MiSyncStatusInfo();
    ...
    public void writeToParcel(Parcel parcel, int flags) {
        ...
        this.miSyncStatusInfo.writeToParcel(parcel, flags);
    }
    ...
    public SyncStatusInfo(Parcel parcel) {
        ...
        this.miSyncStatusInfo = new MiSyncStatusInfo(parcel);
    }
    ...
    public SyncStatusInfo(SyncStatusInfo other) {
        ...
        ArrayList arrayList = other.periodicSyncTimes;
        if (arrayList != null) {
        ...
        this.miSyncStatusInfo = new MiSyncStatusInfo(other.miSyncStatusInfo);
    }
