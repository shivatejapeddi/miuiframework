...
public class CapInfo implements Parcelable {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeInt(this.mGeoSmsSupported);
        dest.writeInt(this.mCallComposerSupported);
        dest.writeInt(this.mPostCallSupported);
        dest.writeInt(this.mSharedMapSupported);
        dest.writeInt(this.mSharedSketchSupported);
        dest.writeInt(this.mChatbotSupported);
        dest.writeInt(this.mChatbotRoleSupported);
