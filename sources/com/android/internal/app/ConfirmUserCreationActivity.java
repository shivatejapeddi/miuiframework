        ...
        if (callingPackage != null) {
            try {
                ...
                if (cantCreateUser) {
                    ...
                    String message;
                    if (accountExists) {
                        message = getString(R.string.user_creation_account_exists, appName, this.mAccountName);
                    } else {
                        message = getString(R.string.user_creation_adding, appName, this.mAccountName);
                    }
                    return message;
                }
