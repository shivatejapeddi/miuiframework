...
public class EpicenterTranslateClipReveal extends Visibility {
    ...
    public Animator onAppear(ViewGroup sceneRoot, View view, TransitionValues startValues, TransitionValues endValues) {
        ...
        return createRectAnimator(view, startStateX, startStateY, f, endStateX, endStateY, endZ, endValues, timeInterpolator4, timeInterpolator2, this.mInterpolatorZ);
    }
    ...
    private static Animator createRectAnimator(View view, State startX, State startY, float startZ, State endX, State endY, float endZ, TransitionValues endValues, TimeInterpolator interpolatorX, TimeInterpolator interpolatorY, TimeInterpolator interpolatorZ) {
        ...
        TypeEvaluator evaluator = new StateEvaluator();
        ObjectAnimator animZ = ObjectAnimator.ofFloat(obj, View.TRANSLATION_Z, startZ, endZ);
        if (timeInterpolator3 != null) {
            animZ.setInterpolator(timeInterpolator3);
        }
        ObjectAnimator animX = ObjectAnimator.ofObject(obj, new StateProperty(StateProperty.TARGET_X), evaluator, startX, endX);
        if (timeInterpolator != null) {
            animX.setInterpolator(timeInterpolator);
        }
        ObjectAnimator animY = ObjectAnimator.ofObject(obj, new StateProperty('y'), evaluator, startY, endY);
        ...
        AnimatorListenerAdapter animatorListener = new AnimatorListenerAdapter() {
            public void onAnimationEnd(Animator animation) {
                obj.setClipBounds(terminalClip);
            }
        };
