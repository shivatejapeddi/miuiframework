...
public class MessagingTextMessage extends ImageFloatingTextView implements MessagingMessage {
    ...
    static MessagingMessage createMessage(MessagingLayout layout, Message m) {
        ...
        if (createdMessage == null) {
            createdMessage = (MessagingTextMessage) LayoutInflater.from(layout.getContext()).inflate((int) R.layout.notification_template_messaging_text_message, messagingLinearLayout, false);
