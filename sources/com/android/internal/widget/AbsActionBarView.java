...
public abstract class AbsActionBarView extends ViewGroup {
    ...
    public Animator setupAnimatorToVisibility(int visibility, long duration) {
        ...
        if (visibility == 0) {
            ...
            anim = ObjectAnimator.ofFloat((Object) this, View.ALPHA, 1.0f);
        ...
        ObjectAnimator anim2 = ObjectAnimator.ofFloat((Object) this, View.ALPHA, 0.0f);
        ...
        anim = ObjectAnimator.ofFloat(this.mMenuView, View.ALPHA, 0.0f);
        anim.setDuration(duration);
        set2.addListener(this.mVisAnimListener.withFinalVisibility(visibility));
        set2.play(anim2).with(anim);
        return set2;
    }
