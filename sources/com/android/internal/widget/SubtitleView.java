...
public class SubtitleView extends View {
    ...
    private boolean computeMeasurements(int maxWidth) {
        ...
        this.mLayout = Builder.obtain(spannableStringBuilder, 0, spannableStringBuilder.length(), this.mTextPaint, maxWidth).setAlignment(this.mAlignment).setLineSpacing(this.mSpacingAdd, this.mSpacingMult).setUseLineSpacingFromFallbacks(true).build();
        return true;
    }
    ...
    public void onDraw(Canvas c) {
        ...
        if (layout != null) {
            ...
            if (edgeType == 1) {
                ...
                textPaint.setShadowLayer(this.mShadowRadius, offset, offset, i);
            } else {
                i2 = innerPaddingX;
            }
            textPaint.setColor(this.mForegroundColor);
