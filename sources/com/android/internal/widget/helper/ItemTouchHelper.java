            ...
            if (this.mSelected != null) {
                ...
                if (prevSelected.itemView.getParent() != null) {
                    ...
                    if (prevActionState == 2) {
                        ...
                        i4 = swipeIfNecessary(prevSelected);
                    }
                    int swipeDir = i4;
                    releaseVelocityTracker();
                    ...
                    rv.setDuration(this.mCallback.getAnimationDuration(this.mRecyclerView, animationType2, targetTranslateX - currentTranslateX, targetTranslateY - currentTranslateY));
        ...
        while (i < childCount) {
            ...
            if (other == viewHolder2.itemView) {
                ...
                if (this.mCallback.canDropOver(this.mRecyclerView, this.mSelected, otherVh)) {
                    ...
                    while (margin < dx) {
                        int cnt = dx;
                        if (dist <= ((Integer) this.mDistances.get(margin)).intValue()) {
                            break;
                        }
                        left++;
                        margin++;
                    ...
                    this.mSwapTargets.add(left, otherVh);
                    this.mDistances.add(left, Integer.valueOf(dist));
                } else {
                    margin2 = margin;
                    left2 = left;
                }
