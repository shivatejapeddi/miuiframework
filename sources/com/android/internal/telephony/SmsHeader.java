...
public class SmsHeader {
    ...
    public String toString() {
        ...
        while (it.hasNext()) {
            ...
            stringBuilder3.append(miscElt.id);
            builder.append(stringBuilder3.toString());
            stringBuilder3 = new StringBuilder();
            stringBuilder3.append(", length=");
            stringBuilder3.append(miscElt.data.length);
            builder.append(stringBuilder3.toString());
            stringBuilder3 = new StringBuilder();
            stringBuilder3.append(", data=");
            stringBuilder3.append(HexDump.toHexString(miscElt.data));
            builder.append(stringBuilder3.toString());
            builder.append(str3);
        }
        builder.append(str3);
