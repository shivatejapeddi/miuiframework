...
public class AnimationScaleListDrawable extends DrawableContainer implements Animatable {
    ...
    public void inflate(Resources r, XmlPullParser parser, AttributeSet attrs, Theme theme) throws XmlPullParserException, IOException {
        TypedArray a = Drawable.obtainAttributes(r, theme, attrs, R.styleable.AnimationScaleListDrawable);
        updateDensity(r);
        a.recycle();
            ...
            if (next != 1) {
                ...
                if (type == 2) {
                    if (depth > innerDepth) {
                        ...
                        TypedArray a = Drawable.obtainAttributes(r, theme, attrs, R.styleable.AnimationScaleListDrawableItem);
