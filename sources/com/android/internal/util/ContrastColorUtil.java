...
public class ContrastColorUtil {
    ...
    /* JADX WARNING: Missing block: B:25:0x005a, code skipped:
            return r0;
     */
    public boolean isGrayscaleIcon(android.graphics.Bitmap r7) {
        /*
        r6 = this;
        r0 = r7.getWidth();
        r1 = r6.mGrayscaleIconMaxSize;
    ...
    L_0x0011:
        r0 = sLock;
        monitor-enter(r0);
        r1 = r6.mGrayscaleBitmapCache;	 Catch:{ all -> 0x0061 }
        r1 = r1.get(r7);	 Catch:{ all -> 0x0061 }
        r1 = (android.util.Pair) r1;	 Catch:{ all -> 0x0061 }
        if (r1 == 0) goto L_0x0036;
    L_0x001e:
        r2 = r1.second;	 Catch:{ all -> 0x0061 }
        r2 = (java.lang.Integer) r2;	 Catch:{ all -> 0x0061 }
        r2 = r2.intValue();	 Catch:{ all -> 0x0061 }
        r3 = r7.getGenerationId();	 Catch:{ all -> 0x0061 }
        if (r2 != r3) goto L_0x0036;
    L_0x002c:
        r2 = r1.first;	 Catch:{ all -> 0x0061 }
        r2 = (java.lang.Boolean) r2;	 Catch:{ all -> 0x0061 }
        r2 = r2.booleanValue();	 Catch:{ all -> 0x0061 }
    ...
    L_0x0036:
        ...
        r1 = r6.mImageUtils;
        monitor-enter(r1);
        r0 = r6.mImageUtils;	 Catch:{ all -> 0x005e }
        r0 = r0.isGrayscale(r7);	 Catch:{ all -> 0x005e }
        r2 = r7.getGenerationId();	 Catch:{ all -> 0x005e }
        monitor-exit(r1);	 Catch:{ all -> 0x005e }
        r3 = sLock;
        monitor-enter(r3);
        r1 = r6.mGrayscaleBitmapCache;	 Catch:{ all -> 0x005b }
        r4 = java.lang.Boolean.valueOf(r0);	 Catch:{ all -> 0x005b }
        r5 = java.lang.Integer.valueOf(r2);	 Catch:{ all -> 0x005b }
        r4 = android.util.Pair.create(r4, r5);	 Catch:{ all -> 0x005b }
        r1.put(r7, r4);	 Catch:{ all -> 0x005b }
    ...
    L_0x0064:
        ...
        return r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.internal.util.ContrastColorUtil.isGrayscaleIcon(android.graphics.Bitmap):boolean");
    }
    ...
    private static boolean shouldUseDark(int backgroundColor, boolean defaultBackgroundIsDark) {
        if (backgroundColor == 0) {
            return defaultBackgroundIsDark ^ 1;
        }
