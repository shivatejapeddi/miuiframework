...
public final class DumpUtils {
    ...
    public static boolean checkDumpPermission(Context context, String tag, PrintWriter pw) {
        if (context.checkCallingOrSelfPermission(permission.DUMP) == 0) {
            return true;
        }
    ...
    public static boolean checkUsageStatsPermission(Context context, String tag, PrintWriter pw) {
        ...
        String str = ", uid=";
        String str2 = " from from pid=";
        String str3 = "Permission Denial: can't dump ";
    ...
    public static boolean isPlatformCriticalPackage(WithComponentName wcn) {
        return wcn != null && isPlatformPackage(wcn.getComponentName()) && isCriticalPackage(wcn.getComponentName());
    }

    public static boolean isPlatformNonCriticalPackage(WithComponentName wcn) {
    ...
    public static <TRec extends WithComponentName> Predicate<TRec> filterRecord(String filterString) {
        ...
        if ("all-platform-critical".equals(filterString)) {
            return -$$Lambda$grRTg3idX3yJe9Zyx-tmLBiD1DM.INSTANCE;
        }
