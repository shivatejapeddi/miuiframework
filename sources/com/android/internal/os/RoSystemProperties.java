...
import android.sysprop.CryptoProperties.state_values;
import android.sysprop.CryptoProperties.type_values;
...
public class RoSystemProperties {
    ...
    public static final boolean CRYPTO_BLOCK_ENCRYPTED = (CRYPTO_TYPE == type_values.BLOCK);
    public static final boolean CRYPTO_ENCRYPTABLE = (CRYPTO_STATE != state_values.UNSUPPORTED);
    public static final boolean CRYPTO_ENCRYPTED = (CRYPTO_STATE == state_values.ENCRYPTED);
    public static final boolean CRYPTO_FILE_ENCRYPTED = (CRYPTO_TYPE == type_values.FILE);
    public static final state_values CRYPTO_STATE = ((state_values) CryptoProperties.state().orElse(state_values.UNSUPPORTED));
    public static final type_values CRYPTO_TYPE = ((type_values) CryptoProperties.type().orElse(type_values.NONE));
