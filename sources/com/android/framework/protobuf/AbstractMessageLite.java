...
public abstract class AbstractMessageLite<MessageType extends AbstractMessageLite<MessageType, BuilderType>, BuilderType extends Builder<MessageType, BuilderType>> implements MessageLite {
    ...
    public static abstract class Builder<MessageType extends AbstractMessageLite<MessageType, BuilderType>, BuilderType extends Builder<MessageType, BuilderType>> implements com.android.framework.protobuf.MessageLite.Builder {
        ...
        static final class LimitedInputStream extends FilterInputStream {
            ...
            public int read(byte[] b, int off, int len) throws IOException {
                ...
                i = super.read(b, off, Math.min(len, i));
                if (i >= 0) {
                    this.limit -= i;
                }
                return i;
