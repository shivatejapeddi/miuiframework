    ...
    private static int encode(CharSequence sequence, byte[] bytes, int offset, int length) {
        ...
        while (i < utf16Length) {
            ...
            if (charAt < 128 && j < limit) {
                ...
                j2 = j + 1;
                bytes[j] = (byte) ((charAt >>> 6) | 960);
                j = j2 + 1;
                bytes[j2] = (byte) ((charAt & 63) | 128);
            } else if ((charAt < 55296 || 57343 < charAt) && j <= limit - 3) {
                j2 = j + 1;
                bytes[j] = (byte) ((charAt >>> 12) | 480);
                j = j2 + 1;
                bytes[j2] = (byte) (((charAt >>> 6) & 63) | 128);
                j2 = j + 1;
                bytes[j] = (byte) ((charAt & 63) | 128);
                j = j2;
            } else if (j <= limit - 4) {
                if (i + 1 != sequence.length()) {
                    i++;
                    ...
                    if (Character.isSurrogatePair(charAt, c)) {
                        ...
                        int i2 = j + 1;
                        bytes[j] = (byte) ((j2 >>> 18) | 240);
                        j = i2 + 1;
                        bytes[i2] = (byte) (((j2 >>> 12) & 63) | 128);
                        i2 = j + 1;
                        bytes[j] = (byte) (((j2 >>> 6) & 63) | 128);
                        j = i2 + 1;
                        bytes[i2] = (byte) ((j2 & 63) | 128);
                    }
                }
