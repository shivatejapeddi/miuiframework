...
final class FieldSet<FieldDescriptorType extends FieldDescriptorLite<FieldDescriptorType>> {
    ...
    public boolean equals(Object o) {
        ...
        SmallSortedMap smallSortedMap = ((FieldSet) o).fields;
    ...
    public static Object readPrimitiveField(CodedInputStream input, FieldType type, boolean checkUtf8) throws IOException {
        if (checkUtf8) {
            return WireFormat.readPrimitiveField(input, type, Utf8Validation.STRICT);
        }
        return WireFormat.readPrimitiveField(input, type, Utf8Validation.LOOSE);
    }
    ...
    static void writeElementNoTag(CodedOutputStream output, FieldType type, Object value) throws IOException {
        switch (type) {
            case DOUBLE:
    ...
    static int computeElementSizeNoTag(FieldType type, Object value) {
        switch (type) {
            case DOUBLE:
    ...
    public static int computeFieldSize(FieldDescriptorLite<?> descriptor, Object value) {
        ...
        for (Object element2 : (List) value) {
            dataSize += computeElementSize(type, number, element2);
        }
        return dataSize;
    }
}
