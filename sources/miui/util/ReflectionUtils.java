...
public class ReflectionUtils {
    ...
    public static Method tryFindMethodExact(Class<?> clazz, String methodName, Object... parameterTypes) {
        ...
        String str2 = TAG;
        try {
            str = findMethodExact((Class) clazz, methodName, parameterTypes);
            return str;
        } catch (ClassNotFoundException ex) {
            Log.w(str2, str, ex);
            return null;
        ...
        synchronized (methodCache) {
            ...
            try {
                ...
                for (Method method3 : clazz.getDeclaredMethods()) {
                    if (method3.getName().equals(methodName) && ClassUtils.isAssignable((Class[]) parameterTypes, method3.getParameterTypes(), true) && (bestMatch == null || MemberUtils.compareParameterTypes(method3.getParameterTypes(), bestMatch.getParameterTypes(), parameterTypes) < 0)) {
                        bestMatch = method3;
                    }
                }
                if (bestMatch != null) {
        ...
        synchronized (constructorCache) {
            ...
            try {
                ...
                for (Constructor<?> constructor3 : clazz.getDeclaredConstructors()) {
                    if (ClassUtils.isAssignable((Class[]) parameterTypes, constructor3.getParameterTypes(), true) && (bestMatch == null || MemberUtils.compareParameterTypes(constructor3.getParameterTypes(), bestMatch.getParameterTypes(), parameterTypes) < 0)) {
    ...
    private static Object checkFieldValue(Object value, Class<?> fieldClazz) throws IllegalArgumentException {
        ...
        if (fieldClazz == Void.class) {
            ...
            if (fieldClazz == null || ClassUtils.isAssignable(value.getClass(), (Class) fieldClazz, true)) {
                return value;
            }
            throw new IllegalArgumentException(str);
        }
    ...
    private static Object checkMethodReturnValue(Object returnedValue, Class<?> returnValueClazz) throws IllegalArgumentException {
        ...
        if (ClassUtils.isAssignable(returnedValue.getClass(), (Class) returnValueClazz, true)) {
            return returnedValue;
        }
