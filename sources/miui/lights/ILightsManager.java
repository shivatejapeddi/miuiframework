...
public interface ILightsManager extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ILightsManager {
        private static final String DESCRIPTOR = "miui.lights.ILightsManager";
        static final int TRANSACTION_setColorfulLight = 1;
        ...
        private static class Proxy implements ILightsManager {
            ...
            public void setColorfulLight(String pkg, int styleType, int userId) throws RemoteException {
                ...
                try {
                    ...
                    Stub.getDefaultImpl().setColorfulLight(pkg, styleType, userId);
                } finally {
                    _reply.recycle();
                    _data.recycle();
                }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            if (code == 1) {
                ...
                setColorfulLight(data.readString(), data.readInt(), data.readInt());
    ...
    void setColorfulLight(String str, int i, int i2) throws RemoteException;
}
