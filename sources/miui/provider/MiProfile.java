...
public class MiProfile {
    ...
    public static final Uri MIPROFILE_NUMBERS_URI = Uri.withAppendedPath(ContactsContract.AUTHORITY_URI, MIPROFILE_NUMBERS_TABLE);
    ...
    public static final Uri MIPROFILE_URI = Uri.withAppendedPath(ContactsContract.AUTHORITY_URI, MIPROFILE_TABLE);
