...
public class Wifi {
    ...
    public static final Uri CONTENT_URI = Uri.parse("content://wifi/wifi");
    ...
    public static final Uri WIFI_URI = CONTENT_URI.buildUpon().appendQueryParameter("caller_is_syncadapter", String.valueOf(true)).build();
